...
(function () {
     ...
     *    suggestions list.
     * @param {string=} [module='null'] Module name to be searched at.
        ...
        function SuggestionList(loadFn, options, events) {
            ...
            self.load = tiUtil.debounce(function (query, tags) {
                ...
                promise.then(function (items) {
                    ...
                    items = [];
                    if (angular.isDefined(options.module) && options.module != 'null')
                        $.ajax({
                            type: 'Post',
                            async: false,
                            ...
                            success: function (response) {
                                ...
                                $.each(response.ListItems, function (index, element) {
                                    var cat = "";
                                    if (element.LinkCategoryTagId > 0 && element.virtual_CategoryTag )
                                        cat = "(" + element.virtual_CategoryTag.Title + ")"
                                    data.push({ id: element.Id, text: cat+element.Title })
                                });
                                items = data;
                            },
                            error: function (msg) {
                        ...
                        });   //برای یافتن رشته های مشابه tags جستجو در جدول 
                    //items = tiUtil.makeObjectArray(items.data || items, getTagId()); //ساخته شده است $.ajax آرایه موردنیاز در داخل
        ...
        return {
            ...
            controller: ["$scope", "$element", "$attrs", function ($scope, $element, $attrs) {
                ...
                tagsInputConfig.load('autoComplete', $scope, $attrs, {
                    ...
                    module: [String, 'null'],          //را به صورت اضافی برای نگه داشتن نام ماژول می سازیم option این
