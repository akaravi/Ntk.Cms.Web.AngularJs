app.controller("ServiceContentTagCtrl", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $filter) {
    ...
    ServiceContentTag.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ServiceContenttag/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Service/ServicecontentTag/add.html',
                scope: $scope
            });
    ...
    ServiceContentTag.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ServiceContenttag/',  ServiceContentTag.gridOptions.selectedRow.item.Id , 'GET').success(function (response) {
            ...
            ServiceContentTag.selectedItem = response.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Service/ServicecontentTag/edit.html',
                scope: $scope
            });
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'ServiceContenttag/',  ServiceContentTag.gridOptions.selectedRow.item.Id , 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'ServiceContenttag/',  ServiceContentTag.selectedItemForDelete.Id , 'DELETE').success(function (res) {
