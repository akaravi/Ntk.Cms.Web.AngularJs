app.controller("serviceShareReciverCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    serviceShareReciverCategory.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"serviceShareReciverCategory/getall", {AccessLoad : true}, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            serviceShareReciverCategory.ListItems = response.ListItems;
            serviceShareReciverCategory.gridOptions.fillData(serviceShareReciverCategory.ListItems, response.Access); // Sending Access as an argument
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ServiceShareMainAdminSetting/ViewModel', "", 'GET').success(function (response) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Service/ServiceShareMainAdminSetting/add.html',
                        scope: $scope
                    });
                    serviceShareReciverCategory.addRequested = false;
                }).error(function (data, errCode, c, d) {
    ...
    serviceShareReciverCategory.EditCategoryModel = function () {
        ...
        serviceShareReciverCategory.contentBusyIndicator.isActive = true;
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'ServiceShareMainAdminSetting/', serviceShareReciverCategory.treeConfig.currentNode.Id, 'GET').success(function (response) {
            buttonIsPressed = false;
            serviceShareReciverCategory.contentBusyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            serviceShareReciverCategory.selectedItem = response.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Service/ServiceShareMainAdminSetting/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
    ...
    serviceShareReciverCategory.addNewCategory = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ServiceShareMainAdminSetting/', serviceShareReciverCategory.selectedItem, 'POST').success(function (response) {
            serviceShareReciverCategory.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    serviceShareReciverCategory.EditCategory = function (frm) {
        ...
        serviceShareReciverCategory.categoryBusyIndicator.isActive = true;
        serviceShareReciverCategory.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'ServiceShareMainAdminSetting/', serviceShareReciverCategory.selectedItem, "PUT").success(function (response) {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'ServiceShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'ServiceShareMainAdminSetting/', serviceShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        serviceShareReciverCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    serviceShareReciverCategory.selectContent = function (node) {
        ...
        serviceShareReciverCategory.gridOptions.advancedSearchData.engine.AccessLoad = true;
    ...
    serviceShareReciverCategory.addNewContentModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'serviceShareReciverCategory/ViewModel', "", 'GET').success(function (response) {
            buttonIsPressed = false;
            //console.log(response);
            rashaErManage.checkAction(response);
            serviceShareReciverCategory.selectedItem = response.Item;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/service/serviceShareReciverCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    serviceShareReciverCategory.openEditModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'serviceShareReciverCategory/', serviceShareReciverCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            buttonIsPressed = false;
            rashaErManage.checkAction(response1);
            serviceShareReciverCategory.selectedItem = response1.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/service/serviceShareReciverCategory/edit.html',
                scope: $scope
            });
    ...
    serviceShareReciverCategory.addNewContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'serviceShareReciverCategory/', serviceShareReciverCategory.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            serviceShareReciverCategory.categoryBusyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    serviceShareReciverCategory.editContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'serviceShareReciverCategory/', serviceShareReciverCategory.selectedItem, "PUT").success(function (response) {
            serviceShareReciverCategory.categoryBusyIndicator.isActive = false;
            serviceShareReciverCategory.addRequested = false;
            serviceShareReciverCategory.treeConfig.showbusy = false;
    ...
    serviceShareReciverCategory.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                serviceShareReciverCategory.showIsBusy = true;
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+"serviceShareReciverCategory/", serviceShareReciverCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    buttonIsPressed = false;
                    serviceShareReciverCategory.showbusy = false;
                    serviceShareReciverCategory.showIsBusy = false;
                    rashaErManage.checkAction(response);
                    serviceShareReciverCategory.selectedItemForDelete = response.Item;
                    console.log(serviceShareReciverCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"serviceShareReciverCategory/", serviceShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        serviceShareReciverCategory.categoryBusyIndicator.isActive = false;
                        serviceShareReciverCategory.treeConfig.showbusy = false;
                        serviceShareReciverCategory.showIsBusy = false;
    ...
    serviceShareReciverCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Service/serviceShareReciverCategory/report.html',
            scope: $scope
        });
    }
