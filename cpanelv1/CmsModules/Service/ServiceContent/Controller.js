app.controller("serviceContentController", [
  ...
  function (
    ...
    serviceContent.addMenu = function () {
      ...
      $modal.open({
        templateUrl: "cpanelv1/CmsModules/service/serviceContent/modalMenu.html",
        scope: $scope
      });
    };
    ...
    serviceContent.init = function () {
      ...
      filterModel = {
        ...
        SearchType: 0,
        value: serviceContent.selectedContentId.Id
      };
      ...
      ajax.call(cmsServerConfig.configApiServerPath + "serviceContentTag/ViewModel", "", "GET").success(function (response) { //Get a ViewModel for serviceContentTag
    ...
    serviceContent.showComment = function (LinkContentId) {
      ...
      ajax.call(cmsServerConfig.configApiServerPath + "servicecomment/getall", engine, 'POST').success(function (response) {
        ...
        serviceContent.gridContentOptions.fillData(serviceContent.ListCommentItems, response.Access); // Sending Access as an argument
    ...
    serviceContent.addNewCategoryModel = function () {
      ...
      ajax
        .call(cmsServerConfig.configApiServerPath + "serviceCategory/ViewModel", "", "GET")
        .success(function (response) {
            ...
            .success(function (response1) {
              ...
              ajax
                ...
                .success(function (response2) {
                  ...
                  $modal.open({
                    templateUrl: "cpanelv1/CmsModules/service/serviceCategory/add.html",
                    scope: $scope
                  });
                  serviceContent.addRequested = false;
                })
    ...
    serviceContent.EditCategoryModel = function () {
      ...
      ajax
        .call(
          cmsServerConfig.configApiServerPath + "serviceCategory/",
            ...
            .success(function (response1) {
              ...
              ajax
                ...
                .success(function (response2) {
                  ...
                  $modal.open({
                    templateUrl: "cpanelv1/CmsModules/service/serviceCategory/edit.html",
                    scope: $scope
                  });
                })
                .error(function (data, errCode, c, d) {
    ...
    serviceContent.Showstatistics = function () {
      ...
      ajax.call(cmsServerConfig.configApiServerPath + 'serviceContent/', serviceContent.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
        rashaErManage.checkAction(response1);
        serviceContent.selectedItem = response1.Item;
        $modal.open({
          templateUrl: "cpanelv1/CmsModules/service/serviceContent/statistics.html",
          scope: $scope
        });
      }).error(function (data, errCode, c, d) {
        rashaErManage.checkAction(data, errCode);
    ...
    serviceContent.addNewCategory = function (frm) {
      ...
      if (serviceContent.treeConfig.currentNode != null)
        ...
        serviceContent.treeConfig.currentNode.Id;
      ajax
        .call(cmsServerConfig.configApiServerPath + "serviceCategory/", serviceContent.selectedItem, "POST")
        .success(function (response) {
          serviceContent.addRequested = false;
          rashaErManage.checkAction(response);
    ...
    serviceContent.EditCategory = function (frm) {
      ...
      serviceContent.addRequested = true;
      ajax
        .call(cmsServerConfig.configApiServerPath + "serviceCategory/", serviceContent.selectedItem, "PUT")
        .success(function (response) {
      ...
      rashaErManage.showYesNo(
        ...
        function (isConfirmed) {
          if (isConfirmed) {
            ...
            buttonIsPressed = true;
            ajax
              .call(cmsServerConfig.configApiServerPath + "serviceCategory/", node.Id, "GET")
              .success(function (response) {
                buttonIsPressed = false;
                rashaErManage.checkAction(response);
    ...
    serviceContent.addNewContentModel = function () {
      ...
      buttonIsPressed = true;
      ajax
        .call(cmsServerConfig.configApiServerPath + "serviceContent/ViewModel", "", "GET")
        .success(function (response) {
          buttonIsPressed = false;
          rashaErManage.checkAction(response);
          ...
          $modal.open({
            templateUrl: "cpanelv1/CmsModules/service/serviceContent/add.html",
            scope: $scope
          });
        })
        .error(function (data, errCode, c, d) {
    ...
    serviceContent.saveOtherInfos = function () {
      ...
      if (serviceContent.editMode) {
        ...
        serviceContent.selectedItemOtherInfos = {};
        // ajax.call(cmsServerConfig.configApiServerPath + 'serviceContentOtherInfo/', serviceContent.selectedItemOtherInfos, 'POST').success(function (response) {
        //   rashaErManage.checkAction(response);
        //   if (response.IsSuccess) {
    ...
    serviceContent.openEditModel = function () {
      ...
      if (serviceContent.gridOptions.selectedRow.item.LinkSiteId != $rootScope.tokenInfo.SiteId && !$rootScope.tokenInfo.UserAccessAdminAllowToAllData) {
        rashaErManage.showMessage($filter('translatentk')('This_service_Is_Shared'));
        return;
      }
      serviceContent.selectedItemOtherInfos = {};
      buttonIsPressed = true;
      ajax.call(cmsServerConfig.configApiServerPath + "serviceContent/", serviceContent.gridOptions.selectedRow.item.Id, "GET")
        .success(function (response1) {
          buttonIsPressed = false;
          rashaErManage.checkAction(response1);
          serviceContent.selectedItem = response1.Item;
          ...
          var filterValue = {
            PropertyName: "LinkContentId",
            value: serviceContent.gridOptions.selectedRow.item.Id,
            SearchType: 0
          }
          ...
          if (response1.Item.LinkMainImageId != null) {
            ajax.call(cmsServerConfig.configApiServerPath + "FileContent/", response1.Item.LinkMainImageId, "GET")
              .success(function (response2) {
                buttonIsPressed = false;
                serviceContent.filePickerMainImage.filename =
          ...
          if (response1.Item.LinkFilePodcastId != null) {
            ajax.call(cmsServerConfig.configApiServerPath + 'FileContent/', response1.Item.LinkFilePodcastId, 'GET').success(function (response2) {
          ...
          if (response1.Item.LinkFileMovieId != null) {
            ajax.call(cmsServerConfig.configApiServerPath + 'FileContent/', response1.Item.LinkFileMovieId, 'GET').success(function (response2) {
          ...
          $modal.open({
            templateUrl: "cpanelv1/CmsModules/service/serviceContent/edit.html",
            scope: $scope
          });
        })
        .error(function (data, errCode, c, d) {
    ...
    serviceContent.addNewContent = function (frm) {
      ...
      ajax.call(cmsServerConfig.configApiServerPath + "serviceContent/", apiSelectedItem, "POST").success(function (response) {
          rashaErManage.checkAction(response);
          serviceContent.categoryBusyIndicator.isActive = false;
          if (response.IsSuccess) {
            ...
            if (serviceContent.tags&& serviceContent.tags.length > 0) {
    ...
    serviceContent.editContent = function (frm) {
      ...
      if (serviceContent.ContentTagsRemoved && serviceContent.ContentTagsRemoved.length > 0) {
        ajax.call(cmsServerConfig.configApiServerPath + "serviceContentTag/DeleteList", serviceContent.ContentTagsRemoved, "POST").success(function (response) {
            rashaErManage.checkAction(response);
          })
          .error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
      ...
      if (serviceContent.ContentOtherInfosRemoved && serviceContent.ContentOtherInfosRemoved.length > 0) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + "serviceContentOtherInfo/DeleteList", OtherInfosRemovedModel, "POST").success(function (response) {
            rashaErManage.checkAction(response);
          })
          .error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
      ...
      if (serviceContent.ContentSimilarsRemoved && serviceContent.ContentSimilarsRemoved.length > 0) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + "serviceContentSimilar/DeleteList", SimilarsRemovedModel, "POST").success(function (response) {
            rashaErManage.checkAction(response);
          })
          .error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
      ...
      ajax
        .call(cmsServerConfig.configApiServerPath + "serviceContent/", apiSelectedItem, "PUT")
        .success(function (response) {
          serviceContent.categoryBusyIndicator.isActive = false;
          serviceContent.addRequested = false;
          serviceContent.treeConfig.showbusy = false;
      ...
      rashaErManage.showYesNo(
        ...
        function (isConfirmed) {
          if (isConfirmed) {
            ...
            ajax
              .call(
                cmsServerConfig.configApiServerPath + "serviceContent/",
      ...
      ajax
        ...
        .success(function (response) {
          ...
          serviceContent.selectedItem.IsAccepted = response.Item.IsAccepted == true ?
            ...
            true;
          ajax
            .call(cmsServerConfig.configApiServerPath + "serviceContent/", serviceContent.selectedItem, "PUT")
            .success(function (response2) {
    ...
    serviceContent.confirmComment = function (item) {
      if (item.Id && item.Id > 0) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + 'serviceComment/', itemCopy, "PUT").success(function (response) {
          rashaErManage.checkAction(response);
          if(response.IsSuccess)
          serviceContent.showComment(serviceContent.gridOptions.selectedRow.item.Id)
        }).error(function (data, errCode, c, d) {
      ...
      rashaErManage.showYesNo(
        ...
        function (isConfirmed) {
          if (isConfirmed) {
            ...
            var itemCopy = angular.copy(item);
            itemCopy.rowOption = null;
            ajax.call(cmsServerConfig.configApiServerPath + "serviceComment/", itemCopy.Id, "DELETE")
              .success(function (res) {
                serviceContent.treeConfig.showbusy = false;
                serviceContent.showbusy = false;
                serviceContent.showIsBusy = false;
    ...
    serviceContent.deleteAttachedfieldName = function (index) {
      ajax
        .call(
          cmsServerConfig.configApiServerPath + "serviceContent/",
          serviceContent.contractsList[index].Id,
          "DELETE"
        )
        .success(function (res) {
          rashaErManage.checkAction(res);
    ...
    serviceContent.openUploadModal = function () {
      $modal.open({
        templateUrl: "cpanelv1/CmsModules/service/serviceContent/upload_modal.html",
        size: "lg",
        scope: $scope
      });
    ...
    serviceContent.openUploadModalPodcast = function () {
      $modal.open({
        templateUrl: 'cpanelv1/CmsModules/service/serviceContent/upload_modalPodcast.html',
        size: 'lg',
        scope: $scope
      });
    ...
    serviceContent.openUploadModalMovie = function () {
      $modal.open({
        templateUrl: 'cpanelv1/CmsModules/service/serviceContent/upload_modalMovie.html',
        size: 'lg',
        scope: $scope
      });
    ...
    serviceContent.replaceFile = function (name) {
      ...
      // Delete the file
      ajax
        .call(cmsServerConfig.configApiServerPath + "FileContent/", serviceContent.fileIdToDelete, "GET")
        .success(function (response1) {
          rashaErManage.checkAction(response1);
    ...
    serviceContent.saveNewFile = function () {
      ajax
        .call(cmsServerConfig.configApiServerPath + "FileContent/", serviceContent.FileItem, "POST")
        .success(function (response) {
          if (response.IsSuccess) {
      ...
      if ($("#save-icon" + index).hasClass("fa-save")) {
        if (serviceContent.fileIsExist(uploadFile.name)) { // File already exists
          ...
          ajax.call(cmsServerConfig.configApiServerPath + "FileContent/ViewModel", "", 'GET').success(function (response) {
            ...
            // ------- serviceContent.saveNewFile()  ----------------------
            var result = 0;
            ajax.call(cmsServerConfig.configApiServerPath + "FileContent/", serviceContent.FileItem, 'POST').success(function (response) {
              if (response.IsSuccess) {
                serviceContent.FileItem = response.Item;
                serviceContent.showSuccessIcon();
                $("#save-icon" + index).removeClass("fa-save");
    ...
    serviceContent.toggleExportForm = function () {
      ...
      $modal.open({
        templateUrl: "cpanelv1/CmsModules/service/serviceContent/report.html",
        scope: $scope
      });
    };
