app.controller("serviceShareServerCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    serviceShareServerCategory.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"serviceShareServerCategory/getall", {AccessLoad : true}, 'POST').success(function (response) {
    ...
    serviceShareServerCategory.addNewCategory = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ServiceShareMainAdminSetting/', serviceShareServerCategory.selectedItem, 'POST').success(function (response) {
            serviceShareServerCategory.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    serviceShareServerCategory.EditCategory = function (frm) {
        ...
        serviceShareServerCategory.categoryBusyIndicator.isActive = true;
        serviceShareServerCategory.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'ServiceShareMainAdminSetting/', serviceShareServerCategory.selectedItem, "PUT").success(function (response) {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'ServiceShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'ServiceShareMainAdminSetting/', serviceShareServerCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        serviceShareServerCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    serviceShareServerCategory.selectContent = function (node) {
        ...
        serviceShareServerCategory.gridOptions.advancedSearchData.engine.AccessLoad = true;
    ...
    serviceShareServerCategory.addNewContentModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'serviceShareServerCategory/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/service/serviceShareServerCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    serviceShareServerCategory.openEditModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'serviceShareServerCategory/', serviceShareServerCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/service/serviceShareServerCategory/edit.html',
                scope: $scope
            });
    ...
    serviceShareServerCategory.addNewContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'serviceShareServerCategory/', serviceShareServerCategory.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            serviceShareServerCategory.categoryBusyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    serviceShareServerCategory.editContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'serviceShareServerCategory/', serviceShareServerCategory.selectedItem, "PUT").success(function (response) {
            serviceShareServerCategory.categoryBusyIndicator.isActive = false;
            serviceShareServerCategory.addRequested = false;
            serviceShareServerCategory.treeConfig.showbusy = false;
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"serviceShareServerCategory/", serviceShareServerCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    ...
                    serviceShareServerCategory.selectedItemForDelete = response.Item;
                    console.log(serviceShareServerCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"serviceShareServerCategory/", serviceShareServerCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        serviceShareServerCategory.categoryBusyIndicator.isActive = false;
                        serviceShareServerCategory.treeConfig.showbusy = false;
                        serviceShareServerCategory.showIsBusy = false;
    ...
    serviceShareServerCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Service/serviceShareServerCategory/report.html',
            scope: $scope
        });
    }
