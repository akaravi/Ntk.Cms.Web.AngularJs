...
app.controller("ServicecategoryCtrl", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $filter) {
    ...
    Servicecategory.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"Servicecategory/getall", { RowPerPage:1000,AccessLoad : true}, 'POST').success(function (response) {
            ...
            Servicecategory.gridOptions.fillData(Servicecategory.ListItems, response.Access);
    ...
    Servicecategory.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'Servicecategory/ViewModel', "", 'GET').success(function (response) {
            rashaErManage.checkAction(response);
    ...
    Servicecategory.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'Servicecategory/', Servicecategory.gridOptions.selectedRow.item.Id , 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            Servicecategory.selectedItem = response.Item;
            //Set dataForTheTree
