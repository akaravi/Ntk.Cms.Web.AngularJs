...
//#help# open modal add 
    ...
    $scope.addEditCustomer=function()
    {
       $scope.getViewModel("0").success(function(response)
       {
           ...
           $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Marketing/MarketingDashboard/customerAdd.html',
                scope: $scope,
                size:'lg'
            });     
       });         
    ...
    $scope.addEditMarketer=function()
    {
       $scope.getViewModel("0").success(function(response)
       {
           $scope.selectedItem=response.Item;
           $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Marketing/MarketingDashboard/MarketerAdd.html',
                scope: $scope
            });     
       });         
    }
$scope.addEditProductGroup=function()
    {
       $scope.getViewModel("0").success(function(response)
       {
           $scope.selectedItem=response.Item;
           $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Marketing/MarketingDashboard/ProductGroupAdd.html',
                scope: $scope
            });     
       });         
    }
$scope.addEditMarketerGroup=function()
    {
       $scope.getViewModel("0").success(function(response)
       {
           $scope.selectedItem=response.Item;
           $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Marketing/MarketingDashboard/MarketerGroupAdd.html',
                scope: $scope
            });     
       });         
    }
    $scope.addEditPosition=function()
    {
       $scope.getViewModel("0").success(function(response)
       {
           $scope.selectedItem=response.Item;
           $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Marketing/MarketingDashboard/PositionAdd.html',
                scope: $scope
            });     
       });         
    }
    $scope.addEditProduct=function()
    {
       $scope.getViewModel("0").success(function(response)
       {
           $scope.selectedItem=response.Item;
           $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Marketing/MarketingDashboard/ProductAdd.html',
                scope: $scope
            });     
       });         
    }
    $scope.addEditSettingKind=function()
    {
       $scope.getViewModel("0").success(function(response)
       {
           $scope.selectedItem=response.Item;
           $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Marketing/MarketingDashboard/SettingKindAdd.html',
                scope: $scope
            });     
       });         
    }
//#help#
    ...
    {
        var ret=ajax.call(cmsServerConfig.configApiServerPath+'MarketingCustomer/', viewmodelId, 'GET');
...
//#help#
    ...
    $scope.init=function()
    {
        ...
        $scope.getAllData('reminder',{Filters:[{PropertyName:'CustomerSettingActivityType',value:'Reminder'}]});
    }
