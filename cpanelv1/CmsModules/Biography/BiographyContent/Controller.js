app.controller("biographyContentController", [
  ...
  // }
    ...
    biographyContent.addMenu = function () {
      ...
      $modal.open({
        templateUrl: "cpanelv1/CmsModules/biography/biographyContent/modalMenu.html",
        scope: $scope
      });
    };
    ...
    biographyContent.init = function () {
      ...
      ajax.call(cmsServerConfig.configApiServerPath + "biographyContentTag/ViewModel", "", "GET").success(function (response) { //Get a ViewModel for biographyContentTag
    ...
    biographyContent.showComment = function (LinkContentId) {
      ...
      ajax.call(cmsServerConfig.configApiServerPath + "biographycomment/getall", engine, 'POST').success(function (response) {
        ...
        biographyContent.gridContentOptions.fillData(biographyContent.ListCommentItems, response.Access); // Sending Access as an argument
    ...
    biographyContent.addNewCategoryModel = function () {
      ...
      ajax
        .call(cmsServerConfig.configApiServerPath + "biographyCategory/ViewModel", "", "GET")
        .success(function (response) {
            ...
            .success(function (response1) {
              ...
              ajax
                ...
                .success(function (response2) {
                  ...
                  $modal.open({
                    templateUrl: "cpanelv1/CmsModules/Biography/BiographyCategory/add.html",
                    scope: $scope
                  });
                  biographyContent.addRequested = false;
                })
            ...
            .success(function (response1) {
              ...
              ajax
                ...
                .success(function (response2) {
                  ...
                  $modal.open({
                    templateUrl: "cpanelv1/CmsModules/Biography/BiographyCategory/edit.html",
                    scope: $scope
                  });
                })
                .error(function (data, errCode, c, d) {
    ...
    biographyContent.Showstatistics = function () {
      ...
      ajax.call(cmsServerConfig.configApiServerPath + 'biographyContent/', biographyContent.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
        rashaErManage.checkAction(response1);
        biographyContent.selectedItem = response1.Item;
        $modal.open({
          templateUrl: "cpanelv1/CmsModules/biography/biographyContent/statistics.html",
          scope: $scope
        });
      }).error(function (data, errCode, c, d) {
        rashaErManage.checkAction(data, errCode);
    ...
    biographyContent.addNewCategory = function (frm) {
      ...
      if (biographyContent.treeConfig.currentNode != null)
        ...
        biographyContent.treeConfig.currentNode.Id;
      ajax
        .call(cmsServerConfig.configApiServerPath + "biographyCategory/", biographyContent.selectedItem, "POST")
        .success(function (response) {
          biographyContent.addRequested = false;
          rashaErManage.checkAction(response);
    ...
    biographyContent.EditCategory = function (frm) {
      ...
      biographyContent.addRequested = true;
      ajax
        .call(cmsServerConfig.configApiServerPath + "biographyCategory/", biographyContent.selectedItem, "PUT")
        .success(function (response) {
      ...
      rashaErManage.showYesNo(
        ...
        function (isConfirmed) {
          if (isConfirmed) {
            ...
            buttonIsPressed = true;
            ajax
              .call(cmsServerConfig.configApiServerPath + "biographyCategory/", node.Id, "GET")
              .success(function (response) {
                buttonIsPressed = false;
                rashaErManage.checkAction(response);
    ...
    biographyContent.openAddModel = function () {
      ...
      buttonIsPressed = true;
      ajax
        .call(cmsServerConfig.configApiServerPath + "biographyContent/ViewModel", "", "GET")
        .success(function (response) {
          buttonIsPressed = false;
          rashaErManage.checkAction(response);
          ...
          $modal.open({
            templateUrl: "cpanelv1/CmsModules/biography/biographyContent/add.html",
            scope: $scope
          });
        })
        .error(function (data, errCode, c, d) {
    ...
    biographyContent.saveOtherInfos = function () {
      ...
      if (biographyContent.editMode) {
        ...
        biographyContent.selectedItemOtherInfos = {};
        // ajax.call(cmsServerConfig.configApiServerPath + 'biographyContentOtherInfo/', biographyContent.selectedItemOtherInfos, 'POST').success(function (response) {
        //   rashaErManage.checkAction(response);
        //   if (response.IsSuccess) {
    ...
    biographyContent.openEditModel = function () {
      ...
      if (biographyContent.gridOptions.selectedRow.item.LinkSiteId != $rootScope.tokenInfo.SiteId && !$rootScope.tokenInfo.UserAccessAdminAllowToAllData) {
        rashaErManage.showMessage($filter('translatentk')('This_Biography_Is_Shared'));
        return;
      }
      biographyContent.selectedItemOtherInfos = {};
      buttonIsPressed = true;
      ajax.call(cmsServerConfig.configApiServerPath + "biographyContent/", biographyContent.gridOptions.selectedRow.item.Id, "GET")
        .success(function (response1) {
          buttonIsPressed = false;
          rashaErManage.checkAction(response1);
          biographyContent.selectedItem = response1.Item;
          ...
          $modal.open({
            templateUrl: "cpanelv1/CmsModules/biography/biographyContent/edit.html",
            scope: $scope
          });
        })
        .error(function (data, errCode, c, d) {
    ...
    biographyContent.addNewContent = function (frm) {
      ...
      ajax.call(cmsServerConfig.configApiServerPath + "biographyContent/", apiSelectedItem, "POST").success(function (response) {
          rashaErManage.checkAction(response);
          biographyContent.categoryBusyIndicator.isActive = false;
          if (response.IsSuccess) {
    ...
    biographyContent.editContent = function (frm) {
      ...
      ajax
        .call(cmsServerConfig.configApiServerPath + "biographyContent/", apiSelectedItem, "PUT")
        .success(function (response) {
          biographyContent.categoryBusyIndicator.isActive = false;
          biographyContent.addRequested = false;
          biographyContent.treeConfig.showbusy = false;
      ...
      ajax
        ...
        .success(function (response) {
          ...
          biographyContent.selectedItem.IsAccepted = response.Item.IsAccepted == true ?
            ...
            true;
          ajax
            .call(cmsServerConfig.configApiServerPath + "biographyContent/", biographyContent.selectedItem, "PUT")
            .success(function (response2) {
    ...
    biographyContent.confirmComment = function (item) {
      if (item.Id && item.Id > 0) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + 'BiographyComment/', itemCopy, "PUT").success(function (response) {
          rashaErManage.checkAction(response);
          if(response.IsSuccess)
          biographyContent.showComment(biographyContent.gridOptions.selectedRow.item.Id)
        }).error(function (data, errCode, c, d) {
    ...
    biographyContent.openUploadModal = function () {
      $modal.open({
        templateUrl: "cpanelv1/CmsModules/biography/biographyContent/upload_modal.html",
        size: "lg",
        scope: $scope
      });
    ...
    biographyContent.openUploadModalPodcast = function () {
      $modal.open({
        templateUrl: 'cpanelv1/CmsModules/biography/biographyContent/upload_modalPodcast.html',
        size: 'lg',
        scope: $scope
      });
    ...
    biographyContent.openUploadModalMovie = function () {
      $modal.open({
        templateUrl: 'cpanelv1/CmsModules/biography/biographyContent/upload_modalMovie.html',
        size: 'lg',
        scope: $scope
      });
    ...
    biographyContent.replaceFile = function (name) {
      ...
      // Delete the file
      ajax
        .call(cmsServerConfig.configApiServerPath + "FileContent/", biographyContent.fileIdToDelete, "GET")
        .success(function (response1) {
          rashaErManage.checkAction(response1);
    ...
    biographyContent.saveNewFile = function () {
      ajax
        .call(cmsServerConfig.configApiServerPath + "FileContent/", biographyContent.FileItem, "POST")
        .success(function (response) {
          if (response.IsSuccess) {
      ...
      if ($("#save-icon" + index).hasClass("fa-save")) {
        if (biographyContent.fileIsExist(uploadFile.name)) { // File already exists
          ...
          ajax.call(cmsServerConfig.configApiServerPath + "FileContent/ViewModel", "", 'GET').success(function (response) {
            ...
            biographyContent.FileItem.UploadFileGUID = uploadFile.errorExceptionResult.Item.FileKey;
            ...
            // ------- biographyContent.saveNewFile()  ----------------------
            var result = 0;
            ajax.call(cmsServerConfig.configApiServerPath + "FileContent/", biographyContent.FileItem, 'POST').success(function (response) {
              if (response.IsSuccess) {
                biographyContent.FileItem = response.Item;
                biographyContent.showSuccessIcon();
                $("#save-icon" + index).removeClass("fa-save");
    ...
    biographyContent.toggleExportForm = function () {
      ...
      $modal.open({
        templateUrl: "cpanelv1/CmsModules/Biography/BiographyContent/report.html",
        scope: $scope
      });
    };
