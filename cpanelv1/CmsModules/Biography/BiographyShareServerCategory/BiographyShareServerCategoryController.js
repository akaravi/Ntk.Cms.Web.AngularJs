app.controller("biographyShareServerCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'BiographyShareMainAdminSetting/ViewModel', "", 'GET').success(function (response) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Biography/BiographyShareMainAdminSetting/add.html',
                        scope: $scope
                    });
                    biographyShareServerCategory.addRequested = false;
                }).error(function (data, errCode, c, d) {
    ...
    biographyShareServerCategory.EditCategoryModel = function () {
        ...
        biographyShareServerCategory.contentBusyIndicator.isActive = true;
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'BiographyShareMainAdminSetting/', biographyShareServerCategory.treeConfig.currentNode.Id, 'GET').success(function (response) {
            buttonIsPressed = false;
            biographyShareServerCategory.contentBusyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            biographyShareServerCategory.selectedItem = response.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Biography/BiographyShareMainAdminSetting/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
    ...
    biographyShareServerCategory.addNewCategory = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'BiographyShareMainAdminSetting/', biographyShareServerCategory.selectedItem, 'POST').success(function (response) {
            biographyShareServerCategory.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    biographyShareServerCategory.EditCategory = function (frm) {
        ...
        biographyShareServerCategory.categoryBusyIndicator.isActive = true;
        biographyShareServerCategory.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'BiographyShareMainAdminSetting/', biographyShareServerCategory.selectedItem, "PUT").success(function (response) {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'BiographyShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'BiographyShareMainAdminSetting/', biographyShareServerCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        biographyShareServerCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    biographyShareServerCategory.addNewContentModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'biographyShareServerCategory/ViewModel', "", 'GET').success(function (response) {
            buttonIsPressed = false;
            //console.log(response);
            rashaErManage.checkAction(response);
            biographyShareServerCategory.selectedItem = response.Item;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/biography/biographyShareServerCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    biographyShareServerCategory.openEditModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'biographyShareServerCategory/', biographyShareServerCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            buttonIsPressed = false;
            rashaErManage.checkAction(response1);
            biographyShareServerCategory.selectedItem = response1.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/biography/biographyShareServerCategory/edit.html',
                scope: $scope
            });
    ...
    biographyShareServerCategory.addNewContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'biographyShareServerCategory/', biographyShareServerCategory.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            biographyShareServerCategory.categoryBusyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    biographyShareServerCategory.editContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'biographyShareServerCategory/', biographyShareServerCategory.selectedItem, "PUT").success(function (response) {
            biographyShareServerCategory.categoryBusyIndicator.isActive = false;
            biographyShareServerCategory.addRequested = false;
            biographyShareServerCategory.treeConfig.showbusy = false;
    ...
    biographyShareServerCategory.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                biographyShareServerCategory.showIsBusy = true;
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+"biographyShareServerCategory/", biographyShareServerCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    buttonIsPressed = false;
                    biographyShareServerCategory.showbusy = false;
                    biographyShareServerCategory.showIsBusy = false;
                    rashaErManage.checkAction(response);
                    biographyShareServerCategory.selectedItemForDelete = response.Item;
                    console.log(biographyShareServerCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"biographyShareServerCategory/", biographyShareServerCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        biographyShareServerCategory.categoryBusyIndicator.isActive = false;
                        biographyShareServerCategory.treeConfig.showbusy = false;
                        biographyShareServerCategory.showIsBusy = false;
   ...
   // End of Upload Modal-----------------------------------------
    ...
    biographyShareServerCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Biography/biographyShareServerCategory/report.html',
            scope: $scope
        });
    }
