app.controller("biographyShareReciverCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    biographyShareReciverCategory.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"biographyShareReciverCategory/getall", engine, 'POST').success(function (response) {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'BiographyShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'BiographyShareMainAdminSetting/', biographyShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        biographyShareReciverCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    biographyShareReciverCategory.selectContent = function (node) {
        ...
        biographyShareReciverCategory.gridOptions.advancedSearchData.engine.AccessLoad = true;
    ...
    biographyShareReciverCategory.addNewContentModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'biographyShareReciverCategory/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/biography/biographyShareReciverCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    biographyShareReciverCategory.openEditModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'biographyShareReciverCategory/', biographyShareReciverCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/biography/biographyShareReciverCategory/edit.html',
                scope: $scope
            });
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"biographyShareReciverCategory/", biographyShareReciverCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    ...
                    biographyShareReciverCategory.selectedItemForDelete = response.Item;
                    console.log(biographyShareReciverCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"biographyShareReciverCategory/", biographyShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        biographyShareReciverCategory.categoryBusyIndicator.isActive = false;
                        biographyShareReciverCategory.treeConfig.showbusy = false;
                        biographyShareReciverCategory.showIsBusy = false;
    ...
    biographyShareReciverCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Biography/biographyShareReciverCategory/report.html',
            scope: $scope
        });
    }
