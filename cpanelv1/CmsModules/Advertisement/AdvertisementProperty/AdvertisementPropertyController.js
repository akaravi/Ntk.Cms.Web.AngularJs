app.controller("advertisementPropertyController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $window, $filter) {
    ...
    advertisementProperty.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"advertisementproperty/getAllwithalias", advertisementProperty.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            ...
            advertisementProperty.gridOptions.fillData(advertisementProperty.ListItems, response.Access);
    ...
    advertisementProperty.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'advertisementproperty/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Advertisement/AdvertisementProperty/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    advertisementProperty.addNewRow = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'advertisementproperty/', advertisementProperty.selectedItem, 'POST').success(function (response) {
            ...
            if (response.IsSuccess) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"advertisementpropertydetailvalue/ViewModel", "", 'GET').success(function (response1) {
    ...
    advertisementProperty.openEditModal = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'advertisementproperty/', parseInt(advertisementProperty.gridOptions.selectedRow.item.Id), 'GET').success(function (response) {
            buttonIsPressed = false;
            rashaErManage.checkAction(response);
            advertisementProperty.selectedItem = response.Item;
            ...
            //*****************************************************************
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Advertisement/AdvertisementProperty/edit.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    advertisementProperty.deleteRow = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                advertisementProperty.busyIndicator.isActive = true;
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+'advertisementproperty/', advertisementProperty.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    buttonIsPressed = false;
                    rashaErManage.checkAction(response);
                    advertisementProperty.selectedItemForDelete = response.Item;
                    ajax.call(cmsServerConfig.configApiServerPath+'advertisementproperty/', advertisementProperty.selectedItemForDelete.Id, 'DELETE').success(function (res) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'AdvertisementContract/ViewModel', "", 'GET').success(function (response) {
            ...
            if (response.IsSuccess) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'AdvertisementContract/getall', model, 'POST').success(function (response) {
                    ...
                    advertisementProperty.contractsListresultAccess = response.Access;
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Advertisement/AdvertisementProperty/addContract.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    rashaErManage.checkAction(data, errCode);
    ...
    advertisementProperty.deleteContract = function (index) {
        advertisementProperty.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'AdvertisementContract/', advertisementProperty.contractsList[index].Id, 'DELETE').success(function (res) {
            advertisementProperty.addRequested = false;
            rashaErManage.checkAction(res);
            if (res.IsSuccess) {
                advertisementProperty.contractsList.splice(index, 1);
    ...
    advertisementProperty.openUploadModal = function () {
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Advertisement/AdvertisementProperty/upload_modal.html',
            size: 'lg',
            scope: $scope
        });
    ...
    advertisementProperty.replaceFile = function (name) {
        ...
        // Delete the file
        ajax.call(cmsServerConfig.configApiServerPath+"FileContent/", advertisementProperty.fileIdToDelete, 'GET').success(function (response1) {
        ...
        if ($("#save-icon" + index).hasClass("fa-save")) {
            ...
            //--------------------------------
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/ViewModel", "", 'GET').success(function (response) {
                    ...
                    advertisementProperty.FileItem.UploadFileGUID = uploadFile.errorExceptionResult.Item.FileKey;
    ...
    advertisementProperty.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Advertisement/AdvertisementProperty/report.html',
            scope: $scope
        });
    }
