app.controller("advertisementContractController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $filter) {
    ...
    advertisementContract.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'advertisementcontract/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Advertisement/AdvertisementContract/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    advertisementContract.addNewRow = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'advertisementcontract/', advertisementContract.selectedItem, 'POST').success(function (response) {
            advertisementContract.addRequested = false;
            advertisementContract.busyIndicator.isActive = false;
            rashaErManage.checkAction(response);
    ...
    advertisementContract.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'advertisementcontract/', advertisementContract.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Advertisement/AdvertisementContract/edit.html',
                scope: $scope
            });
    ...
    advertisementContract.editRow = function (frm) {
        ...
        advertisementContract.busyIndicator.isActive = true;
        ajax.call(cmsServerConfig.configApiServerPath+'advertisementcontract/', advertisementContract.selectedItem, "PUT").success(function (response) {
            advertisementContract.addRequested = true;
            rashaErManage.checkAction(response);
            advertisementContract.busyIndicator.isActive = false;
            if (response.IsSuccess) {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'advertisementcontract/', advertisementContract.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'advertisementcontract/', advertisementContract.selectedItemForDelete.Id, 'DELETE').success(function (res) {
    ...
    cmsSitegrd.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Advertisement/AdvertisementContract/report.html',
            scope: $scope
        });
    }
