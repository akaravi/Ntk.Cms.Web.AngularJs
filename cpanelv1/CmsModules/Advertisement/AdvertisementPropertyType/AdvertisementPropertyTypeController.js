app.controller("advertisementPropertyTypeController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$state', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $state, $window, $filter) {
    ...
    advertisementPropertyType.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"advertisementpropertytype/getall", advertisementPropertyType.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            ...
            advertisementPropertyType.gridOptions.fillData(advertisementPropertyType.ListItems, response.Access);
    ...
    advertisementPropertyType.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'advertisementpropertytype/ViewModel', "", 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            advertisementPropertyType.busyIndicator.isActive = false;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Advertisement/AdvertisementPropertyType/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    advertisementPropertyType.openAddCategoryModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'advertisementpropertytypecategory/ViewModel', "", 'GET').success(function (response) {
            advertisementPropertyType.addRequested = false;
            rashaErManage.checkAction(response);
            advertisementPropertyType.selectedItem = response.Item;
            //Set dataForTheTree
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/",'', 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Advertisement/AdvertisementPropertyTypeCategory/add.html',
                        scope: $scope
                    });
                    advertisementPropertyType.addRequested = false;
                }).error(function (data, errCode, c, d) {
    ...
    advertisementPropertyType.openEditCategoryModal = function () {
        ...
        advertisementPropertyType.addRequested = true;
        advertisementPropertyType.busyIndicator.isActive = true;
        ajax.call(cmsServerConfig.configApiServerPath+'advertisementpropertytypecategory/', advertisementPropertyType.treeConfig.currentNode.Id, 'GET').success(function (response) {
            advertisementPropertyType.addRequested = false;
            advertisementPropertyType.busyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            advertisementPropertyType.selectedItem = response.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/",'', 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Advertisement/AdvertisementPropertyTypeCategory/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
    ...
    advertisementPropertyType.deleteCategory = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                advertisementPropertyType.addRequested = true;
                ajax.call(cmsServerConfig.configApiServerPath+'advertisementpropertytypecategory/', node.Id, 'GET').success(function (response) {
                    advertisementPropertyType.addRequested = false;
                    rashaErManage.checkAction(response);
                    advertisementPropertyType.selectedItemForDelete = response.Item;
                    console.log(advertisementPropertyType.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+'advertisementpropertytypecategory/', advertisementPropertyType.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        advertisementPropertyType.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    advertisementPropertyType.selectContent = function (node) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"advertisementPropertyType/getall", advertisementPropertyType.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            ...
            advertisementPropertyType.busyIndicator.isActive = false;
            advertisementPropertyType.ListItems = response.ListItems;
            advertisementPropertyType.gridOptions.fillData(advertisementPropertyType.ListItems, response.Access); // Sending Access as an argument
            advertisementPropertyType.gridOptions.currentPageNumber = response.CurrentPageNumber;
            advertisementPropertyType.gridOptions.totalRowCount = response.TotalRowCount;
            advertisementPropertyType.gridOptions.rowPerPage = response.RowPerPage;
    ...
    advertisementPropertyType.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'advertisementpropertytype/', advertisementPropertyType.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            advertisementPropertyType.selectedItem = response.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Advertisement/AdvertisementPropertyType/edit.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'advertisementpropertytype/', advertisementPropertyType.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    advertisementPropertyType.selectedItemForDelete = response.Item;
                    console.log(advertisementPropertyType.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+'advertisementpropertytype/', advertisementPropertyType.selectedItemForDelete.Id, 'DELETE').success(function (res) {
    ...
    advertisementPropertyType.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Advertisement/advertisementPropertyType/report.html',
            scope: $scope
        });
    }
