...
advertisementPropertyDetail.LinkCategoryIdSelector = {
    ...
    advertisementPropertyDetail.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"AdvertisementPropertyDetailGroup/getall", advertisementPropertyDetail.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            ...
            advertisementPropertyDetail.groupResultAccess = response.Access;
    ...
    advertisementPropertyDetail.openAddCategoryModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'AdvertisementPropertyDetailGroup/ViewModel', "", 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            advertisementPropertyDetail.selectedItem = response.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Advertisement/AdvertisementPropertyDetailGroup/add.html',
                scope: $scope
            });
    ...
    advertisementPropertyDetail.addNewCategory = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'AdvertisementPropertyDetailGroup/', advertisementPropertyDetail.selectedItem, 'POST').success(function (response) {
            advertisementPropertyDetail.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    advertisementPropertyDetail.openEditCategoryModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'AdvertisementPropertyDetailGroup/', advertisementPropertyDetail.treeConfig.currentNode.Id, 'GET').success(function (response1) {
            advertisementPropertyDetail.showbusy = false;
            rashaErManage.checkAction(response1);
            advertisementPropertyDetail.selectedItem = response1.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Advertisement/AdvertisementPropertyDetailGroup/edit.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    advertisementPropertyDetail.editCategory = function (frm) {
        ...
        advertisementPropertyDetail.categorybusyIndicator.isActive = true;
        advertisementPropertyDetail.selectedItem.IconFont = $("#iconFont").val(); //Save selected icon name in the model
        ajax.call(cmsServerConfig.configApiServerPath+'AdvertisementPropertyDetailGroup/', advertisementPropertyDetail.selectedItem, "PUT").success(function (response) {
            advertisementPropertyDetail.addRequested = true;
    ...
    advertisementPropertyDetail.deleteCategory = function () {
        ...
        if (advertisementPropertyDetail.ListItems.length == 0) {
            rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
                if (isConfirmed) {
                    advertisementPropertyDetail.categorybusyIndicator.isActive = true;
                    ajax.call(cmsServerConfig.configApiServerPath+'AdvertisementPropertyDetailGroup/', node.Id, 'GET').success(function (response) {
                        rashaErManage.checkAction(response);
                        advertisementPropertyDetail.selectedItemForDelete = response.Item;
                        ajax.call(cmsServerConfig.configApiServerPath+'AdvertisementPropertyDetailGroup/', advertisementPropertyDetail.selectedItemForDelete.Id, 'DELETE').success(function (res) {
    ...
    advertisementPropertyDetail.selectContent = function (node) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"advertisementPropertyDetail/getall", advertisementPropertyDetail.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            ...
            advertisementPropertyDetail.gridOptions.fillData(advertisementPropertyDetail.ListItems, response.Access);
    ...
    advertisementPropertyDetail.openAddContentModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'advertisementPropertyDetail/ViewModel', "", 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            advertisementPropertyDetail.selectedItem = response.Item;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Advertisement/advertisementPropertyDetail/add.html',
                scope: $scope
            });
    ...
    advertisementPropertyDetail.addNewContent = function (frm) {
        ...
        advertisementPropertyDetail.selectedItem.IconFont = $("#iconFont").val(); //Save selected icon name in the model
        ajax.call(cmsServerConfig.configApiServerPath+'advertisementPropertyDetail/', advertisementPropertyDetail.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            if (response.IsSuccess) {
                // filter text
    ...
    advertisementPropertyDetail.openEditContentModal = function () {
        ...
        advertisementPropertyDetail.FieldName = "";
        ajax.call(cmsServerConfig.configApiServerPath+'advertisementPropertyDetail/', advertisementPropertyDetail.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            rashaErManage.checkAction(response1);
            advertisementPropertyDetail.selectedItem = response1.Item;
            ...
            advertisementPropertyDetail.onMultipleChoiceChange();
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Advertisement/advertisementPropertyDetail/edit.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    advertisementPropertyDetail.editContent = function (frm) {
        ...
        advertisementPropertyDetail.selectedItem.IconFont = $("#iconFont").val(); //Save selected icon name in the model
        advertisementPropertyDetail.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'advertisementPropertyDetail/', advertisementPropertyDetail.selectedItem, "PUT").success(function (response) {
            // advertisementPropertyDetail.addRequested = false;
            advertisementPropertyDetail.treeConfig.showbusy = false;
            advertisementPropertyDetail.showIsBusy = false;
            rashaErManage.checkAction(response);
    ...
    advertisementPropertyDetail.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                advertisementPropertyDetail.showIsBusy = true;
                ajax.call(cmsServerConfig.configApiServerPath+"advertisementPropertyDetail/", advertisementPropertyDetail.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    advertisementPropertyDetail.showbusy = false;
                    advertisementPropertyDetail.showIsBusy = false;
                    rashaErManage.checkAction(response);
                    advertisementPropertyDetail.selectedItemForDelete = response.Item;
                    ajax.call(cmsServerConfig.configApiServerPath+"advertisementPropertyDetail/", advertisementPropertyDetail.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        advertisementPropertyDetail.treeConfig.showbusy = false;
                        advertisementPropertyDetail.showIsBusy = false;
    ...
    advertisementPropertyDetail.editStepGoDown = function (item, index) {
        ...
        advertisementPropertyDetail.busyIndicator.isActive = true;
        ajax.call(cmsServerConfig.configApiServerPath+'AdvertisementPropertyDetail/', item.Id, 'GET').success(function (response1) {
            rashaErManage.checkAction(response1);
            advertisementPropertyDetail.selectedItem = response1.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+'AdvertisementPropertyDetail/', advertisementPropertyDetail.selectedItem, "PUT").success(function (response2) {
                rashaErManage.checkAction(response2);
                if (response2.IsSuccess) {
                    ajax.call(cmsServerConfig.configApiServerPath+'AdvertisementPropertyDetail/', advertisementPropertyDetail.ListItems[index + 1].Id, 'GET').success(function (response3) {
                        ...
                        ajax.call(cmsServerConfig.configApiServerPath+'AdvertisementPropertyDetail/', advertisementPropertyDetail.selectedItem, "PUT").success(function (response4) {
    ...
    advertisementPropertyDetail.editStepGoDownGroup = function (item) {
        ...
        advertisementPropertyDetail.busyIndicator.isActive = true;
        ajax.call(cmsServerConfig.configApiServerPath+'advertisementPropertyDetailGroup/', item.Id, 'GET').success(function (response1) {
            rashaErManage.checkAction(response1);
            advertisementPropertyDetail.selectedItem = response1.Item;
            var temp = response1.Item.ShowInFormOrder;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+'advertisementPropertyDetailGroup/', advertisementPropertyDetail.selectedItem, "PUT").success(function (response2) {
                rashaErManage.checkAction(response2);
                if (response2.IsSuccess) {
                    ajax.call(cmsServerConfig.configApiServerPath+'advertisementPropertyDetailGroup/', advertisementPropertyDetail.treeConfig.Items[index + 1].Id, 'GET').success(function (response3) {
                        rashaErManage.checkAction(response3);
                        advertisementPropertyDetail.selectedItem = response3.Item;
                        advertisementPropertyDetail.selectedItem.ShowInFormOrder = temp;
                        ajax.call(cmsServerConfig.configApiServerPath+'advertisementPropertyDetailGroup/', advertisementPropertyDetail.selectedItem, "PUT").success(function (response4) {
                            rashaErManage.checkAction(response4);
                            if (response4.IsSuccess) {
    ...
    advertisementPropertyDetail.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Advertisement/advertisementPropertyDetail/report.html',
            scope: $scope
        });
    }
