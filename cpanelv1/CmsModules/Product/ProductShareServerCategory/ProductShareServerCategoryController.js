app.controller("productShareServerCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    productShareServerCategory.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"productShareServerCategory/getall", {}, 'POST').success(function (response) {
            ...
            productShareServerCategory.gridOptions.fillData(productShareServerCategory.ListItems, response.Access); // Sending Access as an argument
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ProductShareMainAdminSetting/ViewModel', "", 'GET').success(function (response) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Product/ProductShareMainAdminSetting/add.html',
                        scope: $scope
                    });
                    productShareServerCategory.addRequested = false;
                }).error(function (data, errCode, c, d) {
    ...
    productShareServerCategory.EditCategoryModel = function () {
        ...
        productShareServerCategory.contentBusyIndicator.isActive = true;
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'ProductShareMainAdminSetting/', productShareServerCategory.treeConfig.currentNode.Id, 'GET').success(function (response) {
            buttonIsPressed = false;
            productShareServerCategory.contentBusyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            productShareServerCategory.selectedItem = response.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Product/ProductShareMainAdminSetting/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
    ...
    productShareServerCategory.addNewCategory = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ProductShareMainAdminSetting/', productShareServerCategory.selectedItem, 'POST').success(function (response) {
            productShareServerCategory.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    productShareServerCategory.EditCategory = function (frm) {
        ...
        productShareServerCategory.categoryBusyIndicator.isActive = true;
        productShareServerCategory.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'ProductShareMainAdminSetting/', productShareServerCategory.selectedItem, "PUT").success(function (response) {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'ProductShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'ProductShareMainAdminSetting/', productShareServerCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        productShareServerCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    productShareServerCategory.addNewContentModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'productShareServerCategory/ViewModel', "", 'GET').success(function (response) {
            buttonIsPressed = false;
            //console.log(response);
            rashaErManage.checkAction(response);
            productShareServerCategory.selectedItem = response.Item;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/product/productShareServerCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    productShareServerCategory.openEditModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'productShareServerCategory/', productShareServerCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            buttonIsPressed = false;
            rashaErManage.checkAction(response1);
            productShareServerCategory.selectedItem = response1.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/product/productShareServerCategory/edit.html',
                scope: $scope
            });
    ...
    productShareServerCategory.addNewContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'productShareServerCategory/', productShareServerCategory.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            productShareServerCategory.categoryBusyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    productShareServerCategory.editContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'productShareServerCategory/', productShareServerCategory.selectedItem, "PUT").success(function (response) {
            productShareServerCategory.categoryBusyIndicator.isActive = false;
            productShareServerCategory.addRequested = false;
            productShareServerCategory.treeConfig.showbusy = false;
    ...
    productShareServerCategory.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                productShareServerCategory.showIsBusy = true;
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+"productShareServerCategory/", productShareServerCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    buttonIsPressed = false;
                    productShareServerCategory.showbusy = false;
                    productShareServerCategory.showIsBusy = false;
                    rashaErManage.checkAction(response);
                    productShareServerCategory.selectedItemForDelete = response.Item;
                    console.log(productShareServerCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"productShareServerCategory/", productShareServerCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        productShareServerCategory.categoryBusyIndicator.isActive = false;
                        productShareServerCategory.treeConfig.showbusy = false;
                        productShareServerCategory.showIsBusy = false;
   ...
   // End of Upload Modal-----------------------------------------
    ...
    productShareServerCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Product/productShareServerCategory/report.html',
            scope: $scope
        });
    }
