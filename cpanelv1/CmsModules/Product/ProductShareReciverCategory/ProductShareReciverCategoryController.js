app.controller("productShareReciverCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'ProductShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'ProductShareMainAdminSetting/', productShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        productShareReciverCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    productShareReciverCategory.addNewContentModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'productShareReciverCategory/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/product/productShareReciverCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    productShareReciverCategory.openEditModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'productShareReciverCategory/', productShareReciverCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/product/productShareReciverCategory/edit.html',
                scope: $scope
            });
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"productShareReciverCategory/", productShareReciverCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    ...
                    productShareReciverCategory.selectedItemForDelete = response.Item;
                    console.log(productShareReciverCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"productShareReciverCategory/", productShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        productShareReciverCategory.categoryBusyIndicator.isActive = false;
                        productShareReciverCategory.treeConfig.showbusy = false;
                        productShareReciverCategory.showIsBusy = false;
    ...
    productShareReciverCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Product/productShareReciverCategory/report.html',
            scope: $scope
        });
    }
