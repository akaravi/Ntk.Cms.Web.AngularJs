app.controller("productContentController", [
    ...
    function(
        ...
        productContent.gridContentOptions = {
            columns: [{
                ...
                },
                {
                    ...
                    template: '<Button ng-if="(x.RecordStatus!=1)" ng-click="productContent.confirmComment(x)" class="btn btn-primary" style="margin-left: 2px;"><i class="fa fa-check-square-o" aria-hidden="true"></i>&nbsp&nbspتایید می کنم</Button>' +
        ...
        productContent.addMenu = function() {
            ...
            $modal.open({
                templateUrl: "cpanelv1/CmsModules/product/productContent/modalMenu.html",
                scope: $scope
            });
        };
        ...
        productContent.init = function() {
            ...
            filterModel = {
                ...
                SearchType: 0,
                value: productContent.selectedContentId.Id
            };
            ...
            productContent.gridOptions.advancedSearchData.engine.AccessLoad = true;
            ajax
            ...
            ajax.call(cmsServerConfig.configApiServerPath + "productContentTag/ViewModel", "", "GET").success(function(response) { //Get a ViewModel for productContentTag
        ...
        productContent.showComment = function(LinkContentId) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath + "productcomment/getall", engine, 'POST').success(function(response) {
                ...
                productContent.gridContentOptions.fillData(productContent.ListCommentItems, response.Access); // Sending Access as an argument
        ...
        productContent.addNewCategoryModel = function() {
            ...
            ajax
                .call(cmsServerConfig.configApiServerPath + "productCategory/ViewModel", "", "GET")
                .success(function(response) {
                        ...
                        .success(function(response1) {
                            ...
                            ajax
                                ...
                                .success(function(response2) {
                                    ...
                                    $modal.open({
                                        templateUrl: "cpanelv1/CmsModules/Product/ProductCategory/add.html",
                                        scope: $scope
                                    });
                                    productContent.addRequested = false;
                                })
        ...
        productContent.EditCategoryModel = function() {
            ...
            ajax
                .call(
                    cmsServerConfig.configApiServerPath + "productCategory/",
                        ...
                        .success(function(response1) {
                            ...
                            ajax
                                ...
                                .success(function(response2) {
                                    ...
                                    $modal.open({
                                        templateUrl: "cpanelv1/CmsModules/Product/ProductCategory/edit.html",
                                        scope: $scope
                                    });
                                })
                                .error(function(data, errCode, c, d) {
        ...
        productContent.Showstatistics = function() {
            ...
            ajax.call(cmsServerConfig.configApiServerPath + 'productContent/', productContent.gridOptions.selectedRow.item.Id, 'GET').success(function(response1) {
                rashaErManage.checkAction(response1);
                productContent.selectedItem = response1.Item;
                $modal.open({
                    templateUrl: "cpanelv1/CmsModules/product/productContent/statistics.html",
                    scope: $scope
                });
            }).error(function(data, errCode, c, d) {
                rashaErManage.checkAction(data, errCode);
            ...
            rashaErManage.showYesNo(
                ...
                function(isConfirmed) {
                    if (isConfirmed) {
                        ...
                        buttonIsPressed = true;
                        ajax
                            .call(cmsServerConfig.configApiServerPath + "productCategory/", node.Id, "GET")
                            .success(function(response) {
                                buttonIsPressed = false;
                                rashaErManage.checkAction(response);
        ...
        productContent.addNewContentModel = function() {
            ...
            buttonIsPressed = true;
            ajax
                .call(cmsServerConfig.configApiServerPath + "productContent/ViewModel", "", "GET")
                .success(function(response) {
                    buttonIsPressed = false;
                    rashaErManage.checkAction(response);
                    ...
                    $modal.open({
                        templateUrl: "cpanelv1/CmsModules/product/productContent/add.html",
                        scope: $scope
                    });
                })
                .error(function(data, errCode, c, d) {
        ...
        productContent.openEditModel = function() {
            ...
            if (productContent.gridOptions.selectedRow.item.LinkSiteId != $rootScope.tokenInfo.SiteId && !$rootScope.tokenInfo.UserAccessAdminAllowToAllData) {
                rashaErManage.showMessage($filter('translatentk')('This_Product_Is_Shared'));
                return;
            }
            productContent.selectedItemOtherInfos = {};
            buttonIsPressed = true;
            ajax.call(cmsServerConfig.configApiServerPath + "productContent/", productContent.gridOptions.selectedRow.item.Id, "GET")
                .success(function(response1) {
                    buttonIsPressed = false;
                    rashaErManage.checkAction(response1);
                    productContent.selectedItem = response1.Item;
                    ...
                    var filterValue = {
                        PropertyName: "LinkContentId",
                        value: productContent.gridOptions.selectedRow.item.Id,
                        SearchType: 0
                    }
                    ...
                    $modal.open({
                        templateUrl: "cpanelv1/CmsModules/product/productContent/edit.html",
                        scope: $scope
                    });
                })
                .error(function(data, errCode, c, d) {
        ...
        productContent.addNewContent = function(frm) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath + "productContent/", apiSelectedItem, "POST").success(function(response) {
                    ...
                    if (response.IsSuccess) {
                        ...
                        if (productContent.tags && productContent.tags.length > 0) {
        ...
        productContent.editContent = function(frm) {
            ...
            if (productContent.ContentTagsRemoved && productContent.ContentTagsRemoved.length > 0) {
                ajax.call(cmsServerConfig.configApiServerPath + "productContentTag/DeleteList", productContent.ContentTagsRemoved, "POST").success(function(response) {
                        rashaErManage.checkAction(response);
                    })
                    .error(function(data, errCode, c, d) {
                        rashaErManage.checkAction(data, errCode);
            ...
            if (productContent.ContentOtherInfosRemoved && productContent.ContentOtherInfosRemoved.length > 0) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath + "productContentOtherInfo/DeleteList", OtherInfosRemovedModel, "POST").success(function(response) {
                        rashaErManage.checkAction(response);
                    })
                    .error(function(data, errCode, c, d) {
                        rashaErManage.checkAction(data, errCode);
            ...
            if (productContent.ContentSimilarsRemoved && productContent.ContentSimilarsRemoved.length > 0) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath + "productContentSimilar/DeleteList", SimilarsRemovedModel, "POST").success(function(response) {
                        rashaErManage.checkAction(response);
                    })
                    .error(function(data, errCode, c, d) {
                        rashaErManage.checkAction(data, errCode);
            ...
            if (productContent.ContentModuleRelationShipRemoved && productContent.ContentModuleRelationShipRemoved.length > 0) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath + "CoreModuleRelationshipContent/DeleteList", productContent.ContentModuleRelationShipRemoved, "POST").success(function(response) {
                        rashaErManage.checkAction(response);
                    })
                    .error(function(data, errCode, c, d) {
                        rashaErManage.checkAction(data, errCode);
            ...
            if (productContent.ContentModuleRelationShipAdded && productContent.ContentModuleRelationShipAdded.length > 0) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath + "CoreModuleRelationshipContent/addbatch", productContent.ContentModuleRelationShipAdded, "POST").success(function(response) {
                        rashaErManage.checkAction(response);
                    })
                    .error(function(data, errCode, c, d) {
                        rashaErManage.checkAction(data, errCode);
            ...
            rashaErManage.showYesNo(
                ...
                function(isConfirmed) {
                    if (isConfirmed) {
                        ...
                        ajax
                            .call(
                                cmsServerConfig.configApiServerPath + "productContent/",
            ...
            rashaErManage.showYesNo(
                ...
                function(isConfirmed) {
                    if (isConfirmed) {
                        ...
                        var itemCopy = angular.copy(item);
                        itemCopy.rowOption = null;
                        ajax.call(cmsServerConfig.configApiServerPath + "productComment/", itemCopy.Id, "DELETE")
                            .success(function(res) {
                                productContent.treeConfig.showbusy = false;
                                productContent.showbusy = false;
                                productContent.showIsBusy = false;
        ...
        productContent.deleteAttachedfieldName = function(index) {
            ajax
                .call(
                    cmsServerConfig.configApiServerPath + "productContent/",
                    productContent.contractsList[index].Id,
                    "DELETE"
                )
                .success(function(res) {
                    rashaErManage.checkAction(res);
        ...
        productContent.openUploadModal = function() {
            $modal.open({
                templateUrl: "cpanelv1/CmsModules/product/productContent/upload_modal.html",
                size: "lg",
                scope: $scope
            });
        ...
        productContent.openUploadModalPodcast = function() {
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/product/productContent/upload_modalPodcast.html',
                size: 'lg',
                scope: $scope
            });
        ...
        productContent.openUploadModalMovie = function() {
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/product/productContent/upload_modalMovie.html',
                size: 'lg',
                scope: $scope
            });
        ...
        productContent.replaceFile = function(name) {
            ...
            // Delete the file
            ajax
                .call(cmsServerConfig.configApiServerPath + "FileContent/", productContent.fileIdToDelete, "GET")
                .success(function(response1) {
                    rashaErManage.checkAction(response1);
            ...
            if ($("#save-icon" + index).hasClass("fa-save")) {
                if (productContent.fileIsExist(uploadFile.name)) { // File already exists
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath + "FileContent/ViewModel", "", 'GET').success(function(response) {
                        ...
                        productContent.FileItem.UploadFileGUID = uploadFile.errorExceptionResult.Item.FileKey;
        ...
        productContent.toggleExportForm = function() {
            ...
            $modal.open({
                templateUrl: "cpanelv1/CmsModules/Product/ProductContent/report.html",
                scope: $scope
            });
        };
