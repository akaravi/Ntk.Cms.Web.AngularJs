app.controller("campaignCategoryCtrl", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $filter) {
    ...
    campaignCategory.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"campaignCategory/getall",engine , 'POST').success(function (response) {

            rashaErManage.checkAction(response);
            campaignCategory.ListItems = response.ListItems;
            campaignCategory.categoryBusyIndicator.isActive = false;
            campaignCategory.gridOptions.fillData(campaignCategory.ListItems, response.Access);
    ...
    campaignCategory.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'campaignCategory/', campaignCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            campaignCategory.selectedItem = response.Item;
            //Set dataForTheTree
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'campaignCategory/', campaignCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'campaignCategory/', campaignCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        campaignCategory.categoryBusyIndicator.isActive = false;
