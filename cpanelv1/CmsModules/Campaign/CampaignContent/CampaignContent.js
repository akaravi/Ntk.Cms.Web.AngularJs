app.controller("campaignContentController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter',
 ...
 //For Grid Options
    ...
    campaignContent.addMenu = function () {
        $modal.open({
            templateUrl: "cpanelv1/CmsModules/Campaign/campaignContent/modalMenu.html",
            scope: $scope
        });
    }
    ...
    campaignContent.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"campaignContentTag/ViewModel", "", 'GET').success(function (response) { //Get a ViewModel for campaignContentTag
    ...
    campaignContent.showComment = function () {
        ...
        if (campaignContent.gridOptions.selectedRow.item) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+'newsComment/getall', campaignContent.gridContentOptions.advancedSearchData.engine, 'POST').success(function (response) {
                ...
                campaignContent.gridContentOptions.fillData(campaignContent.listComments, response.Access);
    ...
    campaignContent.addNewCategoryModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'CampaignCategory/ViewModel', "", 'GET').success(function (response) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Campaign/CampaignCategory/add.html',
                        scope: $scope
                    });
                    campaignContent.addRequested = false;
                }).error(function (data, errCode, c, d) {
    ...
    campaignContent.EditCategoryModel = function () {
        ...
        campaignContent.contentBusyIndicator.isActive = true;
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'CampaignCategory/', campaignContent.treeConfig.currentNode.Id, 'GET').success(function (response) {
            buttonIsPressed = false;
            campaignContent.contentBusyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            campaignContent.selectedItem = response.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Campaign/CampaignCategory/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
    ...
    campaignContent.deleteCategory = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+'CampaignCategory/', node.Id, 'GET').success(function (response) {
                    buttonIsPressed = false;
                    rashaErManage.checkAction(response);
    ...
    campaignContent.addNewContentModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'campaignContent/ViewModel', "", 'GET').success(function (response) {
            buttonIsPressed = false;
            //console.log(response);
            rashaErManage.checkAction(response);
            campaignContent.selectedItem = response.Item;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Campaign/campaignContent/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    campaignContent.openEditModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'campaignContent/', campaignContent.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            buttonIsPressed = false;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Campaign/campaignContent/edit.html',
                scope: $scope
            });
    ...
    campaignContent.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                campaignContent.showIsBusy = true;
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+"campaignContent/", campaignContent.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    buttonIsPressed = false;
                    campaignContent.showbusy = false;
                    campaignContent.showIsBusy = false;
                    rashaErManage.checkAction(response);
    ...
    campaignContent.openUploadModal = function () {
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Campaign/campaignContent/upload_modal.html',
            size: 'lg',
            scope: $scope
        });
        ...
        if ($("#save-icon" + index).hasClass("fa-save")) {
            ...
            //--------------------------------
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/ViewModel", "", 'GET').success(function (response) {
                    ...
                    campaignContent.FileItem.UploadFileGUID = uploadFile.errorExceptionResult.Item.FileKey;
    ...
    campaignContent.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Campaign/campaignContent/report.html',
            scope: $scope
        });
    }
