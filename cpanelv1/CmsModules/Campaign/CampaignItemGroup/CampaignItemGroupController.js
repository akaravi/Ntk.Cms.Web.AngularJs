app.controller("campaignItemGroupCtrl", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $filter) {
    ...
    campaignItemGroup.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"CampaignItemGroup/getall",engine, 'POST').success(function (response) {
            ...
            campaignItemGroup.gridOptions.fillData(campaignItemGroup.ListItems, response.Access);
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'CampaignItemGroup/ViewModel', "", 'GET').success(function (response) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/News/CampaignItemGroup/add.html',
                        scope: $scope
                    });
    ...
    campaignItemGroup.addNewRow = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'CampaignItemGroup/', campaignItemGroup.selectedItem, 'POST').success(function (response) {
            campaignItemGroup.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    campaignItemGroup.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'CampaignItemGroup/', campaignItemGroup.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            campaignItemGroup.selectedItem = response.Item;
            //Set dataForTheTree
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/News/CampaignItemGroup/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'CampaignItemGroup/', campaignItemGroup.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'CampaignItemGroup/', campaignItemGroup.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        campaignItemGroup.categoryBusyIndicator.isActive = false;
