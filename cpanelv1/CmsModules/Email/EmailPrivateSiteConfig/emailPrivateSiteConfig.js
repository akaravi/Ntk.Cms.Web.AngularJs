...
//#help/ سلکتور similar
    ...
    emailPrivateSiteConfig.init = function() {
        ...
        //     }]
        // };
        ajax.call(cmsServerConfig.configApiServerPath+'emailpublicconfig/getonewithjsonformatter',  emailPrivateSiteConfig.selectedPublicConfig.Id, 'GET').success(function(response) {
    ...
    emailPrivateSiteConfig.openAddModal = function() {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'emailprivatesiteconfig/ViewModel', '', 'GET').success(function(response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Email/EmailPrivateSiteConfig/add.html',
                scope: $scope
            });
...
emailPrivateSiteConfig.removeFromCollection = function(listsimilar,idSuperSeder) {
    ...
    emailPrivateSiteConfig.openEditModal = function() {
        ...
        buttonIsPressed = true;
        emailPrivateSiteConfig.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'emailprivatesiteconfig/getonewithjsonformatter',  emailPrivateSiteConfig.gridOptions.selectedRow.item.Id, 'GET').success(function(response) {
            buttonIsPressed = false;
            emailPrivateSiteConfig.addRequested = false;
            rashaErManage.checkAction(response);
            emailPrivateSiteConfig.selectedItem = response.Item;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Email/EmailPrivateSiteConfig/edit.html',
                scope: $scope
            });
        }).error(function(data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function(isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'emailprivatesiteconfig/', emailPrivateSiteConfig.gridOptions.selectedRow.item.Id, 'GET').success(function(response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'emailprivatesiteconfig/', emailPrivateSiteConfig.selectedItemForDelete.Id, 'DELETE').success(function(res) {
    ...
    emailPrivateSiteConfig.toggleExportForm = function() {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Email/EmailPrivateSiteConfig/report.html',
            scope: $scope
        });
    }
    ...
    emailPrivateSiteConfig.openBaseConfigModal = function(selectedId) {
        ...
        // };
        emailPrivateSiteConfig.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+"emailPrivateSiteConfig/getonewithjsonformatter", selectedId, 'GET').success(function(response) {
            emailPrivateSiteConfig.addRequested = false;
            if (response.IsSuccess) {
                emailPrivateSiteConfig.selectedItem = response.Item;
                $modal.open({
                    templateUrl: 'cpanelv1/CmsModules/Email/EmailPrivateSiteConfig/preview.html',
                    scope: $scope
                });
                $builder.removeAllFormObject('default');
                //var customizeValue = JSON.parse(response.Item.emailPrivateSiteConfigJsonValues);
    ...
    emailPrivateSiteConfig.openTestEmailModal = function(selectedId) {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Email/EmailPrivateSiteConfig/testEmail.html',
            scope: $scope
