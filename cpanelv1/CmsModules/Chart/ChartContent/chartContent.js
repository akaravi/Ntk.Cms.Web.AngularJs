...
//#help/ سلکتور دسته بندی در ویرایش محتوا
 chartContent.LinkCategoryIdSelector = {
    ...
    chartContent.addMenu = function () {
        $modal.open({
            templateUrl: "cpanelv1/CmsModules/Chart/ChartContent/modalMenu.html",
            scope: $scope
        });
    }
    ...
    chartContent.init = function () {
        ...
        filterModel = { PropertyName: "ContentTags",PropertyAnyName:"LinkTagId", SearchType: 0, value: chartContent.selectedContentId.Id };
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"chartContent/getall", chartContent.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            ...
            chartContent.gridOptions.fillData(chartContent.ListItems, response.Access); // Sending Access as an argument
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"chartTag/ViewModel", "", 'GET').success(function (response) {    //Get a ViewModel for BiographyTag
            chartContent.ModuleTag = response.Item;
        }).error(function (data, errCode, c, d) {
            console.log(data);
        });
        ajax.call(cmsServerConfig.configApiServerPath+"chartContentTag/ViewModel", "", 'GET').success(function (response) { //Get a ViewModel for chartContentTag
    ...
    chartContent.showComment = function () {
        if (chartContent.gridOptions.selectedRow.item) {
            ...
            var Filter_value1 = {
                ...
                value: chartContent.gridOptions.selectedRow.item.Id,
                SearchType: 0
            }
    ...
    chartContent.addNewCategoryModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ChartCategory/ViewModel', "", 'GET').success(function (response) {
            chartContent.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    chartContent.editCategoryModel = function () {
        ...
        chartContent.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'ChartCategory/', chartContent.treeConfig.currentNode.Id, 'GET').success(function (response) {
            chartContent.addRequested = false;
            rashaErManage.checkAction(response);
            chartContent.selectedItem = response.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Chart/ChartCategory/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
    ...
    chartContent.deleteCategory = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'chartcategory/', node.Id, 'GET').success(function (response) {
    ...
    chartContent.Showstatistics = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'chartcontent/', chartContent.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            rashaErManage.checkAction(response1);
            chartContent.selectedItem = response1.Item;
            $modal.open({
                templateUrl: "cpanelv1/CmsModules/Chart/ChartContent/statistics.html",
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    chartContent.addNewContentModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'chartcontent/ViewModel', "", 'GET').success(function (response) {
            buttonIsPressed = false;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Chart/ChartContent/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    chartContent.openEditModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'chartContent/', chartContent.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Chart/chartContent/edit.html',
                scope: $scope
            });
    ...
    chartContent.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                chartContent.showIsBusy = true;
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+"chartContent/", chartContent.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    buttonIsPressed = false;
                    chartContent.showbusy = false;
                    chartContent.showIsBusy = false;
                    rashaErManage.checkAction(response);
  ...
  //#help similar & otherinfo
   ...
   chartContent.editOtherInfo = function(y) {
    ...
    chartContent.openUploadModal = function () {
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Chart/ChartContent/upload_modal.html',
            size: 'lg',
            scope: $scope
        });
...
//---------------Upload Modal Podcast-------------------------------
     chartContent.openUploadModalPodcast = function () {
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Chart/chartContent/upload_modalPodcast.html',
            size: 'lg',
            scope: $scope
        });
...
//upload file Podcast
 ...
 // replace the file
    ...
    chartContent.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Chart/ChartContent/report.html',
            scope: $scope
        });
    }
