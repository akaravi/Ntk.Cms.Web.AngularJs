 ...
 chartTag.LinkCategoryTagIdSelector = {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'chartCategorytag/ViewModel', "", 'GET').success(function (response) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/chart/chartCategorytag/add.html',
                        scope: $scope
                    });
                    chartTag.addRequested = false;
                }).error(function (data, errCode, c, d) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'chartCategorytag/', chartTag.treeConfig.currentNode.Id, 'GET').success(function (response) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/chart/chartCategorytag/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'chartCategorytag/', node.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'chartCategorytag/', chartTag.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        chartTag.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
                            chartTag.gridOptions.advancedSearchData.engine.Filters = null;
                            chartTag.gridOptions.advancedSearchData.engine.Filters = [];
    ...
    chartTag.openAddModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'charttag/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/chart/charttag/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    chartTag.openEditModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'charttag/', chartTag.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/chart/charttag/edit.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"charttag/", chartTag.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+"charttag/", chartTag.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        chartTag.categoryBusyIndicator.isActive = false;
                        chartTag.treeConfig.showbusy = false;
                        chartTag.showIsBusy = false;
            ...
            ajax
              ...
              .error(function(data) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/ViewModel", "", 'GET').success(function (response) {
                    ...
                    chartTag.FileItem.UploadFileGUID = uploadFile.errorExceptionResult.Item.FileKey;
    ...
    chartTag.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/chart/charttag/report.html',
            scope: $scope
        });
    }
