...
var todayDate = moment().format();
    ...
    chartContentEvent.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'chartContentEvent/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Chart/chartContentEvent/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    chartContentEvent.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'chartContentEvent/', chartContentEvent.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Chart/chartContentEvent/edit.html',
                scope: $scope
            });
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'chartContentEvent/', chartContentEvent.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'chartContentEvent/', chartContentEvent.selectedItemForDelete.Id, 'DELETE').success(function (res) {
    ...
    chartContentEvent.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Chart/chartContentEvent/report.html',
            scope: $scope
        });
    }
