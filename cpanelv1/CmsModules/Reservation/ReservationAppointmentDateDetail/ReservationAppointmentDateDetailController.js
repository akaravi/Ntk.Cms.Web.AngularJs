app.controller("reservationAppointmentDateDetailController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    appDateDetail.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"ReservationAppointmentDateDetail/getall", appDateDetail.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            ...
            appDateDetail.gridOptions.fillData(appDateDetail.ListItems, response.Access);
    ...
    appDateDetail.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ReservationAppointmentDateDetail/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Reservation/ReservationAppointmentDateDetail/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    appDateDetail.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ReservationAppointmentDateDetail/', appDateDetail.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            appDateDetail.selectedItem = response.Item;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Reservation/ReservationAppointmentDateDetail/edit.html',
                scope: $scope
            });
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'ReservationAppointmentDateDetail/', appDateDetail.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'ReservationAppointmentDateDetail/', appDateDetail.selectedItemForDelete.Id, 'DELETE').success(function (res) {
    ...
    appDateDetail.openSetTimesModal = function (dateId) {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Reservation/ReservationAppointmentDateDetail/setTimes.html',
            scope: $scope
        });
