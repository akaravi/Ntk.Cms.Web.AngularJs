app.controller("reservationContentController", [
    ...
    function (
        ...
        reservationContent.addMenu = function () {
            $modal.open({
                templateUrl: "cpanelv1/CmsModules/reservation/reservationContent/modalMenu.html",
                scope: $scope
            });
        };
        ...
        reservationContent.init = function () {
            ...
            ajax
                .call(cmsServerConfig.configApiServerPath + "reservationTag/ViewModel", "", "GET")
                .success(function (response) {
            ...
            ajax
                .call(cmsServerConfig.configApiServerPath + "reservationContentTag/ViewModel", "", "GET")
                .success(function (response) {
        ...
        reservationContent.showComment = function (LinkContentId) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"reservationcomment/getall", engine, 'POST').success(function (response) {
                ...
                reservationContent.gridContentOptions.fillData(reservationContent.ListCommentItems, response.Access); // Sending Access as an argument
        ...
        reservationContent.Showstatistics = function () {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+'reservationContent/', reservationContent.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
                rashaErManage.checkAction(response1);
                reservationContent.selectedItem = response1.Item;
                $modal.open({
                    templateUrl: "cpanelv1/CmsModules/reservation/reservationContent/statistics.html",
                    scope: $scope
                });
            }).error(function (data, errCode, c, d) {
                rashaErManage.checkAction(data, errCode);
        ...
        reservationContent.addNewCategoryModel = function () {
            ...
            ajax
                .call(cmsServerConfig.configApiServerPath + "reservationCategory/ViewModel", "", "GET")
                .success(function (response) {
                        ...
                        .success(function (response1) {
                            ...
                            ajax
                                ...
                                .success(function (response2) {
                                    ...
                                    $modal.open({
                                        templateUrl: "cpanelv1/CmsModules/reservation/reservationCategory/add.html",
                                        scope: $scope
                                    });
                                    reservationContent.addRequested = false;
                                })
                        ...
                        .success(function (response1) {
                            ...
                            ajax
                                ...
                                .success(function (response2) {
                                    ...
                                    $modal.open({
                                        templateUrl: "cpanelv1/CmsModules/reservation/reservationCategory/edit.html",
                                        scope: $scope
                                    });
                                })
                                .error(function (data, errCode, c, d) {
            ...
            rashaErManage.showYesNo(
                ...
                function (isConfirmed) {
                    if (isConfirmed) {
                        ...
                        buttonIsPressed = true;
                        ajax
                            .call(cmsServerConfig.configApiServerPath + "reservationCategory/", node.Id, "GET")
                            .success(function (response) {
                                buttonIsPressed = false;
                                rashaErManage.checkAction(response);
        ...
        reservationContent.addNewContentModel = function () {
            ...
            buttonIsPressed = true;
            ajax
                .call(cmsServerConfig.configApiServerPath + "reservationContent/ViewModel", "", "GET")
                .success(function (response) {
                    buttonIsPressed = false;
                    console.log(response);
                    rashaErManage.checkAction(response);
                    ...
                    $modal.open({
                        templateUrl: "cpanelv1/CmsModules/reservation/reservationContent/add.html",
                        scope: $scope
                    });
                })
                .error(function (data, errCode, c, d) {
        ...
        reservationContent.openEditModel = function () {
            ...
            if (reservationContent.gridOptions.selectedRow.item.LinkSiteId != $rootScope.tokenInfo.SiteId && !$rootScope.tokenInfo.UserAccessAdminAllowToAllData) {
            ...
            ajax
                ...
                .success(function (response1) {
                    ...
                    $modal.open({
                        templateUrl: "cpanelv1/CmsModules/reservation/reservationContent/edit.html",
                        scope: $scope
                    });
                })
                .error(function (data, errCode, c, d) {
        ...
        reservationContent.openUploadModalPodcast = function () {
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/reservation/reservationContent/upload_modalPodcast.html',
                size: 'lg',
                scope: $scope
            });
        ...
        reservationContent.replaceFile = function (name) {
            ...
            // Delete the file
            ajax
                .call(cmsServerConfig.configApiServerPath + "FileContent/", reservationContent.fileIdToDelete, "GET")
                .success(function (response1) {
        ...
        reservationContent.toggleExportForm = function () {
            ...
            $modal.open({
                templateUrl: "cpanelv1/CmsModules/reservation/reservationContent/report.html",
                scope: $scope
            });
        };
