app.controller("discountSerialCardFlowGroupController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    discountSerialCardFlowGroup.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'DiscountSerialCardFlowGroup/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Discount/discountSerialCardFlowGroup/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    discountSerialCardFlowGroup.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'DiscountSerialCardFlowGroup/', discountSerialCardFlowGroup.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Discount/discountSerialCardFlowGroup/edit.html',
                scope: $scope
            });
    ...
    discountSerialCardFlowGroup.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Discount/discountSerialCardFlowGroup/report.html',
            scope: $scope
        });
    }
