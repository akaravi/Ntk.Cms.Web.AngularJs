app.controller("fileShareReciverCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$rootScope', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $rootScope, $filter) {
    ...
    fileShareReciverCategory.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"FileShareReciverCategory/getall",engine, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            fileShareReciverCategory.ListItems = response.ListItems;
            fileShareReciverCategory.gridOptions.fillData(fileShareReciverCategory.ListItems, response.Access); // Sending Access as an argument
    ...
    fileShareReciverCategory.addNewCategoryModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'FileShareMainAdminSetting/ViewModel', "", 'GET').success(function (response) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/File/FileShareMainAdminSetting/add.html',
                        scope: $scope
                    });
                    fileShareReciverCategory.addRequested = false;
                }).error(function (data, errCode, c, d) {
    ...
    fileShareReciverCategory.EditCategoryModel = function () {
        ...
        fileShareReciverCategory.contentBusyIndicator.isActive = true;
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'FileShareMainAdminSetting/', fileShareReciverCategory.treeConfig.currentNode.Id, 'GET').success(function (response) {
            buttonIsPressed = false;
            fileShareReciverCategory.contentBusyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            fileShareReciverCategory.selectedItem = response.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/File/FileShareMainAdminSetting/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
    ...
    fileShareReciverCategory.addNewCategory = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'FileShareMainAdminSetting/', fileShareReciverCategory.selectedItem, 'POST').success(function (response) {
            fileShareReciverCategory.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    fileShareReciverCategory.EditCategory = function (frm) {
        ...
        fileShareReciverCategory.categoryBusyIndicator.isActive = true;
        fileShareReciverCategory.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'FileShareMainAdminSetting/', fileShareReciverCategory.selectedItem, "PUT").success(function (response) {
    ...
    fileShareReciverCategory.deleteCategory = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+'FileShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    buttonIsPressed = false;
                    rashaErManage.checkAction(response);
                    fileShareReciverCategory.selectedItemForDelete = response.Item;
                    console.log(fileShareReciverCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+'FileShareMainAdminSetting/', fileShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        fileShareReciverCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    fileShareReciverCategory.selectContent = function (node) {
        ...
        fileShareReciverCategory.gridOptions.advancedSearchData.engine.AccessLoad = true;
    ...
    fileShareReciverCategory.addNewContentModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'FileShareReciverCategory/ViewModel', "", 'GET').success(function (response) {
            buttonIsPressed = false;
            //console.log(response);
            rashaErManage.checkAction(response);
            fileShareReciverCategory.selectedItem = response.Item;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/file/fileShareReciverCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    fileShareReciverCategory.openEditModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'FileShareReciverCategory/', fileShareReciverCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            buttonIsPressed = false;
            rashaErManage.checkAction(response1);
            fileShareReciverCategory.selectedItem = response1.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/file/fileShareReciverCategory/edit.html',
                scope: $scope
            });
    ...
    fileShareReciverCategory.addNewContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'FileShareReciverCategory/', fileShareReciverCategory.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            fileShareReciverCategory.categoryBusyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    fileShareReciverCategory.editContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'FileShareReciverCategory/', fileShareReciverCategory.selectedItem, "PUT").success(function (response) {
            fileShareReciverCategory.categoryBusyIndicator.isActive = false;
            fileShareReciverCategory.addRequested = false;
            fileShareReciverCategory.treeConfig.showbusy = false;
    ...
    fileShareReciverCategory.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                fileShareReciverCategory.showIsBusy = true;
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+"FileShareReciverCategory/", fileShareReciverCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    buttonIsPressed = false;
                    fileShareReciverCategory.showbusy = false;
                    fileShareReciverCategory.showIsBusy = false;
                    rashaErManage.checkAction(response);
                    fileShareReciverCategory.selectedItemForDelete = response.Item;
                    console.log(fileShareReciverCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"FileShareReciverCategory/", fileShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        fileShareReciverCategory.categoryBusyIndicator.isActive = false;
                        fileShareReciverCategory.treeConfig.showbusy = false;
                        fileShareReciverCategory.showIsBusy = false;
    ...
    fileShareReciverCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/File/fileShareReciverCategory/report.html',
            scope: $scope
        });
    }
