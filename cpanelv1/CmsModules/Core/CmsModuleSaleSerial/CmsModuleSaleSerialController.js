app.controller("cmsModuleSaleSerialController", [
    ...
    function (
       ...
       // longitude: 'Geolocationlongitude',
        ...
        //    ajax
        //      .call("/api/ArticleTag/", tagObject, "POST")
        ...
        cmsModuleSaleSerial.addMenu = function () {
            ...
            $modal.open({
                templateUrl: "cpanelv1/CmsModules/Core/cmsModuleSaleSerial/modalMenu.html",
                scope: $scope
            });
        };
        cmsModuleSaleSerial.openmodalUse = function () {
            ...
            $modal.open({
                templateUrl: "cpanelv1/CmsModules/Core/cmsModuleSaleSerial/Chekmodal.html",
                scope: $scope
            });
        };
        ...
        cmsModuleSaleSerial.addNewCategory = function (frm) {
            ...
            if (cmsModuleSaleSerial.treeConfig.currentNode != null)
                cmsModuleSaleSerial.selectedItem.LinkParentId =
                    cmsModuleSaleSerial.treeConfig.currentNode.Id;
            ajax
                .call(cmsServerConfig.configApiServerPath + "CoreModuleSaleHeader/", cmsModuleSaleSerial.selectedItem, "POST")
                .success(function (response) {
                    cmsModuleSaleSerial.addRequested = false;
                    rashaErManage.checkAction(response);
        ...
        cmsModuleSaleSerial.editCategory = function (frm) {
            ...
            cmsModuleSaleSerial.categoryBusyIndicator.isActive = true;
            ajax
                .call(cmsServerConfig.configApiServerPath + "CoreModuleSaleHeader/", cmsModuleSaleSerial.selectedItem, "PUT")
                .success(function (response) {
                    cmsModuleSaleSerial.addRequested = true;
        ...
        cmsModuleSaleSerial.addNewContentModel = function () {
            ...
            buttonIsPressed = true;
            ajax
                .call(cmsServerConfig.configApiServerPath + "CoreModuleSaleSerial/ViewModel", "", "GET")
                .success(function (response) {
                    buttonIsPressed = false;
                    ...
                    $modal.open({
                        templateUrl: "cpanelv1/CmsModules/Core/cmsModuleSaleSerial/add.html",
                        scope: $scope
                    });
                })
                .error(function (data, errCode, c, d) {
        ...
        cmsModuleSaleSerial.openEditModel = function () {
            ...
            ajax
                .call(
                    cmsServerConfig.configApiServerPath+"CoreModuleSaleSerial/",
                ...
                .success(function (response1) {
                    ...
                    $modal.open({
                        templateUrl: "cpanelv1/CmsModules/Core/cmsModuleSaleSerial/edit.html",
                        scope: $scope
                    });
                })
                .error(function (data, errCode, c, d) {
        ...
        cmsModuleSaleSerial.addNewContent = function (frm) {
            ...
            ajax
                .call(cmsServerConfig.configApiServerPath + "CoreModuleSaleSerial/", cmsModuleSaleSerial.selectedItem, "POST")
                .success(function (response) {
                    rashaErManage.checkAction(response);
                    cmsModuleSaleSerial.categoryBusyIndicator.isActive = false;
                    if (response.IsSuccess) {
        ...
        cmsModuleSaleSerial.editContent = function (frm) {
            ...
            //  });
            ajax
                .call(cmsServerConfig.configApiServerPath + "CoreModuleSaleSerial/", cmsModuleSaleSerial.selectedItem, "PUT")
                .success(function (response) {
                    cmsModuleSaleSerial.categoryBusyIndicator.isActive = false;
                    cmsModuleSaleSerial.addRequested = false;
                    cmsModuleSaleSerial.treeConfig.showbusy = false;
        ...
        //                cmsModuleSaleSerial.showbusy = true;
        //                cmsModuleSaleSerial.showIsBusy = true;
        //                ajax.call(cmsServerConfig.configApiServerPath+'CoreModuleSaleSerial/', cmsModuleSaleSerial.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
        //                    cmsModuleSaleSerial.showbusy = false;
        //                    cmsModuleSaleSerial.showIsBusy = false;
        //                    rashaErManage.checkAction(response);
        //                    cmsModuleSaleSerial.selectedItemForDelete = response.Item;
        //                    console.log(cmsModuleSaleSerial.selectedItemForDelete);
        //                    ajax.call(cmsServerConfig.configApiServerPath+'CoreModuleSaleSerial/', cmsModuleSaleSerial.selectedItemForDelete.Id, 'DELETE').success(function (res) {
        //                        cmsModuleSaleSerial.treeConfig.showbusy = false;
        //                        cmsModuleSaleSerial.showIsBusy = false;
        //                        rashaErManage.checkAction(res);
        //                        if (res.IsSuccess) {
        ...
        cmsModuleSaleSerial.toggleExportForm = function () {
            ...
            $modal.open({
                templateUrl: "cpanelv1/CmsModules/Core/cmsModuleSaleSerial/report.html",
                scope: $scope
            });
        };
