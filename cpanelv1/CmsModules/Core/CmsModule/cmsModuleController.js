app.controller("cmsModuleGridCtrl", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$builder', '$window', '$filter', '$rootScope', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $builder, $window, $filter, $rootScope) {
    ...
    cmsModulegrd.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'coremodule/ViewModel', '', 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Core/cmsModule/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    cmsModulegrd.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'coremodule/', cmsModulegrd.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Core/cmsModule/edit.html',
                scope: $scope
            });
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'coremodule/', cmsModulegrd.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'coremodule/', cmsModulegrd.selectedItemForDelete.Id, 'DELETE').success(function (res) {
    ...
    cmsModulegrd.gridOptions = {
        columns: [
            ...
            // { name: 'ModuleConfigAdminMainJson', displayName: 'تنظیمات ماژول', sortable: true, visible: 'cmsModulegrd.CheckAccessEdit("ModuleConfigAdminMainJson")', template: '<a ng-if="cmsModulegrd.CheckAccessEdit(\'ModuleConfigAdminMainJson\')" class="btn btn-warning" ng-show="cmsModulegrd.gridOptions.Access.AccessWatchRow" ng-click="cmsModulegrd.designForm(x, \'ModuleConfigAdminMainJsonForm\')" title="طراحی فرم"><i class="fa fa-paint-brush" aria-hidden="true"></i></a>&nbsp;<a ng-if="cmsModulegrd.CheckAccessEdit(\'ModuleConfigAdminMainJsonForm\')" class="btn btn-success" ng-click="cmsModulegrd.openPreviewModal(x, \'ModuleConfigAdminMainJsonForm\', \'ModuleConfigAdminMainJson\')" title="مقداردهی"><i class="fa fa-pencil" aria-hidden="true"></i></a>' },
            // { name: 'ModuleConfigSiteAccessDefaultJson', displayName: 'تنظیمات دسترسی', sortable: true, visible: 'cmsModulegrd.CheckAccessEdit("ModuleConfigSiteAccessDefaultJson")', template: '<a ng-if="cmsModulegrd.CheckAccessEdit(\'ModuleConfigSiteAccessDefaultJson\')" class="btn btn-warning" ng-show="cmsModulegrd.gridOptions.Access.AccessWatchRow" ng-click="cmsModulegrd.designForm(x, \'ModuleConfigSiteAccessJsonFrom\')" title="طراحی فرم\"><i class=\"fa fa-paint-brush\" aria-hidden="true"></i></a>&nbsp;<a  ng-if="cmsModulegrd.CheckAccessEdit(\'ModuleConfigSiteJsonForm\')" class="btn btn-success" ng-click="cmsModulegrd.openPreviewModal(x, \'ModuleConfigSiteAccessJsonFrom\', \'ModuleConfigSiteAccessDefaultJson\')" title="مقداردهی"><i class=\"fa fa-pencil\" aria-hidden="true"></i></a>' },
            // { name: 'ModuleConfigSiteDefaultJson', displayName: 'تنظیمات سایت', sortable: true, template: '<a ng-if="cmsModulegrd.CheckAccessEdit(\'ModuleConfigSiteJsonForm\')" class="btn btn-warning" ng-show="cmsModulegrd.gridOptions.Access.AccessWatchRow" ng-click="cmsModulegrd.designForm(x, \'ModuleConfigSiteJsonForm\')" title="طراحی فرم"><i class="fa fa-paint-brush" aria-hidden="true"></i></a>&nbsp;<a ng-if="cmsModulegrd.CheckAccessEdit(\'ModuleConfigSiteDefaultJson\')" class="btn btn-success" ng-click="cmsModulegrd.openPreviewModal(x, \'ModuleConfigSiteJsonForm\', \'ModuleConfigSiteDefaultJson\')" title="مقداردهی"><i class=\"fa fa-pencil\" aria-hidden="true"></i></a>' },
            // { name: 'ModuleSiteStorageValuesJsonForm', displayName: 'مقادیر موردنیاز', sortable: true, visible: 'cmsModulegrd.CheckAccessEdit("ModuleSiteStorageValuesJsonForm")', type: 'string', template: '<a ng-if="cmsModulegrd.CheckAccessEdit(\'ModuleSiteStorageValuesJsonForm\')" class="btn btn-warning" ng-show="cmsModulegrd.gridOptions.Access.AccessWatchRow" ng-click="cmsModulegrd.designForm(x, \'ModuleSiteStorageValuesJsonForm\')" title="طراحی فرم"><i class="fa fa-paint-brush" aria-hidden="true"></i></a>' }
        ],
        data: {},
        multiSelect: false,
        advancedSearchData: {
    ...
    cmsModulegrd.openModuleConfigModalDefault = function (module) {
        ...
        $modal.open({
            templateUrl:'cpanelv1/CmsModules/' + cmsModulegrd.ModuleConfigSelected.ClassName + '/Config/ModuleDefault.html',
            scope: $scope
        });
    }
    ...
    cmsModulegrd.openPreviewModal = function (item, formName, fieldName) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'coremodule/GetOneWithModuleConfig', model, 'POST').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Core/CmsModule/preview.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    cmsModulegrd.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Core/CmsModule/report.html',
            scope: $scope
        });
    }
