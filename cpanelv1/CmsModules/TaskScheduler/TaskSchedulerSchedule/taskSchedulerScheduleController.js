...
//schedule Grid Options
    ...
    schedule.addMenu = function () {
        $modal.open({
            templateUrl: "cpanelv1/CmsModules/TaskScheduler/schedule/modalMenu.html",
            scope: $scope
        });
    }
 ...
 schedule.showTaskLog = function () {
    ...
    schedule.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'TaskSchedulerSchedule/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/TaskScheduler/TaskSchedulerSchedule/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    schedule.openEditModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'TaskSchedulerSchedule/', schedule.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/TaskScheduler/TaskSchedulerSchedule/edit.html',
                scope: $scope
            });
   ...
   //Replace Item OnDelete/OnEdit Grid Options
    ...
    schedule.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/TaskScheduler/TaskSchedulerSchedule/report.html',
            scope: $scope
        });
    }
