...
//                   $modal.open({
//                       templateUrl: 'cpanelv1/CmsModules/TaskScheduler/TaskSchedulerProcess/add.html',
//                       scope: $scope
//                   });
//                   taskSchedulerProcess.addRequested = false;
//               }).error(function (data, errCode, c, d) {
...
//    }
         ...
         if (response.Item.LinkMainImageId != null) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    taskSchedulerProcess.busyIndicator.isActive = false;
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/TaskScheduler/TaskSchedulerProcess/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
    ...
    taskSchedulerProcess.showFormMainAdmin = function (preview, selectedId) {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/TaskScheduler/TaskSchedulerProcess/formMainAdmin.html',
            scope: $scope
        });
    }
   ...
   var component = $.parseJSON(taskSchedulerProcess.selectedItem.JsonFormAdminSiteJsonForm);
    ...
    taskSchedulerProcess.showFormSiteAdmin = function (preview, selectedId) {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/TaskScheduler/TaskSchedulerProcess/formSiteAdmin.html',
            scope: $scope
        });
    }
    // Save Input Value Form
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    taskSchedulerProcess.showFormPreview = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'TaskSchedulerProcessvalue/', taskSchedulerProcess.selectedItem.Id, 'GET').success(function (response1) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/TaskScheduler/TaskSchedulerProcess/preview.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            taskSchedulerProcess.busyIndicator.isActive = false;
          ...
          ajax
            ...
            .success(function(response) {
              taskSchedulerProcess.FileItem = response.Item;
                ...
                taskSchedulerProcess.FileItem.UploadFileGUID = uploadFile.errorExceptionResult.Item.FileKey;
