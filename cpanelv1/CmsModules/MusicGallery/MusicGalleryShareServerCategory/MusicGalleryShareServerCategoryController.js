app.controller("musicGalleryShareServerCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    musicGalleryShareServerCategory.addNewCategory = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'MusicGalleryShareMainAdminSetting/', musicGalleryShareServerCategory.selectedItem, 'POST').success(function (response) {
            musicGalleryShareServerCategory.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    musicGalleryShareServerCategory.EditCategory = function (frm) {
        ...
        musicGalleryShareServerCategory.categoryBusyIndicator.isActive = true;
        musicGalleryShareServerCategory.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'MusicGalleryShareMainAdminSetting/', musicGalleryShareServerCategory.selectedItem, "PUT").success(function (response) {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'MusicGalleryShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'MusicGalleryShareMainAdminSetting/', musicGalleryShareServerCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        musicGalleryShareServerCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    musicGalleryShareServerCategory.addNewContentModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'musicGalleryShareServerCategory/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/musicGallery/musicGalleryShareServerCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    musicGalleryShareServerCategory.openEditModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'musicGalleryShareServerCategory/', musicGalleryShareServerCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/musicGallery/musicGalleryShareServerCategory/edit.html',
                scope: $scope
            });
    ...
    musicGalleryShareServerCategory.addNewContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'musicGalleryShareServerCategory/', musicGalleryShareServerCategory.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            musicGalleryShareServerCategory.categoryBusyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    musicGalleryShareServerCategory.editContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'musicGalleryShareServerCategory/', musicGalleryShareServerCategory.selectedItem, "PUT").success(function (response) {
            musicGalleryShareServerCategory.categoryBusyIndicator.isActive = false;
            musicGalleryShareServerCategory.addRequested = false;
            musicGalleryShareServerCategory.treeConfig.showbusy = false;
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"musicGalleryShareServerCategory/", musicGalleryShareServerCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    ...
                    musicGalleryShareServerCategory.selectedItemForDelete = response.Item;
                    console.log(musicGalleryShareServerCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"musicGalleryShareServerCategory/", musicGalleryShareServerCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        musicGalleryShareServerCategory.categoryBusyIndicator.isActive = false;
                        musicGalleryShareServerCategory.treeConfig.showbusy = false;
                        musicGalleryShareServerCategory.showIsBusy = false;
   ...
   // End of Upload Modal-----------------------------------------
    ...
    musicGalleryShareServerCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/MusicGallery/musicGalleryShareServerCategory/report.html',
            scope: $scope
        });
    }
