app.controller("musicGalleryShareReciverCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    musicGalleryShareReciverCategory.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"musicGalleryShareReciverCategory/getall", {}, 'POST').success(function (response) {
            ...
            musicGalleryShareReciverCategory.gridOptions.fillData(musicGalleryShareReciverCategory.ListItems, response.Access); // Sending Access as an argument
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'MusicGalleryShareMainAdminSetting/ViewModel', "", 'GET').success(function (response) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesFromCategory/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/MusicGallery/MusicGalleryShareMainAdminSetting/add.html',
                        scope: $scope
                    });
                    musicGalleryShareReciverCategory.addRequested = false;
                }).error(function (data, errCode, c, d) {
    ...
    musicGalleryShareReciverCategory.EditCategoryModel = function () {
        ...
        musicGalleryShareReciverCategory.contentBusyIndicator.isActive = true;
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'MusicGalleryShareMainAdminSetting/', musicGalleryShareReciverCategory.treeConfig.currentNode.Id, 'GET').success(function (response) {
            buttonIsPressed = false;
            musicGalleryShareReciverCategory.contentBusyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            musicGalleryShareReciverCategory.selectedItem = response.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesFromCategory/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/MusicGallery/MusicGalleryShareMainAdminSetting/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'MusicGalleryShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'MusicGalleryShareMainAdminSetting/', musicGalleryShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        musicGalleryShareReciverCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    musicGalleryShareReciverCategory.addNewContentModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'musicGalleryShareReciverCategory/ViewModel', "", 'GET').success(function (response) {
            buttonIsPressed = false;
            //console.log(response);
            rashaErManage.checkAction(response);
            musicGalleryShareReciverCategory.selectedItem = response.Item;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/musicGallery/musicGalleryShareReciverCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    musicGalleryShareReciverCategory.openEditModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'musicGalleryShareReciverCategory/', musicGalleryShareReciverCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            buttonIsPressed = false;
            rashaErManage.checkAction(response1);
            musicGalleryShareReciverCategory.selectedItem = response1.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/musicGallery/musicGalleryShareReciverCategory/edit.html',
                scope: $scope
            });
    ...
    musicGalleryShareReciverCategory.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                musicGalleryShareReciverCategory.showIsBusy = true;
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+"musicGalleryShareReciverCategory/", musicGalleryShareReciverCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    buttonIsPressed = false;
                    musicGalleryShareReciverCategory.showbusy = false;
                    musicGalleryShareReciverCategory.showIsBusy = false;
                    rashaErManage.checkAction(response);
                    musicGalleryShareReciverCategory.selectedItemForDelete = response.Item;
                    console.log(musicGalleryShareReciverCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"musicGalleryShareReciverCategory/", musicGalleryShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        musicGalleryShareReciverCategory.categoryBusyIndicator.isActive = false;
                        musicGalleryShareReciverCategory.treeConfig.showbusy = false;
                        musicGalleryShareReciverCategory.showIsBusy = false;
    ...
    musicGalleryShareReciverCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/MusicGallery/musicGalleryShareReciverCategory/report.html',
            scope: $scope
        });
    }
