 ...
 imgGalleryTag.LinkCategoryTagIdSelector = {
    ...
    imgGalleryTag.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"imgGallerytag/getall", imgGalleryTag.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            ...
            imgGalleryTag.gridOptions.fillData(imgGalleryTag.ListItems, response.Access); // Sending Access as an argument
    ...
    imgGalleryTag.addNewCategoryModel = function () {
        imgGalleryTag.addRequested = false;
        ajax.call(cmsServerConfig.configApiServerPath+'imgGalleryCategorytag/ViewModel', "", 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/imgGallery/imgGalleryCategorytag/add.html',
                        scope: $scope
                    });
                    imgGalleryTag.addRequested = false;
                }).error(function (data, errCode, c, d) {
    ...
    imgGalleryTag.openEditCategoryModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'imgGalleryCategorytag/', imgGalleryTag.treeConfig.currentNode.Id, 'GET').success(function (response) {
            buttonIsPressed = false;
            imgGalleryTag.contentBusyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            imgGalleryTag.selectedItem = response.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/imgGallery/imgGalleryCategorytag/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
    ...
    imgGalleryTag.addNewCategory = function (frm) {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'imgGalleryCategorytag/', imgGalleryTag.selectedItem, 'POST').success(function (response) {
            buttonIsPressed = false;
            imgGalleryTag.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    imgGalleryTag.editCategory = function (frm) {
        ...
        imgGalleryTag.categoryBusyIndicator.isActive = true;
        ajax.call(cmsServerConfig.configApiServerPath+'imgGalleryCategorytag/', imgGalleryTag.selectedItem, "PUT").success(function (response) {
            imgGalleryTag.addRequested = true;
    ...
    imgGalleryTag.openAddModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'imgGallerytag/ViewModel', "", 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            imgGalleryTag.selectedItem = response.Item;
            imgGalleryTag.selectedItem.LinkCategoryTagId = imgGalleryTag.CategoryTagId;
            //imgGalleryTag.clearPreviousData();
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/imgGallery/imgGallerytag/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    imgGalleryTag.openEditModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'imgGallerytag/', imgGalleryTag.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            buttonIsPressed = false;
            rashaErManage.checkAction(response1);
            imgGalleryTag.selectedItem = response1.Item;

            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/imgGallery/imgGallerytag/edit.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    imgGalleryTag.addNewRow = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'imgGallerytag/', imgGalleryTag.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            imgGalleryTag.categoryBusyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    imgGalleryTag.editRow = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'imgGallerytag/', imgGalleryTag.selectedItem, "PUT").success(function (response) {
            imgGalleryTag.categoryBusyIndicator.isActive = false;
            imgGalleryTag.addRequested = false;
            imgGalleryTag.treeConfig.showbusy = false;
            imgGalleryTag.showIsBusy = false;
    ...
    imgGalleryTag.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                imgGalleryTag.showIsBusy = true;
                ajax.call(cmsServerConfig.configApiServerPath+"imgGallerytag/", imgGalleryTag.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    imgGalleryTag.showbusy = false;
                    imgGalleryTag.showIsBusy = false;
                    rashaErManage.checkAction(response);
                    imgGalleryTag.selectedItemForDelete = response.Item;
    ...
    imgGalleryTag.openUploadModal = function () {
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/imgGallery/imgGalleryContent/upload_modal.html',
            size: 'lg',
            scope: $scope
        });
    ...
    imgGalleryTag.saveNewFile = function () {
        ajax.call(cmsServerConfig.configApiServerPath+"FileContent/", imgGalleryTag.FileItem, 'POST').success(function (response) {
            if (response.IsSuccess) {
            ...
            ajax
              ...
              .error(function(data) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/ViewModel", "", 'GET').success(function (response) {
                    ...
                    imgGalleryTag.FileItem.UploadFileGUID = uploadFile.errorExceptionResult.Item.FileKey;
    ...
    imgGalleryTag.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/imgGallery/imgGallerytag/report.html',
            scope: $scope
        });
    }
