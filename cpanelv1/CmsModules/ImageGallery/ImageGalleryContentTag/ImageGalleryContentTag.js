app.controller("mscGalleryContentTagCtrl", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $window, $filter) {
    ...
    mscGalleryContentTag.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'MusicGalleryContentTag/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/ImageGallery/ImageGalleryContentTag/add.html',
                scope: $scope
            });
    ...
    mscGalleryContentTag.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'MusicGalleryContentTag/',  mscGalleryContentTag.gridOptions.selectedRow.item.Id , 'GET').success(function (response) {
            ...
            mscGalleryContentTag.selectedItem = response.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/ImageGallery/ImageGalleryContentTag/edit.html',
                scope: $scope
            });
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'MusicGalleryContentTag/',  mscGalleryContentTag.gridOptions.selectedRow.item.Id , 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'MusicGalleryContentTag/',  mscGalleryContentTag.selectedItemForDelete.Id , 'DELETE').success(function (res) {
    ...
    mscGalleryContentTag.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/ImageGallery/ImageGalleryContentTag/report.html',
            scope: $scope
        });
    }
