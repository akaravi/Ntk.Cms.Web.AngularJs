app.controller("imageGalleryShareReciverCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    imageGalleryShareReciverCategory.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"imageGalleryShareReciverCategory/getall", {}, 'POST').success(function (response) {
            ...
            imageGalleryShareReciverCategory.gridOptions.fillData(imageGalleryShareReciverCategory.ListItems, response.Access); // Sending Access as an argument
    ...
    imageGalleryShareReciverCategory.addNewCategoryModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ImageGalleryShareMainAdminSetting/ViewModel', "", 'GET').success(function (response) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesFromCategory/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/ImageGallery/ImageGalleryShareMainAdminSetting/add.html',
                        scope: $scope
                    });
                    imageGalleryShareReciverCategory.addRequested = false;
                }).error(function (data, errCode, c, d) {
    ...
    imageGalleryShareReciverCategory.EditCategoryModel = function () {
        ...
        imageGalleryShareReciverCategory.contentBusyIndicator.isActive = true;
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'ImageGalleryShareMainAdminSetting/', imageGalleryShareReciverCategory.treeConfig.currentNode.Id, 'GET').success(function (response) {
            buttonIsPressed = false;
            imageGalleryShareReciverCategory.contentBusyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            imageGalleryShareReciverCategory.selectedItem = response.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesFromCategory/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/ImageGallery/ImageGalleryShareMainAdminSetting/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
    ...
    imageGalleryShareReciverCategory.addNewCategory = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ImageGalleryShareMainAdminSetting/', imageGalleryShareReciverCategory.selectedItem, 'POST').success(function (response) {
            imageGalleryShareReciverCategory.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    imageGalleryShareReciverCategory.EditCategory = function (frm) {
        ...
        imageGalleryShareReciverCategory.categoryBusyIndicator.isActive = true;
        imageGalleryShareReciverCategory.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'ImageGalleryShareMainAdminSetting/', imageGalleryShareReciverCategory.selectedItem, "PUT").success(function (response) {
    ...
    imageGalleryShareReciverCategory.deleteCategory = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+'ImageGalleryShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    buttonIsPressed = false;
                    rashaErManage.checkAction(response);
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'ImageGalleryShareMainAdminSetting/', imageGalleryShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        imageGalleryShareReciverCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    imageGalleryShareReciverCategory.addNewContentModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'imageGalleryShareReciverCategory/ViewModel', "", 'GET').success(function (response) {
            buttonIsPressed = false;
            //console.log(response);
            rashaErManage.checkAction(response);
            imageGalleryShareReciverCategory.selectedItem = response.Item;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/imageGallery/imageGalleryShareReciverCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    imageGalleryShareReciverCategory.openEditModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'imageGalleryShareReciverCategory/', imageGalleryShareReciverCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            buttonIsPressed = false;
            rashaErManage.checkAction(response1);
            imageGalleryShareReciverCategory.selectedItem = response1.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/imageGallery/imageGalleryShareReciverCategory/edit.html',
                scope: $scope
            });
    ...
    imageGalleryShareReciverCategory.addNewContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'imageGalleryShareReciverCategory/', imageGalleryShareReciverCategory.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            imageGalleryShareReciverCategory.categoryBusyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    imageGalleryShareReciverCategory.editContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'imageGalleryShareReciverCategory/', imageGalleryShareReciverCategory.selectedItem, "PUT").success(function (response) {
            imageGalleryShareReciverCategory.categoryBusyIndicator.isActive = false;
            imageGalleryShareReciverCategory.addRequested = false;
            imageGalleryShareReciverCategory.treeConfig.showbusy = false;
    ...
    imageGalleryShareReciverCategory.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                imageGalleryShareReciverCategory.showIsBusy = true;
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+"imageGalleryShareReciverCategory/", imageGalleryShareReciverCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    buttonIsPressed = false;
                    imageGalleryShareReciverCategory.showbusy = false;
                    imageGalleryShareReciverCategory.showIsBusy = false;
                    rashaErManage.checkAction(response);
                    imageGalleryShareReciverCategory.selectedItemForDelete = response.Item;
                    console.log(imageGalleryShareReciverCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"imageGalleryShareReciverCategory/", imageGalleryShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        imageGalleryShareReciverCategory.categoryBusyIndicator.isActive = false;
                        imageGalleryShareReciverCategory.treeConfig.showbusy = false;
                        imageGalleryShareReciverCategory.showIsBusy = false;
    ...
    imageGalleryShareReciverCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/ImageGallery/imageGalleryShareReciverCategory/report.html',
            scope: $scope
        });
    }
