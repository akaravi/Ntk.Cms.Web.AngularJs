app.controller("ticketingDepartemenController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    ticketingDepartemen.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + 'ticketingDepartemen/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Ticketing/TicketingDepartemen/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
    ...
    ticketingDepartemen.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + 'ticketingDepartemen/', ticketingDepartemen.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            ...
            ticketingDepartemen.selectedItem = response.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Ticketing/TicketingDepartemen/edit.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath + 'ticketingDepartemen/', ticketingDepartemen.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath + 'ticketingDepartemen/', ticketingDepartemen.selectedItemForDelete.Id, 'DELETE').success(function (res) {
    ...
    ticketingDepartemen.openOperatorModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + 'ticketingDepartemenoperator/ViewModel', "", 'GET').success(function (response) {
            ...
            if (response.IsSuccess) {
                ...
                $modal.open({
                    templateUrl: 'cpanelv1/CmsModules/Ticketing/TicketingDepartemen/addOperator.html',
                    scope: $scope
                });
            }
        }).error(function (data, errCode, c, d) {
    ...
    ticketingDepartemen.deleteMember = function (index) {
        ajax.call(cmsServerConfig.configApiServerPath + 'ticketingDepartemenoprator/', ticketingDepartemen.operatorsList[index].Id, 'DELETE').success(function (res) {
            rashaErManage.checkAction(res);
            if (res.IsSuccess) {
    ...
    ticketingDepartemen.addNewRowTypeOperatorModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + 'ticketingDepartemenOperator/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Ticketing/TicketingDepartemenOperator/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ajax.call(cmsServerConfig.configApiServerPath + 'ticketingDepartemenoperator/', ticketingDepartemen.gridContentOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    rashaErManage.checkAction(response);
                    ticketingDepartemen.selectedItemForDelete = response.Item;
                    ajax.call(cmsServerConfig.configApiServerPath + 'ticketingDepartemenoperator/', ticketingDepartemen.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        rashaErManage.checkAction(res);
                        if (res.IsSuccess) {
                            ticketingDepartemen.replaceItem(ticketingDepartemen.selectedItemForDelete.Id);
                        }
    ...
    ticketingDepartemen.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Ticketing/TicketingDepartemen/report.html',
            scope: $scope
        });
    }
