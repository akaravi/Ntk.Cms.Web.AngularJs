app.controller("ticketingTaskController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window','$stateParams', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window,$stateParams, $filter) {
    ...
    ticketingTask.addNewModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'TicketingTask/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Ticketing/TicketingTask/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
    ...
    ticketingTask.openEditModal = function (s) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'TicketingTask/', ticketingTask.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            ...
            ticketingTask.filePickerFiles.fileId = null;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Ticketing/TicketingTask/edit.html',
                scope: $scope
            });
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'TicketingAnswer/', ticketingTask.answersGridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            ...
            if (response.IsSuccess) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'TicketingTask/', response.Item.LinkTicketId, 'GET').success(function (responseTask) {
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Ticketing/TicketingTask/editAnswer.html',
                        scope: $scope
                    });
                     }
                }).error(function (data, errCode, c, d) {
    ...
    ticketingTask.openAddAnswerModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'TicketingAnswer/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Ticketing/TicketingTask/addAnswer.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    ticketingTask.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Ticketing/TicketingTask/report.html',
            scope: $scope
        });
    }
