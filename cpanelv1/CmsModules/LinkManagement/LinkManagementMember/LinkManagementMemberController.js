app.controller("linkManagementMemberController", ["$scope", "$state", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$window', '$filter', function ($scope, $state, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $window, $filter) {
    ...
    linkManagementMember.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"linkManagementMember/getall", engine, 'POST').success(function (response) {
            ...
            linkManagementMember.gridOptions.fillData(linkManagementMember.ListItems , response.Access);
    ...
    linkManagementMember.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'linkManagementMember/ViewModel', "", 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            linkManagementMember.busyIndicator.isActive = false;
            linkManagementMember.selectedItem = response.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/LinkManagement/linkManagementMember/add.html',
                scope: $scope
            });
    ...
    linkManagementMember.addNewRow = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'linkManagementMember/', linkManagementMember.selectedItem, 'POST').success(function (response) {
            linkManagementMember.addRequested = false;
            linkManagementMember.busyIndicator.isActive = false;
            rashaErManage.checkAction(response);
    ...
    linkManagementMember.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'linkManagementMember/', linkManagementMember.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            ...
            linkManagementMember.selectedItem = response.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/LinkManagement/linkManagementMember/edit.html',
                scope: $scope
            });
    ...
    linkManagementMember.editRow = function (frm) {
        ...
        linkManagementMember.busyIndicator.isActive = true;
        ajax.call(cmsServerConfig.configApiServerPath+'linkManagementMember/', linkManagementMember.selectedItem, "PUT").success(function (response) {
            linkManagementMember.addRequested = true;
            rashaErManage.checkAction(response);
            linkManagementMember.busyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    linkManagementMember.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/LinkManagement/linkManagementMember/report.html',
            scope: $scope
        });
    }
