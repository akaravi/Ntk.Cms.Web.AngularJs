app.controller("linkManagementAccountingController", ["$scope", "$stateParams", "$state", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$window', '$filter', function ($scope, $stateParams, $state, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $window, $filter) {
    ...
    linkManagementAccounting.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'linkManagementAccounting/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/LinkManagement/linkManagementAccounting/add.html',
                scope: $scope
            });
    ...
    linkManagementAccounting.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'linkManagementAccounting/', linkManagementAccounting.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/LinkManagement/linkManagementAccounting/edit.html',
                scope: $scope
            });
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'linkManagementAccounting/', linkManagementAccounting.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'linkManagementAccounting/', linkManagementAccounting.selectedItemForDelete.Id, 'DELETE').success(function (res) {
    ...
    linkManagementAccounting.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/LinkManagement/linkManagementAccounting/report.html',
            scope: $scope
        });
    }
