app.controller("linkManagementAccountingDetailController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $window, $filter) {
    ...
    linkManagementAccountingDetail.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'linkManagementAccountingDetail/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/LinkManagement/linkManagementAccountingDetail/add.html',
                scope: $scope
            });
    ...
    linkManagementAccountingDetail.addNewRow = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'linkManagementAccountingDetail/', linkManagementAccountingDetail.selectedItem, 'POST').success(function (response) {
            linkManagementAccountingDetail.addRequested = false;
            linkManagementAccountingDetail.busyIndicator.isActive = false;
            rashaErManage.checkAction(response);
    ...
    linkManagementAccountingDetail.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'linkManagementAccountingDetail/', linkManagementAccountingDetail.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            ...
            linkManagementAccountingDetail.selectedItem = response.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/LinkManagement/linkManagementAccountingDetail/edit.html',
                scope: $scope
            });
    ...
    linkManagementAccountingDetail.editRow = function (frm) {
        ...
        linkManagementAccountingDetail.busyIndicator.isActive = true;
        ajax.call(cmsServerConfig.configApiServerPath+'linkManagementAccountingDetail/', linkManagementAccountingDetail.selectedItem, "PUT").success(function (response) {
            linkManagementAccountingDetail.addRequested = true;
            rashaErManage.checkAction(response);
            linkManagementAccountingDetail.busyIndicator.isActive = false;
            if (response.IsSuccess) {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'linkManagementAccountingDetail/', linkManagementAccountingDetail.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'linkManagementAccountingDetail/', linkManagementAccountingDetail.selectedItemForDelete.Id, 'DELETE').success(function (res) {
    ...
    linkManagementAccountingDetail.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/LinkManagement/linkManagementAccountingDetail/report.html',
            scope: $scope
        });
    }
