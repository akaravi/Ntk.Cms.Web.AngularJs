...
objectPropertyDetail.LinkCategoryIdSelector = {
    ...
    objectPropertyDetail.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"objectPropertyDetailGroup/getall", objectPropertyDetail.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            ...
            objectPropertyDetail.groupResultAccess = response.Access;
    ...
    objectPropertyDetail.openAddCategoryModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetailGroup/ViewModel', "", 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            objectPropertyDetail.selectedItem = response.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/object/objectPropertyDetailGroup/add.html',
                scope: $scope
            });
    ...
    objectPropertyDetail.addNewCategory = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetailGroup/', objectPropertyDetail.selectedItem, 'POST').success(function (response) {
            objectPropertyDetail.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    objectPropertyDetail.openEditCategoryModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetailGroup/', objectPropertyDetail.treeConfig.currentNode.Id, 'GET').success(function (response1) {
            objectPropertyDetail.showbusy = false;
            rashaErManage.checkAction(response1);
            objectPropertyDetail.selectedItem = response1.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/object/objectPropertyDetailGroup/edit.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    objectPropertyDetail.editCategory = function (frm) {
        ...
        objectPropertyDetail.categorybusyIndicator.isActive = true;
        objectPropertyDetail.selectedItem.IconFont = $("#iconFont").val(); //Save selected icon name in the model
        ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetailGroup/', objectPropertyDetail.selectedItem, "PUT").success(function (response) {
            objectPropertyDetail.addRequested = true;
    ...
    objectPropertyDetail.deleteCategory = function () {
        ...
        if (objectPropertyDetail.ListItems.length == 0) {
            rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
                if (isConfirmed) {
                    objectPropertyDetail.categorybusyIndicator.isActive = true;
                    ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetailGroup/', node.Id, 'GET').success(function (response) {
                        rashaErManage.checkAction(response);
                        objectPropertyDetail.selectedItemForDelete = response.Item;
                        ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetailGroup/', objectPropertyDetail.selectedItemForDelete.Id, 'DELETE').success(function (res) {
    ...
    objectPropertyDetail.selectContent = function (node) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"objectPropertyDetail/getall", objectPropertyDetail.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            ...
            objectPropertyDetail.gridOptions.fillData(objectPropertyDetail.ListItems, response.Access);
    ...
    objectPropertyDetail.openAddContentModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetail/ViewModel', "", 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            objectPropertyDetail.selectedItem = response.Item;
            objectPropertyDetail.selectedItem.LinkPropertyDetailGroupId = node.Id;
            objectPropertyDetail.onMultipleChoiceChange();
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/object/objectPropertyDetail/add.html',
                scope: $scope
            });
    ...
    objectPropertyDetail.addNewContent = function (frm) {
        ...
        objectPropertyDetail.selectedItem.IconFont = $("#iconFont").val(); //Save selected icon name in the model
        ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetail/', objectPropertyDetail.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            if (response.IsSuccess) {
                // filter text
    ...
    objectPropertyDetail.openEditContentModal = function () {
        ...
        objectPropertyDetail.FieldName = "";
        ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetail/', objectPropertyDetail.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            rashaErManage.checkAction(response1);
            objectPropertyDetail.selectedItem = response1.Item;
            ...
            objectPropertyDetail.onMultipleChoiceChange();
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/object/objectPropertyDetail/edit.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    objectPropertyDetail.editContent = function (frm) {
        ...
        objectPropertyDetail.selectedItem.IconFont = $("#iconFont").val(); //Save selected icon name in the model
        objectPropertyDetail.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetail/', objectPropertyDetail.selectedItem, "PUT").success(function (response) {
            // objectPropertyDetail.addRequested = false;
            objectPropertyDetail.treeConfig.showbusy = false;
            objectPropertyDetail.showIsBusy = false;
            rashaErManage.checkAction(response);
    ...
    objectPropertyDetail.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                objectPropertyDetail.showIsBusy = true;
                ajax.call(cmsServerConfig.configApiServerPath+"objectPropertyDetail/", objectPropertyDetail.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    objectPropertyDetail.showbusy = false;
                    objectPropertyDetail.showIsBusy = false;
                    rashaErManage.checkAction(response);
                    objectPropertyDetail.selectedItemForDelete = response.Item;
                    ajax.call(cmsServerConfig.configApiServerPath+"objectPropertyDetail/", objectPropertyDetail.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        objectPropertyDetail.treeConfig.showbusy = false;
                        objectPropertyDetail.showIsBusy = false;
    ...
    objectPropertyDetail.editStepGoDown = function (item, index) {
        ...
        objectPropertyDetail.busyIndicator.isActive = true;
        ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetail/', item.Id, 'GET').success(function (response1) {
            rashaErManage.checkAction(response1);
            objectPropertyDetail.selectedItem = response1.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetail/', objectPropertyDetail.selectedItem, "PUT").success(function (response2) {
                rashaErManage.checkAction(response2);
                if (response2.IsSuccess) {
                    ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetail/', objectPropertyDetail.ListItems[index + 1].Id, 'GET').success(function (response3) {
                        ...
                        ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetail/', objectPropertyDetail.selectedItem, "PUT").success(function (response4) {
    ...
    objectPropertyDetail.editStepGoDownGroup = function (item) {
        ...
        objectPropertyDetail.busyIndicator.isActive = true;
        ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetailGroup/', item.Id, 'GET').success(function (response1) {
            rashaErManage.checkAction(response1);
            objectPropertyDetail.selectedItem = response1.Item;
            var temp = response1.Item.ShowInFormOrder;
            objectPropertyDetail.selectedItem.ShowInFormOrder = objectPropertyDetail.treeConfig.Items[index + 1].ShowInFormOrder;
            ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetailGroup/', objectPropertyDetail.selectedItem, "PUT").success(function (response2) {
                rashaErManage.checkAction(response2);
                if (response2.IsSuccess) {
                    ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetailGroup/', objectPropertyDetail.treeConfig.Items[index + 1].Id, 'GET').success(function (response3) {
                        rashaErManage.checkAction(response3);
                        objectPropertyDetail.selectedItem = response3.Item;
                        objectPropertyDetail.selectedItem.ShowInFormOrder = temp;
                        ajax.call(cmsServerConfig.configApiServerPath+'objectPropertyDetailGroup/', objectPropertyDetail.selectedItem, "PUT").success(function (response4) {
                            rashaErManage.checkAction(response4);
                            if (response4.IsSuccess) {
    ...
    objectPropertyDetail.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/object/objectPropertyDetail/report.html',
            scope: $scope
        });
    }
