 ...
 objectPropertyType.filePickerMainImage = {
    ...
    objectPropertyType.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"objectpropertytype/getall", objectPropertyType.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            ...
            objectPropertyType.gridOptions.fillData(objectPropertyType.ListItems, response.Access);
    ...
    objectPropertyType.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'objectpropertytype/ViewModel', "", 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            objectPropertyType.busyIndicator.isActive = false;
            objectPropertyType.selectedItem = response.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/object/objectPropertyType/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    objectPropertyType.addNewRow = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'objectpropertytype/', objectPropertyType.selectedItem, 'POST').success(function (response) {
            objectPropertyType.addRequested = false;
            objectPropertyType.busyIndicator.isActive = false;
            rashaErManage.checkAction(response);
    ...
    objectPropertyType.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'objectpropertytype/', objectPropertyType.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            objectPropertyType.selectedItem = response.Item;
    ...
    objectPropertyType.editRow = function (frm) {
        ...
        objectPropertyType.busyIndicator.isActive = true;
        ajax.call(cmsServerConfig.configApiServerPath+'objectpropertytype/', objectPropertyType.selectedItem, "PUT").success(function (response) {
            objectPropertyType.addRequested = true;
            rashaErManage.checkAction(response);
            objectPropertyType.busyIndicator.isActive = false;
            if (response.IsSuccess) {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'objectpropertytype/', objectPropertyType.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'objectpropertytype/', objectPropertyType.selectedItemForDelete.Id, 'DELETE').success(function (res) {
...
objectPropertyType.alreadyExist = function (id, array) {
   ...
   //---------------Upload Modal-------------------------------
    objectPropertyType.openUploadModal = function () {
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Service/objectPropertyType/upload_modal.html',
            size: 'lg',
            scope: $scope
        });
    ...
    objectPropertyType.replaceFile = function (name) {
        ...
        // Delete the file
        ajax.call(cmsServerConfig.configApiServerPath+"FileContent/", objectPropertyType.fileIdToDelete, 'GET').success(function (response1) {
    ...
    objectPropertyType.saveNewFile = function () {
        ajax.call(cmsServerConfig.configApiServerPath+"FileContent/", objectPropertyType.FileItem, 'POST').success(function (response) {
            if (response.IsSuccess) {
        ...
        if ($("#save-icon" + index).hasClass("fa-save")) {
            ...
            //--------------------------------
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/ViewModel", "", 'GET').success(function (response) {
                    ...
                    objectPropertyType.FileItem.UploadFileGUID = uploadFile.errorExceptionResult.Item.FileKey;
    ...
    objectPropertyType.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/object/objectPropertyType/report.html',
            scope: $scope
        });
    }
