app.controller("blogShareReciverCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    blogShareReciverCategory.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"blogShareReciverCategory/getall", engine, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            blogShareReciverCategory.ListItems = response.ListItems;
            blogShareReciverCategory.gridOptions.fillData(blogShareReciverCategory.ListItems, response.Access); // Sending Access as an argument
    ...
    blogShareReciverCategory.addNewCategoryModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'BlogShareMainAdminSetting/ViewModel', "", 'GET').success(function (response) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Blog/BlogShareMainAdminSetting/add.html',
                        scope: $scope
                    });
                    blogShareReciverCategory.addRequested = false;
                }).error(function (data, errCode, c, d) {
    ...
    blogShareReciverCategory.EditCategoryModel = function () {
        ...
        blogShareReciverCategory.contentBusyIndicator.isActive = true;
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'BlogShareMainAdminSetting/', blogShareReciverCategory.treeConfig.currentNode.Id, 'GET').success(function (response) {
            buttonIsPressed = false;
            blogShareReciverCategory.contentBusyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            blogShareReciverCategory.selectedItem = response.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Blog/BlogShareMainAdminSetting/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
    ...
    blogShareReciverCategory.addNewCategory = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'BlogShareMainAdminSetting/', blogShareReciverCategory.selectedItem, 'POST').success(function (response) {
            blogShareReciverCategory.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    blogShareReciverCategory.EditCategory = function (frm) {
        ...
        blogShareReciverCategory.categoryBusyIndicator.isActive = true;
        blogShareReciverCategory.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'BlogShareMainAdminSetting/', blogShareReciverCategory.selectedItem, "PUT").success(function (response) {
    ...
    blogShareReciverCategory.deleteCategory = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+'BlogShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    buttonIsPressed = false;
                    rashaErManage.checkAction(response);
                    blogShareReciverCategory.selectedItemForDelete = response.Item;
                    console.log(blogShareReciverCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+'BlogShareMainAdminSetting/', blogShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        blogShareReciverCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    blogShareReciverCategory.selectContent = function (node) {
        ...
        blogShareReciverCategory.gridOptions.advancedSearchData.engine.AccessLoad = true;
    ...
    blogShareReciverCategory.addNewContentModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'blogShareReciverCategory/ViewModel', "", 'GET').success(function (response) {
            buttonIsPressed = false;
            //console.log(response);
            rashaErManage.checkAction(response);
            blogShareReciverCategory.selectedItem = response.Item;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/blog/blogShareReciverCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    blogShareReciverCategory.openEditModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'blogShareReciverCategory/', blogShareReciverCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            buttonIsPressed = false;
            rashaErManage.checkAction(response1);
            blogShareReciverCategory.selectedItem = response1.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/blog/blogShareReciverCategory/edit.html',
                scope: $scope
            });
    ...
    blogShareReciverCategory.addNewContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'blogShareReciverCategory/', blogShareReciverCategory.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            blogShareReciverCategory.categoryBusyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    blogShareReciverCategory.editContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'blogShareReciverCategory/', blogShareReciverCategory.selectedItem, "PUT").success(function (response) {
            blogShareReciverCategory.categoryBusyIndicator.isActive = false;
            blogShareReciverCategory.addRequested = false;
            blogShareReciverCategory.treeConfig.showbusy = false;
    ...
    blogShareReciverCategory.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                blogShareReciverCategory.showIsBusy = true;
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+"blogShareReciverCategory/", blogShareReciverCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    buttonIsPressed = false;
                    blogShareReciverCategory.showbusy = false;
                    blogShareReciverCategory.showIsBusy = false;
                    rashaErManage.checkAction(response);
                    blogShareReciverCategory.selectedItemForDelete = response.Item;
                    console.log(blogShareReciverCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"blogShareReciverCategory/", blogShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        blogShareReciverCategory.categoryBusyIndicator.isActive = false;
                        blogShareReciverCategory.treeConfig.showbusy = false;
                        blogShareReciverCategory.showIsBusy = false;
    ...
    blogShareReciverCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Blog/blogShareReciverCategory/report.html',
            scope: $scope
        });
    }
