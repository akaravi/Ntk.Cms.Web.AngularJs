app.controller("blogShareServerCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    blogShareServerCategory.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"blogShareServerCategory/getall", engine, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            blogShareServerCategory.ListItems = response.ListItems;
            blogShareServerCategory.gridOptions.fillData(blogShareServerCategory.ListItems, response.Access); // Sending Access as an argument
    ...
    blogShareServerCategory.EditCategoryModel = function () {
        ...
        blogShareServerCategory.contentBusyIndicator.isActive = true;
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'BlogShareMainAdminSetting/', blogShareServerCategory.treeConfig.currentNode.Id, 'GET').success(function (response) {
            buttonIsPressed = false;
            blogShareServerCategory.contentBusyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            blogShareServerCategory.selectedItem = response.Item;
    ...
    blogShareServerCategory.addNewCategory = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'BlogShareMainAdminSetting/', blogShareServerCategory.selectedItem, 'POST').success(function (response) {
            blogShareServerCategory.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    blogShareServerCategory.EditCategory = function (frm) {
        ...
        blogShareServerCategory.categoryBusyIndicator.isActive = true;
        blogShareServerCategory.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'BlogShareMainAdminSetting/', blogShareServerCategory.selectedItem, "PUT").success(function (response) {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'BlogShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'BlogShareMainAdminSetting/', blogShareServerCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        blogShareServerCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    blogShareServerCategory.selectContent = function (node) {
        ...
        blogShareServerCategory.gridOptions.advancedSearchData.engine.AccessLoad = true;
    ...
    blogShareServerCategory.addNewContentModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'blogShareServerCategory/ViewModel', "", 'GET').success(function (response) {
            buttonIsPressed = false;
            //console.log(response);
            rashaErManage.checkAction(response);
            blogShareServerCategory.selectedItem = response.Item;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/blog/blogShareServerCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    blogShareServerCategory.openEditModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'blogShareServerCategory/', blogShareServerCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            buttonIsPressed = false;
            rashaErManage.checkAction(response1);
            blogShareServerCategory.selectedItem = response1.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/blog/blogShareServerCategory/edit.html',
                scope: $scope
            });
    ...
    blogShareServerCategory.addNewContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'blogShareServerCategory/', blogShareServerCategory.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            blogShareServerCategory.categoryBusyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    blogShareServerCategory.editContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'blogShareServerCategory/', blogShareServerCategory.selectedItem, "PUT").success(function (response) {
            blogShareServerCategory.categoryBusyIndicator.isActive = false;
            blogShareServerCategory.addRequested = false;
            blogShareServerCategory.treeConfig.showbusy = false;
    ...
    blogShareServerCategory.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                blogShareServerCategory.showIsBusy = true;
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+"blogShareServerCategory/", blogShareServerCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    buttonIsPressed = false;
                    blogShareServerCategory.showbusy = false;
                    blogShareServerCategory.showIsBusy = false;
                    rashaErManage.checkAction(response);
                    blogShareServerCategory.selectedItemForDelete = response.Item;
                    console.log(blogShareServerCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"blogShareServerCategory/", blogShareServerCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        blogShareServerCategory.categoryBusyIndicator.isActive = false;
                        blogShareServerCategory.treeConfig.showbusy = false;
                        blogShareServerCategory.showIsBusy = false;
   ...
   // End of Upload Modal-----------------------------------------
    ...
    blogShareServerCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Blog/blogShareServerCategory/report.html',
            scope: $scope
        });
    }
