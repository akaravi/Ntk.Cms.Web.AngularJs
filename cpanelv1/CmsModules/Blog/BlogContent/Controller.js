app.controller("blogContentController", [
  ...
  function (
    ...
    blogContent.addMenu = function () {
      ...
      $modal.open({
        templateUrl: "cpanelv1/CmsModules/blog/blogContent/modalMenu.html",
        scope: $scope
      });
    };
    ...
    blogContent.init = function () {
      ...
      filterModel = {
        ...
        SearchType: 0,
        value: blogContent.selectedContentId.Id
      };
      ...
      ajax.call(cmsServerConfig.configApiServerPath + "blogContentTag/ViewModel", "", "GET").success(function (response) { //Get a ViewModel for blogContentTag
    ...
    blogContent.showComment = function (LinkContentId) {
      ...
      ajax.call(cmsServerConfig.configApiServerPath + "blogcomment/getall", engine, 'POST').success(function (response) {
        ...
        blogContent.gridContentOptions.fillData(blogContent.ListCommentItems, response.Access); // Sending Access as an argument
    ...
    blogContent.addNewCategoryModel = function () {
      ...
      ajax
        .call(cmsServerConfig.configApiServerPath + "blogCategory/ViewModel", "", "GET")
        .success(function (response) {
          ...
          ajax
            ...
            .success(function (response1) {
              ...
              ajax
                .call(
                  cmsServerConfig.configApiServerPath + "FileContent/GetFilesInCategoryId/","","GET"
                )
                .success(function (response2) {
                  ...
                  $modal.open({
                    templateUrl: "cpanelv1/CmsModules/Blog/BlogCategory/add.html",
                    scope: $scope
                  });
                  blogContent.addRequested = false;
                })
            ...
            .success(function (response1) {
              ...
              ajax
                ...
                .success(function (response2) {
                  ...
                  $modal.open({
                    templateUrl: "cpanelv1/CmsModules/Blog/BlogCategory/edit.html",
                    scope: $scope
                  });
                })
                .error(function (data, errCode, c, d) {
    ...
    blogContent.Showstatistics = function () {
      ...
      ajax.call(cmsServerConfig.configApiServerPath + 'blogContent/', blogContent.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
        rashaErManage.checkAction(response1);
        blogContent.selectedItem = response1.Item;
        $modal.open({
          templateUrl: "cpanelv1/CmsModules/blog/blogContent/statistics.html",
          scope: $scope
        });
      }).error(function (data, errCode, c, d) {
        rashaErManage.checkAction(data, errCode);
      ...
      rashaErManage.showYesNo(
        ...
        function (isConfirmed) {
          if (isConfirmed) {
            ...
            buttonIsPressed = true;
            ajax
              .call(cmsServerConfig.configApiServerPath + "blogCategory/", node.Id, "GET")
              .success(function (response) {
                buttonIsPressed = false;
                rashaErManage.checkAction(response);
    ...
    blogContent.addNewContentModel = function () {
      ...
      buttonIsPressed = true;
      ajax
        .call(cmsServerConfig.configApiServerPath + "blogContent/ViewModel", "", "GET")
        .success(function (response) {
          buttonIsPressed = false;
          rashaErManage.checkAction(response);
          ...
          $modal.open({
            templateUrl: "cpanelv1/CmsModules/blog/blogContent/add.html",
            scope: $scope
          });
        })
        .error(function (data, errCode, c, d) {
    ...
    blogContent.openEditModel = function () {
      ...
      if (blogContent.gridOptions.selectedRow.item.LinkSiteId != $rootScope.tokenInfo.SiteId && !$rootScope.tokenInfo.UserAccessAdminAllowToAllData) {
        rashaErManage.showMessage($filter('translatentk')('This_Blog_Is_Shared'));
        return;
      }
      blogContent.selectedItemOtherInfos = {};
      buttonIsPressed = true;
      ajax.call(cmsServerConfig.configApiServerPath + "blogContent/", blogContent.gridOptions.selectedRow.item.Id, "GET")
        .success(function (response1) {
          buttonIsPressed = false;
          rashaErManage.checkAction(response1);
          blogContent.selectedItem = response1.Item;
          ...
          var filterValue = {
            PropertyName: "LinkContentId",
            value: blogContent.gridOptions.selectedRow.item.Id,
            SearchType: 0
          }
          ...
          $modal.open({
            templateUrl: "cpanelv1/CmsModules/blog/blogContent/edit.html",
            scope: $scope
          });
        })
        .error(function (data, errCode, c, d) {
    ...
    blogContent.editContent = function (frm) {
      ...
      if (blogContent.ContentModuleRelationShipRemoved && blogContent.ContentModuleRelationShipRemoved.length > 0) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + "CoreModuleRelationshipContent/DeleteList", blogContent.ContentModuleRelationShipRemoved, "POST").success(function (response) {
            rashaErManage.checkAction(response);
          })
          .error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
      ...
      if (blogContent.ContentModuleRelationShipAdded && blogContent.ContentModuleRelationShipAdded.length > 0) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + "CoreModuleRelationshipContent/addbatch", blogContent.ContentModuleRelationShipAdded, "POST").success(function (response) {
            rashaErManage.checkAction(response);
          })
          .error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    blogContent.openUploadModal = function () {
      $modal.open({
        templateUrl: "cpanelv1/CmsModules/blog/blogContent/upload_modal.html",
        size: "lg",
        scope: $scope
      });
    ...
    blogContent.openUploadModalPodcast = function () {
      $modal.open({
        templateUrl: 'cpanelv1/CmsModules/blog/blogContent/upload_modalPodcast.html',
        size: 'lg',
        scope: $scope
      });
    ...
    blogContent.openUploadModalMovie = function () {
      $modal.open({
        templateUrl: 'cpanelv1/CmsModules/blog/blogContent/upload_modalMovie.html',
        size: 'lg',
        scope: $scope
      });
    ...
    blogContent.replaceFile = function (name) {
      ...
      // Delete the file
      ajax
        .call(cmsServerConfig.configApiServerPath + "FileContent/", blogContent.fileIdToDelete, "GET")
        .success(function (response1) {
          rashaErManage.checkAction(response1);
      ...
      if ($("#save-icon" + index).hasClass("fa-save")) {
        if (blogContent.fileIsExist(uploadFile.name)) { // File already exists
          ...
          ajax.call(cmsServerConfig.configApiServerPath + "FileContent/ViewModel", "", 'GET').success(function (response) {
            ...
            blogContent.FileItem.UploadFileGUID = uploadFile.errorExceptionResult.Item.FileKey;
    ...
    blogContent.toggleExportForm = function () {
      ...
      $modal.open({
        templateUrl: "cpanelv1/CmsModules/Blog/BlogContent/report.html",
        scope: $scope
      });
    };
