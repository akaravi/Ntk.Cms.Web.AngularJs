app.controller("blogContentParameterTypeController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    blogContentParameterType.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'blogContentParameterType/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/blog/blogContentParameterType/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    blogContentParameterType.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'blogContentParameterType/', blogContentParameterType.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/blog/blogContentParameterType/edit.html',
                scope: $scope
            });
    ...
    blogContentParameterType.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/blog/blogContentParameterType/report.html',
            scope: $scope
        });
    }
