...
vehiclePropertyDetail.LinkCategoryIdSelector = {
    ...
    vehiclePropertyDetail.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"VehiclePropertyDetailGroup/getall", vehiclePropertyDetail.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            ...
            vehiclePropertyDetail.groupResultAccess = response.Access;
    ...
    vehiclePropertyDetail.openAddCategoryModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'VehiclePropertyDetailGroup/ViewModel', "", 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            vehiclePropertyDetail.selectedItem = response.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Vehicle/VehiclePropertyDetailGroup/add.html',
                scope: $scope
            });
    ...
    vehiclePropertyDetail.openEditCategoryModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'VehiclePropertyDetailGroup/', vehiclePropertyDetail.treeConfig.currentNode.Id, 'GET').success(function (response1) {
            vehiclePropertyDetail.showbusy = false;
            rashaErManage.checkAction(response1);
            vehiclePropertyDetail.selectedItem = response1.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Vehicle/VehiclePropertyDetailGroup/edit.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    vehiclePropertyDetail.deleteCategory = function () {
        ...
        if (vehiclePropertyDetail.ListItems.length == 0) {
            rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
                if (isConfirmed) {
                    vehiclePropertyDetail.categorybusyIndicator.isActive = true;
                    ajax.call(cmsServerConfig.configApiServerPath+'VehiclePropertyDetailGroup/', node.Id, 'GET').success(function (response) {
                        rashaErManage.checkAction(response);
                        vehiclePropertyDetail.selectedItemForDelete = response.Item;
                        ajax.call(cmsServerConfig.configApiServerPath+'VehiclePropertyDetailGroup/', vehiclePropertyDetail.selectedItemForDelet.Id, 'DELETE').success(function (res) {
    ...
    vehiclePropertyDetail.selectContent = function (node) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"vehiclePropertyDetail/getall", vehiclePropertyDetail.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            ...
            vehiclePropertyDetail.gridOptions.fillData(vehiclePropertyDetail.ListItems, response.Access);
    ...
    vehiclePropertyDetail.openAddContentModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'vehiclePropertyDetail/ViewModel', "", 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            vehiclePropertyDetail.selectedItem = response.Item;
            vehiclePropertyDetail.selectedItem.LinkPropertyDetailGroupId = node.Id;
            vehiclePropertyDetail.onMultipleChoiceChange();
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Vehicle/vehiclePropertyDetail/add.html',
                scope: $scope
            });
    ...
    vehiclePropertyDetail.openEditContentModal = function () {
        ...
        vehiclePropertyDetail.FieldName = "";
        ajax.call(cmsServerConfig.configApiServerPath+'vehiclePropertyDetail/', vehiclePropertyDetail.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            rashaErManage.checkAction(response1);
            vehiclePropertyDetail.selectedItem = response1.Item;
            ...
            vehiclePropertyDetail.onMultipleChoiceChange();
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Vehicle/vehiclePropertyDetail/edit.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    vehiclePropertyDetail.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                vehiclePropertyDetail.showIsBusy = true;
                ajax.call(cmsServerConfig.configApiServerPath+"vehiclePropertyDetail/", vehiclePropertyDetail.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    vehiclePropertyDetail.showbusy = false;
                    vehiclePropertyDetail.showIsBusy = false;
                    rashaErManage.checkAction(response);
                    vehiclePropertyDetail.selectedItemForDelete = response.Item;
                    ajax.call(cmsServerConfig.configApiServerPath+"vehiclePropertyDetail/", vehiclePropertyDetail.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        vehiclePropertyDetail.treeConfig.showbusy = false;
                        vehiclePropertyDetail.showIsBusy = false;
    ...
    vehiclePropertyDetail.editStepGoDown = function (item, index) {
        ...
        vehiclePropertyDetail.busyIndicator.isActive = true;
        ajax.call(cmsServerConfig.configApiServerPath+'VehiclePropertyDetail/', item.Id, 'GET').success(function (response1) {
            rashaErManage.checkAction(response1);
            vehiclePropertyDetail.selectedItem = response1.Item;
    ...
    vehiclePropertyDetail.editStepGoDownGroup = function (item) {
        ...
        vehiclePropertyDetail.busyIndicator.isActive = true;
        ajax.call(cmsServerConfig.configApiServerPath+'vehiclePropertyDetailGroup/', item.Id, 'GET').success(function (response1) {
            rashaErManage.checkAction(response1);
            vehiclePropertyDetail.selectedItem = response1.Item;
            var temp = response1.Item.ShowInFormOrder;
    ...
    vehiclePropertyDetail.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Vehicle/vehiclePropertyDetail/report.html',
            scope: $scope
        });
    }
