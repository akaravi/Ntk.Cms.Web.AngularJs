app.controller("mvGalleryCommentCtrl", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $window, $filter) {
    ...
    mvGalleryComment.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'MovieGalleryComment/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/MovieGallery/MovieGalleryComment/add.html',
                scope: $scope
            });
    ...
    mvGalleryComment.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'MovieGalleryComment/', mvGalleryComment.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            ...
            mvGalleryComment.selectedItem = response.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/MovieGallery/MovieGalleryComment/edit.html',
                scope: $scope
            });
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'MovieGalleryComment/', mvGalleryComment.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'MovieGalleryComment/', mvGalleryComment.selectedItemForDelete.Id, 'DELETE').success(function (res) {
    ...
    mvGalleryComment.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/MovieGallery/MovieGalleryComment/report.html',
            scope: $scope
        });
    }
