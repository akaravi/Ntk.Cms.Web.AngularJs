 ...
 mvGalleryTag.LinkCategoryTagIdSelector = {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'movieGalleryCategorytag/ViewModel', "", 'GET').success(function (response) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/movieGallery/movieGalleryCategorytag/add.html',
                        scope: $scope
                    });
                    mvGalleryTag.addRequested = false;
                }).error(function (data, errCode, c, d) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'movieGalleryCategorytag/', mvGalleryTag.treeConfig.currentNode.Id, 'GET').success(function (response) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/movieGallery/movieGalleryCategorytag/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'movieGalleryCategorytag/', node.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'movieGalleryCategorytag/', mvGalleryTag.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        mvGalleryTag.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
                            mvGalleryTag.gridOptions.advancedSearchData.engine.Filters = null;
                            mvGalleryTag.gridOptions.advancedSearchData.engine.Filters = [];
    ...
    mvGalleryTag.openAddModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'movieGallerytag/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/movieGallery/movieGallerytag/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    mvGalleryTag.openEditModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'movieGallerytag/', mvGalleryTag.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/movieGallery/movieGallerytag/edit.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"movieGallerytag/", mvGalleryTag.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+"movieGallerytag/", mvGalleryTag.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        mvGalleryTag.categoryBusyIndicator.isActive = false;
                        mvGalleryTag.treeConfig.showbusy = false;
                        mvGalleryTag.showIsBusy = false;
    ...
    mvGalleryTag.openUploadModal = function () {
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/movieGallery/movieGalleryContent/upload_modal.html',
            size: 'lg',
            scope: $scope
        });
            ...
            ajax
              ...
              .error(function(data) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/ViewModel", "", 'GET').success(function (response) {
                    ...
                    mvGalleryTag.FileItem.UploadFileGUID = uploadFile.errorExceptionResult.Item.FileKey;
    ...
    mvGalleryTag.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/movieGallery/movieGallerytag/report.html',
            scope: $scope
        });
    }
