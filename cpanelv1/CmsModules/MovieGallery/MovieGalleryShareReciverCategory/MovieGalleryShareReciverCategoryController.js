app.controller("movieGalleryShareReciverCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    movieGalleryShareReciverCategory.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"movieGalleryShareReciverCategory/getall", {}, 'POST').success(function (response) {
            ...
            movieGalleryShareReciverCategory.gridOptions.fillData(movieGalleryShareReciverCategory.ListItems, response.Access); // Sending Access as an argument
    ...
    movieGalleryShareReciverCategory.addNewCategoryModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'MovieGalleryShareMainAdminSetting/ViewModel', "", 'GET').success(function (response) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/MovieGallery/MovieGalleryShareMainAdminSetting/add.html',
                        scope: $scope
                    });
                    movieGalleryShareReciverCategory.addRequested = false;
                }).error(function (data, errCode, c, d) {
    ...
    movieGalleryShareReciverCategory.EditCategoryModel = function () {
        ...
        movieGalleryShareReciverCategory.contentBusyIndicator.isActive = true;
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'MovieGalleryShareMainAdminSetting/', movieGalleryShareReciverCategory.treeConfig.currentNode.Id, 'GET').success(function (response) {
            buttonIsPressed = false;
            movieGalleryShareReciverCategory.contentBusyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            movieGalleryShareReciverCategory.selectedItem = response.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/MovieGallery/MovieGalleryShareMainAdminSetting/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
    ...
    movieGalleryShareReciverCategory.addNewCategory = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'MovieGalleryShareMainAdminSetting/', movieGalleryShareReciverCategory.selectedItem, 'POST').success(function (response) {
            movieGalleryShareReciverCategory.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    movieGalleryShareReciverCategory.EditCategory = function (frm) {
        ...
        movieGalleryShareReciverCategory.categoryBusyIndicator.isActive = true;
        movieGalleryShareReciverCategory.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'MovieGalleryShareMainAdminSetting/', movieGalleryShareReciverCategory.selectedItem, "PUT").success(function (response) {
    ...
    movieGalleryShareReciverCategory.deleteCategory = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+'MovieGalleryShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    buttonIsPressed = false;
                    rashaErManage.checkAction(response);
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'MovieGalleryShareMainAdminSetting/', movieGalleryShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        movieGalleryShareReciverCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    movieGalleryShareReciverCategory.addNewContentModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'movieGalleryShareReciverCategory/ViewModel', "", 'GET').success(function (response) {
            buttonIsPressed = false;
            //console.log(response);
            rashaErManage.checkAction(response);
            movieGalleryShareReciverCategory.selectedItem = response.Item;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/movieGallery/movieGalleryShareReciverCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    movieGalleryShareReciverCategory.openEditModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'movieGalleryShareReciverCategory/', movieGalleryShareReciverCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            buttonIsPressed = false;
            rashaErManage.checkAction(response1);
            movieGalleryShareReciverCategory.selectedItem = response1.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/movieGallery/movieGalleryShareReciverCategory/edit.html',
                scope: $scope
            });
    ...
    movieGalleryShareReciverCategory.addNewContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'movieGalleryShareReciverCategory/', movieGalleryShareReciverCategory.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            movieGalleryShareReciverCategory.categoryBusyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    movieGalleryShareReciverCategory.editContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'movieGalleryShareReciverCategory/', movieGalleryShareReciverCategory.selectedItem, "PUT").success(function (response) {
            movieGalleryShareReciverCategory.categoryBusyIndicator.isActive = false;
            movieGalleryShareReciverCategory.addRequested = false;
            movieGalleryShareReciverCategory.treeConfig.showbusy = false;
    ...
    movieGalleryShareReciverCategory.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                movieGalleryShareReciverCategory.showIsBusy = true;
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+"movieGalleryShareReciverCategory/", movieGalleryShareReciverCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    buttonIsPressed = false;
                    movieGalleryShareReciverCategory.showbusy = false;
                    movieGalleryShareReciverCategory.showIsBusy = false;
                    rashaErManage.checkAction(response);
                    movieGalleryShareReciverCategory.selectedItemForDelete = response.Item;
                    console.log(movieGalleryShareReciverCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"movieGalleryShareReciverCategory/", movieGalleryShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        movieGalleryShareReciverCategory.categoryBusyIndicator.isActive = false;
                        movieGalleryShareReciverCategory.treeConfig.showbusy = false;
                        movieGalleryShareReciverCategory.showIsBusy = false;
    ...
    movieGalleryShareReciverCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/MovieGallery/movieGalleryShareReciverCategory/report.html',
            scope: $scope
        });
    }
