app.controller("movieGalleryShareServerCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    movieGalleryShareServerCategory.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"movieGalleryShareServerCategory/getall", {}, 'POST').success(function (response) {
            ...
            movieGalleryShareServerCategory.gridOptions.fillData(movieGalleryShareServerCategory.ListItems, response.Access); // Sending Access as an argument
    ...
    movieGalleryShareServerCategory.EditCategoryModel = function () {
        ...
        movieGalleryShareServerCategory.contentBusyIndicator.isActive = true;
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'MovieGalleryShareMainAdminSetting/', movieGalleryShareServerCategory.treeConfig.currentNode.Id, 'GET').success(function (response) {
            buttonIsPressed = false;
            movieGalleryShareServerCategory.contentBusyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            movieGalleryShareServerCategory.selectedItem = response.Item;
    ...
    movieGalleryShareServerCategory.addNewCategory = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'MovieGalleryShareMainAdminSetting/', movieGalleryShareServerCategory.selectedItem, 'POST').success(function (response) {
            movieGalleryShareServerCategory.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    movieGalleryShareServerCategory.EditCategory = function (frm) {
        ...
        movieGalleryShareServerCategory.categoryBusyIndicator.isActive = true;
        movieGalleryShareServerCategory.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'MovieGalleryShareMainAdminSetting/', movieGalleryShareServerCategory.selectedItem, "PUT").success(function (response) {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'MovieGalleryShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'MovieGalleryShareMainAdminSetting/', movieGalleryShareServerCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        movieGalleryShareServerCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    movieGalleryShareServerCategory.addNewContentModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'movieGalleryShareServerCategory/ViewModel', "", 'GET').success(function (response) {
            buttonIsPressed = false;
            //console.log(response);
            rashaErManage.checkAction(response);
            movieGalleryShareServerCategory.selectedItem = response.Item;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/movieGallery/movieGalleryShareServerCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    movieGalleryShareServerCategory.openEditModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'movieGalleryShareServerCategory/', movieGalleryShareServerCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            buttonIsPressed = false;
            rashaErManage.checkAction(response1);
            movieGalleryShareServerCategory.selectedItem = response1.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/movieGallery/movieGalleryShareServerCategory/edit.html',
                scope: $scope
            });
    ...
    movieGalleryShareServerCategory.addNewContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'movieGalleryShareServerCategory/', movieGalleryShareServerCategory.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            movieGalleryShareServerCategory.categoryBusyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    movieGalleryShareServerCategory.editContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'movieGalleryShareServerCategory/', movieGalleryShareServerCategory.selectedItem, "PUT").success(function (response) {
            movieGalleryShareServerCategory.categoryBusyIndicator.isActive = false;
            movieGalleryShareServerCategory.addRequested = false;
            movieGalleryShareServerCategory.treeConfig.showbusy = false;
    ...
    movieGalleryShareServerCategory.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                movieGalleryShareServerCategory.showIsBusy = true;
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+"movieGalleryShareServerCategory/", movieGalleryShareServerCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    buttonIsPressed = false;
                    movieGalleryShareServerCategory.showbusy = false;
                    movieGalleryShareServerCategory.showIsBusy = false;
                    rashaErManage.checkAction(response);
                    movieGalleryShareServerCategory.selectedItemForDelete = response.Item;
                    console.log(movieGalleryShareServerCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"movieGalleryShareServerCategory/", movieGalleryShareServerCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        movieGalleryShareServerCategory.categoryBusyIndicator.isActive = false;
                        movieGalleryShareServerCategory.treeConfig.showbusy = false;
                        movieGalleryShareServerCategory.showIsBusy = false;
   ...
   // End of Upload Modal-----------------------------------------
    ...
    movieGalleryShareServerCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/MovieGallery/movieGalleryShareServerCategory/report.html',
            scope: $scope
        });
    }
