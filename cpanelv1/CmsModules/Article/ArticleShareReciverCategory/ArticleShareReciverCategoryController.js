app.controller("articleShareReciverCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    articleShareReciverCategory.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"articleShareReciverCategory/getall",engine, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            articleShareReciverCategory.ListItems = response.ListItems;
            articleShareReciverCategory.gridOptions.fillData(articleShareReciverCategory.ListItems, response.Access); // Sending Access as an argument
    ...
    articleShareReciverCategory.addNewCategoryModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ArticleShareMainAdminSetting/ViewModel', "", 'GET').success(function (response) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Article/ArticleShareMainAdminSetting/add.html',
                        scope: $scope
                    });
                    articleShareReciverCategory.addRequested = false;
                }).error(function (data, errCode, c, d) {
    ...
    articleShareReciverCategory.EditCategoryModel = function () {
        ...
        articleShareReciverCategory.contentBusyIndicator.isActive = true;
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'ArticleShareMainAdminSetting/', articleShareReciverCategory.treeConfig.currentNode.Id, 'GET').success(function (response) {
            buttonIsPressed = false;
            articleShareReciverCategory.contentBusyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            articleShareReciverCategory.selectedItem = response.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Article/ArticleShareMainAdminSetting/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
    ...
    articleShareReciverCategory.addNewCategory = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ArticleShareMainAdminSetting/', articleShareReciverCategory.selectedItem, 'POST').success(function (response) {
            articleShareReciverCategory.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    articleShareReciverCategory.EditCategory = function (frm) {
        ...
        articleShareReciverCategory.categoryBusyIndicator.isActive = true;
        articleShareReciverCategory.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'ArticleShareMainAdminSetting/', articleShareReciverCategory.selectedItem, "PUT").success(function (response) {
    ...
    articleShareReciverCategory.deleteCategory = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+'ArticleShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    buttonIsPressed = false;
                    rashaErManage.checkAction(response);
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'ArticleShareMainAdminSetting/', articleShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        articleShareReciverCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    articleShareReciverCategory.selectContent = function (node) {
        ...
        articleShareReciverCategory.gridOptions.advancedSearchData.engine.AccessLoad = true;
    ...
    articleShareReciverCategory.addNewContentModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'articleShareReciverCategory/ViewModel', "", 'GET').success(function (response) {
            buttonIsPressed = false;
            //console.log(response);
            rashaErManage.checkAction(response);
            articleShareReciverCategory.selectedItem = response.Item;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/article/articleShareReciverCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    articleShareReciverCategory.openEditModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'articleShareReciverCategory/', articleShareReciverCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            buttonIsPressed = false;
            rashaErManage.checkAction(response1);
            articleShareReciverCategory.selectedItem = response1.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/article/articleShareReciverCategory/edit.html',
                scope: $scope
            });
    ...
    articleShareReciverCategory.addNewContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'articleShareReciverCategory/', articleShareReciverCategory.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            articleShareReciverCategory.categoryBusyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    articleShareReciverCategory.editContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'articleShareReciverCategory/', articleShareReciverCategory.selectedItem, "PUT").success(function (response) {
            articleShareReciverCategory.categoryBusyIndicator.isActive = false;
            articleShareReciverCategory.addRequested = false;
            articleShareReciverCategory.treeConfig.showbusy = false;
    ...
    articleShareReciverCategory.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                articleShareReciverCategory.showIsBusy = true;
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+"articleShareReciverCategory/", articleShareReciverCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    buttonIsPressed = false;
                    articleShareReciverCategory.showbusy = false;
                    articleShareReciverCategory.showIsBusy = false;
                    rashaErManage.checkAction(response);
                    articleShareReciverCategory.selectedItemForDelete = response.Item;
                    console.log(articleShareReciverCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"articleShareReciverCategory/", articleShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        articleShareReciverCategory.categoryBusyIndicator.isActive = false;
                        articleShareReciverCategory.treeConfig.showbusy = false;
                        articleShareReciverCategory.showIsBusy = false;
    ...
    articleShareReciverCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/News/articleShareReciverCategory/report.html',
            scope: $scope
        });
    }
