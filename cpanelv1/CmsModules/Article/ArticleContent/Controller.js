app.controller("articleContentController", [
  ...
  function (
    ...
    articleContent.addMenu = function () {
      ...
      $modal.open({
        templateUrl: "cpanelv1/CmsModules/article/articleContent/modalMenu.html",
        scope: $scope
      });
    };
    ...
    articleContent.init = function () {
      ...
      filterModel = {
        ...
        SearchType: 0,
        value: articleContent.selectedContentId.Id
      };
      ...
      ajax.call(cmsServerConfig.configApiServerPath + "articleContentTag/ViewModel", "", "GET").success(function (response) { //Get a ViewModel for articleContentTag
    ...
    articleContent.showComment = function (LinkContentId) {
      ...
      ajax.call(cmsServerConfig.configApiServerPath + "articlecomment/getall", engine, 'POST').success(function (response) {
        ...
        articleContent.gridContentOptions.fillData(articleContent.ListCommentItems, response.Access); // Sending Access as an argument
    ...
    articleContent.addNewCategoryModel = function () {
      ...
      ajax
        .call(cmsServerConfig.configApiServerPath + "articleCategory/ViewModel", "", "GET")
        .success(function (response) {
            ...
            .success(function (response1) {
              ...
              ajax
                ...
                .success(function (response2) {
                  ...
                  $modal.open({
                    templateUrl: "cpanelv1/CmsModules/Article/ArticleCategory/edit.html",
                    scope: $scope
                  });
                })
                .error(function (data, errCode, c, d) {
    ...
    articleContent.Showstatistics = function () {
      ...
      ajax.call(cmsServerConfig.configApiServerPath + 'articleContent/', articleContent.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
        rashaErManage.checkAction(response1);
        articleContent.selectedItem = response1.Item;
        $modal.open({
          templateUrl: "cpanelv1/CmsModules/article/articleContent/statistics.html",
          scope: $scope
        });
      }).error(function (data, errCode, c, d) {
        rashaErManage.checkAction(data, errCode);
    ...
    articleContent.addNewCategory = function (frm) {
      ...
      if (articleContent.treeConfig.currentNode != null)
        ...
        articleContent.treeConfig.currentNode.Id;
      ajax
        .call(cmsServerConfig.configApiServerPath + "articleCategory/", articleContent.selectedItem, "POST")
        .success(function (response) {
          articleContent.addRequested = false;
          rashaErManage.checkAction(response);
    ...
    articleContent.EditCategory = function (frm) {
      ...
      articleContent.addRequested = true;
      ajax
        .call(cmsServerConfig.configApiServerPath + "articleCategory/", articleContent.selectedItem, "PUT")
        .success(function (response) {
      ...
      rashaErManage.showYesNo(
        ...
        function (isConfirmed) {
          if (isConfirmed) {
            ...
            buttonIsPressed = true;
            ajax
              .call(cmsServerConfig.configApiServerPath + "articleCategory/", node.Id, "GET")
              .success(function (response) {
                buttonIsPressed = false;
                rashaErManage.checkAction(response);
    ...
    articleContent.addNewContentModel = function () {
      ...
      buttonIsPressed = true;
      ajax
        .call(cmsServerConfig.configApiServerPath + "articleContent/ViewModel", "", "GET")
        .success(function (response) {
          buttonIsPressed = false;
          rashaErManage.checkAction(response);
          ...
          $modal.open({
            templateUrl: "cpanelv1/CmsModules/article/articleContent/add.html",
            scope: $scope
          });
        })
        .error(function (data, errCode, c, d) {
    ...
    articleContent.saveOtherInfos = function () {
      ...
      if (articleContent.editMode) {
        ...
        articleContent.selectedItemOtherInfos = {};
        // ajax.call(cmsServerConfig.configApiServerPath + 'articleContentOtherInfo/', articleContent.selectedItemOtherInfos, 'POST').success(function (response) {
        //   rashaErManage.checkAction(response);
        //   if (response.IsSuccess) {
    ...
    articleContent.openEditModel = function () {
      ...
      articleContent.selectedItemOtherInfos = {};
      buttonIsPressed = true;
      ajax.call(cmsServerConfig.configApiServerPath + "articleContent/", articleContent.gridOptions.selectedRow.item.Id, "GET")
        .success(function (response1) {
          buttonIsPressed = false;
          rashaErManage.checkAction(response1);
          articleContent.selectedItem = response1.Item;
          ...
          var filterValue = {
            PropertyName: "LinkContentId",
            value: articleContent.gridOptions.selectedRow.item.Id,
            SearchType: 0
          }
          ...
          $modal.open({
            templateUrl: "cpanelv1/CmsModules/article/articleContent/edit.html",
            scope: $scope
          });
        })
        .error(function (data, errCode, c, d) {
    ...
    articleContent.addNewContent = function (frm) {
      ...
      ajax.call(cmsServerConfig.configApiServerPath + "articleContent/", apiSelectedItem, "POST").success(function (response) {
          rashaErManage.checkAction(response);
          articleContent.categoryBusyIndicator.isActive = false;
          if (response.IsSuccess) {
    ...
    articleContent.editContent = function (frm) {
      ...
      if (articleContent.ContentModuleRelationShipRemoved && articleContent.ContentModuleRelationShipRemoved.length > 0) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + "CoreModuleRelationshipContent/DeleteList", articleContent.ContentModuleRelationShipRemoved, "Delete").success(function (response) {
            rashaErManage.checkAction(response);
          })
          .error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
      ...
      if (articleContent.ContentModuleRelationShipAdded && articleContent.ContentModuleRelationShipAdded.length > 0) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + "CoreModuleRelationshipContent/addbatch", articleContent.ContentModuleRelationShipAdded, "POST").success(function (response) {
            rashaErManage.checkAction(response);
          })
          .error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
      ...
      ajax
        .call(cmsServerConfig.configApiServerPath + "articleContent/", apiSelectedItem, "PUT")
        .success(function (response) {
          articleContent.categoryBusyIndicator.isActive = false;
          articleContent.addRequested = false;
          articleContent.treeConfig.showbusy = false;
      ...
      ajax
        ...
        .success(function (response) {
          ...
          articleContent.selectedItem.IsAccepted = response.Item.IsAccepted == true ?
            ...
            true;
          ajax
            .call(cmsServerConfig.configApiServerPath + "articleContent/", articleContent.selectedItem, "PUT")
            .success(function (response2) {
    ...
    articleContent.confirmComment = function (item) {
      if (item.Id && item.Id > 0) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + 'ArticleComment/', itemCopy, "PUT").success(function (response) {
          rashaErManage.checkAction(response);
          if(response.IsSuccess)
          articleContent.showComment(articleContent.gridOptions.selectedRow.item.Id)
        }).error(function (data, errCode, c, d) {
    ...
    articleContent.openUploadModal = function () {
      $modal.open({
        templateUrl: "cpanelv1/CmsModules/article/articleContent/upload_modal.html",
        size: "lg",
        scope: $scope
      });
    ...
    articleContent.openUploadModalPodcast = function () {
      $modal.open({
        templateUrl: 'cpanelv1/CmsModules/article/articleContent/upload_modalPodcast.html',
        size: 'lg',
        scope: $scope
      });
    ...
    articleContent.openUploadModalMovie = function () {
      $modal.open({
        templateUrl: 'cpanelv1/CmsModules/article/articleContent/upload_modalMovie.html',
        size: 'lg',
        scope: $scope
      });
    ...
    articleContent.replaceFile = function (name) {
      ...
      // Delete the file
      ajax
        .call(cmsServerConfig.configApiServerPath + "FileContent/", articleContent.fileIdToDelete, "GET")
        .success(function (response1) {
          rashaErManage.checkAction(response1);
    ...
    articleContent.saveNewFile = function () {
      ajax
        .call(cmsServerConfig.configApiServerPath + "FileContent/", articleContent.FileItem, "POST")
        .success(function (response) {
          if (response.IsSuccess) {
      ...
      if ($("#save-icon" + index).hasClass("fa-save")) {
        if (articleContent.fileIsExist(uploadFile.name)) { // File already exists
          ...
          ajax.call(cmsServerConfig.configApiServerPath + "FileContent/ViewModel", "", 'GET').success(function (response) {
            ...
            articleContent.FileItem.UploadFileGUID = uploadFile.errorExceptionResult.Item.FileKey;
            ...
            // ------- articleContent.saveNewFile()  ----------------------
            var result = 0;
            ajax.call(cmsServerConfig.configApiServerPath + "FileContent/", articleContent.FileItem, 'POST').success(function (response) {
              if (response.IsSuccess) {
                articleContent.FileItem = response.Item;
                articleContent.showSuccessIcon();
                $("#save-icon" + index).removeClass("fa-save");
    ...
    articleContent.toggleExportForm = function () {
      ...
      $modal.open({
        templateUrl: "cpanelv1/CmsModules/Article/ArticleContent/report.html",
        scope: $scope
      });
    };
