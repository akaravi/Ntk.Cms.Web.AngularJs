 ...
 articleTag.LinkCategoryTagIdSelector = {
    ...
    articleTag.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"articletag/getall", articleTag.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            ...
            articleTag.gridOptions.fillData(articleTag.ListItems, response.Access); // Sending Access as an argument
    ...
    articleTag.addNewCategoryModel = function () {
        articleTag.addRequested = false;
        ajax.call(cmsServerConfig.configApiServerPath+'articleCategorytag/ViewModel', "", 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/article/articleCategorytag/add.html',
                        scope: $scope
                    });
                    articleTag.addRequested = false;
                }).error(function (data, errCode, c, d) {
    ...
    articleTag.openEditCategoryModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'articleCategorytag/', articleTag.treeConfig.currentNode.Id, 'GET').success(function (response) {
            buttonIsPressed = false;
            articleTag.contentBusyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            articleTag.selectedItem = response.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/article/articleCategorytag/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
    ...
    articleTag.addNewCategory = function (frm) {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'articleCategorytag/', articleTag.selectedItem, 'POST').success(function (response) {
            buttonIsPressed = false;
            articleTag.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    articleTag.editCategory = function (frm) {
        ...
        articleTag.categoryBusyIndicator.isActive = true;
        ajax.call(cmsServerConfig.configApiServerPath+'articleCategorytag/', articleTag.selectedItem, "PUT").success(function (response) {
            articleTag.addRequested = true;
    ...
    articleTag.deleteCategory = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'articleCategorytag/', node.Id, 'GET').success(function (response) {
                    rashaErManage.checkAction(response);
                    articleTag.selectedItemForDelete = response.Item;
                    ajax.call(cmsServerConfig.configApiServerPath+'articleCategorytag/', articleTag.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        articleTag.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
                            articleTag.gridOptions.advancedSearchData.engine.Filters = null;
                            articleTag.gridOptions.advancedSearchData.engine.Filters = [];
    ...
    articleTag.openAddModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'articletag/ViewModel', "", 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            articleTag.selectedItem = response.Item;
            articleTag.selectedItem.LinkCategoryTagId = articleTag.CategoryTagId;
            //articleTag.clearPreviousData();
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/article/articletag/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    articleTag.openEditModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'articletag/', articleTag.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            buttonIsPressed = false;
            rashaErManage.checkAction(response1);
            articleTag.selectedItem = response1.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/article/articletag/edit.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    articleTag.addNewContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'articletag/', articleTag.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            articleTag.categoryBusyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    articleTag.editContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'articletag/', articleTag.selectedItem, "PUT").success(function (response) {
            articleTag.categoryBusyIndicator.isActive = false;
            articleTag.addRequested = false;
            articleTag.treeConfig.showbusy = false;
            articleTag.showIsBusy = false;
    ...
    articleTag.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                articleTag.showIsBusy = true;
                ajax.call(cmsServerConfig.configApiServerPath+"articletag/", articleTag.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    articleTag.showbusy = false;
                    articleTag.showIsBusy = false;
                    rashaErManage.checkAction(response);
                    articleTag.selectedItemForDelete = response.Item;
                    console.log(articleTag.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"articletag/", articleTag.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        articleTag.categoryBusyIndicator.isActive = false;
                        articleTag.treeConfig.showbusy = false;
                        articleTag.showIsBusy = false;
  ...
  //#help similar & otherinfo
   ...
   articleTag.editOtherInfo = function(y) {
    ...
    articleTag.replaceFile = function (name) {
        ...
        // Delete the file
        ajax.call(cmsServerConfig.configApiServerPath+"FileContent/", articleTag.fileIdToDelete, 'GET').success(function (response1) {
    ...
    articleTag.saveNewFile = function () {
        ajax.call(cmsServerConfig.configApiServerPath+"FileContent/", articleTag.FileItem, 'POST').success(function (response) {
            if (response.IsSuccess) {
            ...
            ajax
              ...
              .error(function(data) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/ViewModel", "", 'GET').success(function (response) {
                    ...
                    articleTag.FileItem.UploadFileGUID = uploadFile.errorExceptionResult.Item.FileKey;
    ...
    articleTag.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/article/articletag/report.html',
            scope: $scope
        });
    }
