...
quoteContent.LinkCategoryIdSelector = {
    ...
    quoteContent.addMenu = function () {
        $modal.open({
            templateUrl: "cpanelv1/CmsModules/Quote/QuoteContent/modalMenu.html",
            scope: $scope
        });
    }
    ...
    quoteContent.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"quoteContent/getall", quoteContent.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            ...
            quoteContent.gridOptions.fillData(quoteContent.ListItems, response.Access); // Sending Access as an argument
    ...
    quoteContent.Showstatistics = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'quoteContent/', quoteContent.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            rashaErManage.checkAction(response1);
            quoteContent.selectedItem = response1.Item;
            $modal.open({
                templateUrl: "cpanelv1/CmsModules/Quote/quoteContent/statistics.html",
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    quoteContent.addNewCategoryModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'QuoteCategory/ViewModel', "", 'GET').success(function (response) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Quote/QuoteCategory/add.html',
                        scope: $scope
                    });
                    quoteContent.addRequested = false;
                }).error(function (data, errCode, c, d) {
    ...
    quoteContent.editCategoryModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'QuoteCategory/', quoteContent.treeConfig.currentNode.Id, 'GET').success(function (response) {
            buttonIsPressed = false;
            quoteContent.contentBusyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            quoteContent.selectedItem = response.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Quote/QuoteCategory/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
    ...
    quoteContent.deleteCategory = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+'QuoteCategory/', node.Id, 'GET').success(function (response) {
                    buttonIsPressed = false;
                    rashaErManage.checkAction(response);
    ...
    quoteContent.addNewContentModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'quoteContent/ViewModel', "", 'GET').success(function (response) {
            buttonIsPressed = false;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Quote/quoteContent/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    quoteContent.openEditModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'quoteContent/', quoteContent.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            ...
            quoteContent.filePickerFiles.fileId = null;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Quote/quoteContent/edit.html',
                scope: $scope
            });
    ...
    quoteContent.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                quoteContent.showIsBusy = true;
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+"quoteContent/", quoteContent.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    buttonIsPressed = false;
                    quoteContent.showbusy = false;
                    quoteContent.showIsBusy = false;
                    rashaErManage.checkAction(response);
 ...
 //#help similar & otherinfo
   ...
   quoteContent.editOtherInfo = function(y) {
    ...
    quoteContent.openUploadModal = function () {
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Quote/QuoteContent/upload_modal.html',
            size: 'lg',
            scope: $scope
        });
        ...
        if ($("#save-icon" + index).hasClass("fa-save")) {
            ...
            //--------------------------------
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/ViewModel", "", 'GET').success(function (response) {
                    ...
                    quoteContent.FileItem.UploadFileGUID = uploadFile.errorExceptionResult.Item.FileKey;
    ...
    quoteContent.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Quote/QuoteContent/report.html',
            scope: $scope
        });
    }
