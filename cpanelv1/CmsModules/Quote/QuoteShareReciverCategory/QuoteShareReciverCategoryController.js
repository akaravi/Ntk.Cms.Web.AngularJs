app.controller("quoteShareReciverCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'QuoteShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'QuoteShareMainAdminSetting/', quoteShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        quoteShareReciverCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    quoteShareReciverCategory.addNewContentModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'quoteShareReciverCategory/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/quote/quoteShareReciverCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    quoteShareReciverCategory.openEditModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'quoteShareReciverCategory/', quoteShareReciverCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/quote/quoteShareReciverCategory/edit.html',
                scope: $scope
            });
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"quoteShareReciverCategory/", quoteShareReciverCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    ...
                    quoteShareReciverCategory.selectedItemForDelete = response.Item;
                    console.log(quoteShareReciverCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"quoteShareReciverCategory/", quoteShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        quoteShareReciverCategory.categoryBusyIndicator.isActive = false;
                        quoteShareReciverCategory.treeConfig.showbusy = false;
                        quoteShareReciverCategory.showIsBusy = false;
    ...
    quoteShareReciverCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Quote/quoteShareReciverCategory/report.html',
            scope: $scope
        });
    }
