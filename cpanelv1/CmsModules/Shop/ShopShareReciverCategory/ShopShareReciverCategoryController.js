app.controller("shopShareReciverCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    shopShareReciverCategory.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"shopShareReciverCategory/getall", {AccessLoad : true}, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            shopShareReciverCategory.ListItems = response.ListItems;
            shopShareReciverCategory.gridOptions.fillData(shopShareReciverCategory.ListItems, response.Access); // Sending Access as an argument
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ShopShareMainAdminSetting/ViewModel', "", 'GET').success(function (response) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Shop/ShopShareMainAdminSetting/add.html',
                        scope: $scope
                    });
                    shopShareReciverCategory.addRequested = false;
                }).error(function (data, errCode, c, d) {
    ...
    shopShareReciverCategory.EditCategoryModel = function () {
        ...
        shopShareReciverCategory.contentBusyIndicator.isActive = true;
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'ShopShareMainAdminSetting/', shopShareReciverCategory.treeConfig.currentNode.Id, 'GET').success(function (response) {
            buttonIsPressed = false;
            shopShareReciverCategory.contentBusyIndicator.isActive = false;
            rashaErManage.checkAction(response);
            shopShareReciverCategory.selectedItem = response.Item;
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Shop/ShopShareMainAdminSetting/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
    ...
    shopShareReciverCategory.addNewCategory = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ShopShareMainAdminSetting/', shopShareReciverCategory.selectedItem, 'POST').success(function (response) {
            shopShareReciverCategory.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    shopShareReciverCategory.EditCategory = function (frm) {
        ...
        shopShareReciverCategory.categoryBusyIndicator.isActive = true;
        shopShareReciverCategory.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'ShopShareMainAdminSetting/', shopShareReciverCategory.selectedItem, "PUT").success(function (response) {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'ShopShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'ShopShareMainAdminSetting/', shopShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        shopShareReciverCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    shopShareReciverCategory.selectContent = function (node) {
        ...
        shopShareReciverCategory.gridOptions.advancedSearchData.engine.AccessLoad = true;
    ...
    shopShareReciverCategory.addNewContentModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'shopShareReciverCategory/ViewModel', "", 'GET').success(function (response) {
            buttonIsPressed = false;
            //console.log(response);
            rashaErManage.checkAction(response);
            shopShareReciverCategory.selectedItem = response.Item;
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/shop/shopShareReciverCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    shopShareReciverCategory.openEditModel = function () {
        ...
        buttonIsPressed = true;
        ajax.call(cmsServerConfig.configApiServerPath+'shopShareReciverCategory/', shopShareReciverCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            buttonIsPressed = false;
            rashaErManage.checkAction(response1);
            shopShareReciverCategory.selectedItem = response1.Item;
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/shop/shopShareReciverCategory/edit.html',
                scope: $scope
            });
    ...
    shopShareReciverCategory.addNewContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'shopShareReciverCategory/', shopShareReciverCategory.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            shopShareReciverCategory.categoryBusyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    shopShareReciverCategory.editContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'shopShareReciverCategory/', shopShareReciverCategory.selectedItem, "PUT").success(function (response) {
            shopShareReciverCategory.categoryBusyIndicator.isActive = false;
            shopShareReciverCategory.addRequested = false;
            shopShareReciverCategory.treeConfig.showbusy = false;
    ...
    shopShareReciverCategory.deleteContent = function () {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                shopShareReciverCategory.showIsBusy = true;
                buttonIsPressed = true;
                ajax.call(cmsServerConfig.configApiServerPath+"shopShareReciverCategory/", shopShareReciverCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    buttonIsPressed = false;
                    shopShareReciverCategory.showbusy = false;
                    shopShareReciverCategory.showIsBusy = false;
                    rashaErManage.checkAction(response);
                    shopShareReciverCategory.selectedItemForDelete = response.Item;
                    console.log(shopShareReciverCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"shopShareReciverCategory/", shopShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        shopShareReciverCategory.categoryBusyIndicator.isActive = false;
                        shopShareReciverCategory.treeConfig.showbusy = false;
                        shopShareReciverCategory.showIsBusy = false;
    ...
    shopShareReciverCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Shop/shopShareReciverCategory/report.html',
            scope: $scope
        });
    }
