...
//                   $modal.open({
//                       templateUrl: 'cpanelv1/CmsModules/Shop/ShopProcess/add.html',
//                       scope: $scope
//                   });
//                   shopProcess.addRequested = false;
//               }).error(function (data, errCode, c, d) {
...
//        ajax.call(cmsServerConfig.configApiServerPath+'ShopProcess/', shopProcess.selectedItem, 'POST').success(function (response) {
//            shopProcess.addRequested = false;
//            shopProcess.busyIndicator.isActive = false;
//            rashaErManage.checkAction(response);
...
//    }
         ...
         if (response.Item.LinkMainImageId != null) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath+"FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/GetFilesInCategoryId/","", 'GET').success(function (response2) { //Get files in root
                    ...
                    shopProcess.busyIndicator.isActive = false;
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Shop/ShopProcess/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
    ...
    shopProcess.editRow = function (frm) {
        ...
        shopProcess.busyIndicator.isActive = true;
        ajax.call(cmsServerConfig.configApiServerPath+'ShopProcess/', shopProcess.selectedItem, "PUT").success(function (response) {
            shopProcess.addRequested = true;
            rashaErManage.checkAction(response);
            shopProcess.busyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    shopProcess.showFormMainAdmin = function (preview, selectedId) {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Shop/ShopProcess/formMainAdmin.html',
            scope: $scope
        });
    }
    ...
    shopProcess.saveJsonFormMainAdmin = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ShopProcess/', shopProcess.selectedItem.Id, 'GET').success(function (response1) {
            ...
            shopProcess.busyIndicator.isActive = true;
            ajax.call(cmsServerConfig.configApiServerPath+'ShopProcess/', shopProcess.selectedItem, "PUT").success(function (response2) {
   ...
   var component = $.parseJSON(shopProcess.selectedItem.JsonFormAdminSiteJsonForm);
    ...
    shopProcess.showFormSiteAdmin = function (preview, selectedId) {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Shop/ShopProcess/formSiteAdmin.html',
            scope: $scope
        });
    }
    // Save Input Value Form
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    shopProcess.showFormPreview = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ShopProcessvalue/', shopProcess.selectedItem.Id, 'GET').success(function (response1) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Shop/ShopProcess/preview.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            shopProcess.busyIndicator.isActive = false;
      ...
      if ($("#save-icon" + index).hasClass("fa-save")) {
          ...
          ajax
            ...
            .success(function(response) {
              ...
              var result = 0;
              ajax
                .call(cmsServerConfig.configApiServerPath + "FileContent/", shopProcess.FileItem, "POST")
                .success(function(response) {
                  if (response.IsSuccess) {
                    shopProcess.FileItem = response.Item;
                    shopProcess.showSuccessIcon();
