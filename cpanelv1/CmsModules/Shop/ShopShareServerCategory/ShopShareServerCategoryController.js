app.controller("shopShareServerCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    shopShareServerCategory.addNewCategory = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'ShopShareMainAdminSetting/', shopShareServerCategory.selectedItem, 'POST').success(function (response) {
            shopShareServerCategory.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    shopShareServerCategory.EditCategory = function (frm) {
        ...
        shopShareServerCategory.categoryBusyIndicator.isActive = true;
        shopShareServerCategory.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'ShopShareMainAdminSetting/', shopShareServerCategory.selectedItem, "PUT").success(function (response) {
    ...
    shopShareServerCategory.addNewContentModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'shopShareServerCategory/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/shop/shopShareServerCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    shopShareServerCategory.openEditModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'shopShareServerCategory/', shopShareServerCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/shop/shopShareServerCategory/edit.html',
                scope: $scope
            });
    ...
    shopShareServerCategory.addNewContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'shopShareServerCategory/', shopShareServerCategory.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            shopShareServerCategory.categoryBusyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    shopShareServerCategory.editContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'shopShareServerCategory/', shopShareServerCategory.selectedItem, "PUT").success(function (response) {
            shopShareServerCategory.categoryBusyIndicator.isActive = false;
            shopShareServerCategory.addRequested = false;
            shopShareServerCategory.treeConfig.showbusy = false;
   ...
   // End of Upload Modal-----------------------------------------
    ...
    shopShareServerCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Shop/shopShareServerCategory/report.html',
            scope: $scope
        });
    }
