app.controller("newsShareReciverCategoryController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$rootScope', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $rootScope, $filter) {
    ...
    newsShareReciverCategory.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+"newsShareReciverCategory/getall", engine, 'POST').success(function (response) {
    ...
    newsShareReciverCategory.addNewCategory = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'NewsShareMainAdminSetting/', newsShareReciverCategory.selectedItem, 'POST').success(function (response) {
            newsShareReciverCategory.addRequested = false;
            rashaErManage.checkAction(response);
    ...
    newsShareReciverCategory.EditCategory = function (frm) {
        ...
        newsShareReciverCategory.categoryBusyIndicator.isActive = true;
        newsShareReciverCategory.addRequested = true;
        ajax.call(cmsServerConfig.configApiServerPath+'NewsShareMainAdminSetting/', newsShareReciverCategory.selectedItem, "PUT").success(function (response) {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'NewsShareMainAdminSetting/', node.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'NewsShareMainAdminSetting/', newsShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        newsShareReciverCategory.categoryBusyIndicator.isActive = false;
                        if (res.IsSuccess) {
    ...
    newsShareReciverCategory.selectContent = function (node) {
        ...
        newsShareReciverCategory.gridOptions.advancedSearchData.engine.AccessLoad = true;
    ...
    newsShareReciverCategory.addNewContentModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'newsShareReciverCategory/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/news/newsShareReciverCategory/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    newsShareReciverCategory.openEditModel = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'newsShareReciverCategory/', newsShareReciverCategory.gridOptions.selectedRow.item.Id, 'GET').success(function (response1) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/news/newsShareReciverCategory/edit.html',
                scope: $scope
            });
    ...
    newsShareReciverCategory.addNewContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'newsShareReciverCategory/', newsShareReciverCategory.selectedItem, 'POST').success(function (response) {
            rashaErManage.checkAction(response);
            newsShareReciverCategory.categoryBusyIndicator.isActive = false;
            if (response.IsSuccess) {
    ...
    newsShareReciverCategory.editContent = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'newsShareReciverCategory/', newsShareReciverCategory.selectedItem, "PUT").success(function (response) {
            newsShareReciverCategory.categoryBusyIndicator.isActive = false;
            newsShareReciverCategory.addRequested = false;
            newsShareReciverCategory.treeConfig.showbusy = false;
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"newsShareReciverCategory/", newsShareReciverCategory.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    ...
                    newsShareReciverCategory.selectedItemForDelete = response.Item;
                    console.log(newsShareReciverCategory.selectedItemForDelete);
                    ajax.call(cmsServerConfig.configApiServerPath+"newsShareReciverCategory/", newsShareReciverCategory.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        newsShareReciverCategory.categoryBusyIndicator.isActive = false;
                        newsShareReciverCategory.treeConfig.showbusy = false;
                        newsShareReciverCategory.showIsBusy = false;
    ...
    newsShareReciverCategory.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/News/newsShareReciverCategory/report.html',
            scope: $scope
        });
    }
