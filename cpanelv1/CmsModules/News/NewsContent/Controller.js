app.controller("newsContentController", [
    ...
    function(
        ...
        newsContent.gridContentOptions = {
            columns: [{
                ...
                },
                {
                    ...
                    template: '<Button ng-if="(x.RecordStatus!=1)" ng-click="newsContent.confirmComment(x)" class="btn btn-primary" style="margin-left: 2px;"><i class="fa fa-check-square-o" aria-hidden="true"></i>&nbsp&nbspتایید می کنم</Button>' +
        ...
        newsContent.addMenu = function() {
            ...
            $modal.open({
                templateUrl: "cpanelv1/CmsModules/news/newsContent/modalMenu.html",
                scope: $scope
            });
        };
        ...
        newsContent.init = function() {
            ...
            ajax.call(cmsServerConfig.configApiServerPath + "newsContentTag/ViewModel", "", "GET").success(function(response) { //Get a ViewModel for newsContentTag
        ...
        newsContent.showComment = function(LinkContentId) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath + "newscomment/getall", engine, 'POST').success(function(response) {
                ...
                newsContent.gridContentOptions.fillData(newsContent.ListCommentItems, response.Access); // Sending Access as an argument
        ...
        newsContent.addNewCategoryModel = function() {
            ...
            ajax
                .call(cmsServerConfig.configApiServerPath + "newsCategory/ViewModel", "", "GET")
                .success(function(response) {
                        ...
                        .success(function(response1) {
                            ...
                            ajax
                                ...
                                .success(function(response2) {
                                    ...
                                    $modal.open({
                                        templateUrl: "cpanelv1/CmsModules/News/NewsCategory/add.html",
                                        scope: $scope
                                    });
                                    newsContent.addRequested = false;
                                })
        ...
        newsContent.EditCategoryModel = function() {
            ...
            ajax
                .call(
                    cmsServerConfig.configApiServerPath + "newsCategory/",
                        ...
                        .success(function(response1) {
                            ...
                            ajax
                                ...
                                .success(function(response2) {
                                    ...
                                    $modal.open({
                                        templateUrl: "cpanelv1/CmsModules/News/NewsCategory/edit.html",
                                        scope: $scope
                                    });
                                })
                                .error(function(data, errCode, c, d) {
        ...
        newsContent.Showstatistics = function() {
            ...
            ajax.call(cmsServerConfig.configApiServerPath + 'newsContent/', newsContent.gridOptions.selectedRow.item.Id, 'GET').success(function(response1) {
                rashaErManage.checkAction(response1);
                newsContent.selectedItem = response1.Item;
                $modal.open({
                    templateUrl: "cpanelv1/CmsModules/news/newsContent/statistics.html",
                    scope: $scope
                });
            }).error(function(data, errCode, c, d) {
                rashaErManage.checkAction(data, errCode);
            ...
            rashaErManage.showYesNo(
                ...
                function(isConfirmed) {
                    if (isConfirmed) {
                        ...
                        buttonIsPressed = true;
                        ajax
                            .call(cmsServerConfig.configApiServerPath + "newsCategory/", node.Id, "GET")
                            .success(function(response) {
                                buttonIsPressed = false;
                                rashaErManage.checkAction(response);
        ...
        newsContent.addNewContentModel = function() {
            ...
            buttonIsPressed = true;
            ajax
                .call(cmsServerConfig.configApiServerPath + "newsContent/ViewModel", "", "GET")
                .success(function(response) {
                    buttonIsPressed = false;
                    rashaErManage.checkAction(response);
                    ...
                    $modal.open({
                        templateUrl: "cpanelv1/CmsModules/news/newsContent/add.html",
                        scope: $scope
                    });
                })
                .error(function(data, errCode, c, d) {
        ...
        newsContent.openEditModel = function() {
            ...
            if (newsContent.gridOptions.selectedRow.item.LinkSiteId != $rootScope.tokenInfo.SiteId && !$rootScope.tokenInfo.UserAccessAdminAllowToAllData) {
                rashaErManage.showMessage($filter('translatentk')('This_News_Is_Shared'));
                return;
            }
            newsContent.selectedItemOtherInfos = {};
            buttonIsPressed = true;
            ajax.call(cmsServerConfig.configApiServerPath + "newsContent/", newsContent.gridOptions.selectedRow.item.Id, "GET")
                .success(function(response1) {
                    buttonIsPressed = false;
                    rashaErManage.checkAction(response1);
                    newsContent.selectedItem = response1.Item;
                    ...
                    $modal.open({
                        templateUrl: "cpanelv1/CmsModules/news/newsContent/edit.html",
                        scope: $scope
                    });
                })
                .error(function(data, errCode, c, d) {
        ...
        newsContent.addNewContent = function(frm) {
            ...
            ajax.call(cmsServerConfig.configApiServerPath + "newsContent/", apiSelectedItem, "POST").success(function(response) {
                ...
                if (response.IsSuccess) {
                    ...
                    if (newsContent.tags && newsContent.tags.length > 0) {
        ...
        newsContent.editContent = function(frm) {
            ...
            if (newsContent.ContentTagsRemoved && newsContent.ContentTagsRemoved.length > 0) {
                ajax.call(cmsServerConfig.configApiServerPath + "newsContentTag/DeleteList", newsContent.ContentTagsRemoved, "POST").success(function(response) {
                        rashaErManage.checkAction(response);
                    })
                    .error(function(data, errCode, c, d) {
                        rashaErManage.checkAction(data, errCode);
            ...
            if (newsContent.ContentOtherInfosRemoved && newsContent.ContentOtherInfosRemoved.length > 0) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath + "newsContentOtherInfo/DeleteList", OtherInfosRemovedModel, "POSt").success(function(response) {
                        rashaErManage.checkAction(response);
                    })
                    .error(function(data, errCode, c, d) {
                        rashaErManage.checkAction(data, errCode);
            ...
            if (newsContent.ContentSimilarsRemoved && newsContent.ContentSimilarsRemoved.length > 0) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath + "newsContentSimilar/DeleteList", SimilarsRemovedModel, "POST").success(function(response) {
                        rashaErManage.checkAction(response);
                    })
                    .error(function(data, errCode, c, d) {
                        rashaErManage.checkAction(data, errCode);
            ...
            rashaErManage.showYesNo(
                ...
                function(isConfirmed) {
                    if (isConfirmed) {
                        ...
                        ajax
                            .call(
                                cmsServerConfig.configApiServerPath + "newsContent/",
            ...
            rashaErManage.showYesNo(
                ...
                function(isConfirmed) {
                    if (isConfirmed) {
                        ...
                        var itemCopy = angular.copy(item);
                        itemCopy.rowOption = null;
                        ajax.call(cmsServerConfig.configApiServerPath + "newsComment/", itemCopy.Id, "DELETE")
                            .success(function(res) {
                                newsContent.treeConfig.showbusy = false;
                                newsContent.showbusy = false;
                                newsContent.showIsBusy = false;
        ...
        newsContent.deleteAttachedfieldName = function(index) {
            ajax
                .call(
                    cmsServerConfig.configApiServerPath + "newsContent/",
                    newsContent.contractsList[index].Id,
                    "DELETE"
                )
                .success(function(res) {
                    rashaErManage.checkAction(res);
        ...
        newsContent.openUploadModal = function() {
            $modal.open({
                templateUrl: "cpanelv1/CmsModules/news/newsContent/upload_modal.html",
                size: "lg",
                scope: $scope
            });
        ...
        newsContent.openUploadModalPodcast = function() {
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/news/newsContent/upload_modalPodcast.html',
                size: 'lg',
                scope: $scope
            });
        ...
        newsContent.openUploadModalMovie = function() {
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/news/newsContent/upload_modalMovie.html',
                size: 'lg',
                scope: $scope
            });
        ...
        newsContent.replaceFile = function(name) {
            ...
            // Delete the file
            ajax
                .call(cmsServerConfig.configApiServerPath + "FileContent/", newsContent.fileIdToDelete, "GET")
                .success(function(response1) {
                    rashaErManage.checkAction(response1);
        ...
        newsContent.toggleExportForm = function() {
            ...
            $modal.open({
                templateUrl: "cpanelv1/CmsModules/News/NewsContent/report.html",
                scope: $scope
            });
        };
