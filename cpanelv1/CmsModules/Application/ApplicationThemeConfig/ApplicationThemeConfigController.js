app.controller("themeConfigController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$builder', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $builder, $window, $filter) {
    ...
    themeConfig.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + 'ApplicationThemeConfig/ViewModel', "", 'GET').success(function (response) {
            ...
            if (themeConfig.selectedItem != undefined && themeConfig.selectedItem.virtual_Source != undefined) {
                themeConfig.selectedItem.ThemeConfigBuilderJsonValuesHtml = 'cpanelv1/CmsModules/Application/ConfigTheme/' + themeConfig.selectedItem.virtual_Source.ClassName + '.Builder.html';
                themeConfig.selectedItem.ThemeConfigRuntimeJsonValuesHtml = 'cpanelv1/CmsModules/Application/ConfigTheme/' + themeConfig.selectedItem.virtual_Source.ClassName + '.Runtime.html';
            }
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Application/ApplicationThemeConfig/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    themeConfig.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + 'ApplicationThemeConfig/', themeConfig.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Application/ApplicationThemeConfig/edit.html',
                scope: $scope
            });
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath + "applicationthemeconfig/", themeConfig.gridOptions.selectedRow.item.Id, "GET").success(function (response) {
                    ...
                    themeConfig.busyIndicator.isActive = true;
                    ajax.call(cmsServerConfig.configApiServerPath + "applicationthemeconfig/", themeConfig.selectedItemForDelete.Id, 'DELETE').success(function (res) {
                        themeConfig.busyIndicator.isActive = false;
    ...
    themeConfig.onSourceChange = function (sourceId) {
        ...
        if (themeConfig.selectedItem != undefined && source != undefined && source.ClassName != undefined) {
            themeConfig.selectedItem.ThemeConfigBuilderJsonValuesHtml = 'cpanelv1/CmsModules/Application/ConfigTheme/' + source.ClassName + '.Builder.html';
            themeConfig.selectedItem.ThemeConfigRuntimeJsonValuesHtml = 'cpanelv1/CmsModules/Application/ConfigTheme/' + source.ClassName + '.Runtime.html';
        }
        themeConfig.busyIndicator.isActive = true;
            ...
            if (themeConfig.fileIsExist(uploadFile.name)) {
                ...
                ajax
                    ...
                    .success(function (response) {
                        ...
                        themeConfig.FileItem.UploadFileGUID = uploadFile.errorExceptionResult.Item.FileKey;
    ...
    themeConfig.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Application/ApplicationThemeConfig/report.html',
            scope: $scope
        });
    }
