app.controller("applicationSourceController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$state', '$builder', '$filter', function($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $state, $builder, $filter) {
    ...
    appSource.openEditModal = function() {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + 'ApplicationSource/', appSource.gridOptions.selectedRow.item.Id, 'GET').success(function(response) {
            ...
            appSource.includeHtmlBuilderAdmin = 'cpanelv1/CmsModules/Application/ConfigSource/' + appSource.selectedItem.ClassName + '.Builder.Admin.html';
            appSource.includeHtmlRuntimeAdmin = 'cpanelv1/CmsModules/Application/ConfigSource/' + appSource.selectedItem.ClassName + '.Runtime.Admin.html';
            appSource.includeHtmlBuilderSite = 'cpanelv1/CmsModules/Application/ConfigSource/' + appSource.selectedItem.ClassName + '.Builder.Site.html';
            appSource.includeHtmlRuntimeSite = 'cpanelv1/CmsModules/Application/ConfigSource/' + appSource.selectedItem.ClassName + '.Runtime.Site.html';
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Application/ApplicationSource/edit.html',
                scope: $scope
            });
