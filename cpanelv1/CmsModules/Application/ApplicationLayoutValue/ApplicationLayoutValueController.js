app.controller("applicationLayoutValueController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$stateParams', '$builder', '$state', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $stateParams, $builder, $state, $filter) {
    ...
    appLayoutValue.openEditModal = function () {
        ...
        appLayoutValue.includeHtmlSite = 'cpanelv1/CmsModules/Application/ConfigLayout/' + appLayoutValue.gridOptions.selectedRow.item.virtual_Source.ClassName + '.' + appLayoutValue.gridOptions.selectedRow.item.ClassName + '.Site.html';
        ...
        ajax.call(cmsServerConfig.configApiServerPath + 'ApplicationLayoutvalue/', filterDataModel, 'POST').success(function (responseValue) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Application/applicationlayoutvalue/edit.html',
                scope: $scope
            });
