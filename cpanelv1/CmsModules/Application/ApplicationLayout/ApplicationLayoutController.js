app.controller("applicationLayoutController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$builder', '$stateParams', '$state', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $builder, $stateParams, $state, $filter) {
    ...
    appLayout.init = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + "applicationLayout/getall", appLayout.gridOptions.advancedSearchData.engine, 'POST').success(function (response) {
            ...
            appLayout.gridOptions.fillData(appLayout.ListItems, response.Access);
    ...
    appLayout.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath + 'ApplicationLayout/', appLayout.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            rashaErManage.checkAction(response);
            ...
            if (fId >= 0) {
                ...
                appLayout.includeHtmlAdmin = 'cpanelv1/CmsModules/Application/ConfigLayout/' + appLayout.selectedItem.virtual_Source.ClassName + '.' + appLayout.selectedItem.ClassName + '.Admin.html';
                appLayout.includeHtmlSite = 'cpanelv1/CmsModules/Application/ConfigLayout/' + appLayout.selectedItem.virtual_Source.ClassName + '.' + appLayout.selectedItem.ClassName + '.Site.html';
            }
            ...
            ajax.call(cmsServerConfig.configApiServerPath + "FileCategory/getAll", filterModelParentRootFolders, 'POST').success(function (response1) { //Get root directories
                ...
                ajax.call(cmsServerConfig.configApiServerPath + "FileContent/GetFilesInCategoryId/",'', 'GET').success(function (response2) { //Get files in root
                    ...
                    appLayout.busyIndicator.isActive = false;
                    $modal.open({
                        templateUrl: 'cpanelv1/CmsModules/Application/ApplicationLayout/edit.html',
                        scope: $scope
                    });
                }).error(function (data, errCode, c, d) {
                    console.log(data);
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath + 'ApplicationLayout/', appLayout.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath + 'ApplicationLayout/', appLayout.selectedItemForDelete.Id, 'DELETE').success(function (res) {
            ...
            if (appLayout.fileIsExist(uploadFile.name)) {
                ...
                ajax
                    ...
                    .success(function (response) {
                        ...
                        appLayout.FileItem.UploadFileGUID = uploadFile.errorExceptionResult.Item.FileKey;
