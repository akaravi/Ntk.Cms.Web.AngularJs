app.controller("deliveryMethodDetailController", ["$scope", "$http", "ajax", 'rashaErManage', '$modal', '$modalStack', 'SweetAlert', '$timeout', '$window', '$filter', function ($scope, $http, ajax, rashaErManage, $modal, $modalStack, sweetAlert, $timeout, $window, $filter) {
    ...
    deliveryMethodDetail.init = function () {
        ...
        deliveryMethodDetail.gridOptions.advancedSearchData.engine.AccessLoad = true;
    ...
    deliveryMethodDetail.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'DeliveryMethodDetail/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Delivery/DeliveryMethodDetail/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    deliveryMethodDetail.addNewRow = function (frm) {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'DeliveryMethodDetail/', deliveryMethodDetail.selectedItem, 'POST').success(function (response) {
            deliveryMethodDetail.addRequested = false;
            deliveryMethodDetail.busyIndicator.isActive = false;
            rashaErManage.checkAction(response);
    ...
    deliveryMethodDetail.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'DeliveryMethodDetail/', deliveryMethodDetail.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Delivery/DeliveryMethodDetail/edit.html',
                scope: $scope
            });
    ...
    deliveryMethodDetail.editRow = function (frm) {
        ...
        deliveryMethodDetail.busyIndicator.isActive = true;
        ajax.call(cmsServerConfig.configApiServerPath+'DeliveryMethodDetail/', deliveryMethodDetail.selectedItem, "PUT").success(function (response) {
            deliveryMethodDetail.addRequested = true;
            rashaErManage.checkAction(response);
            deliveryMethodDetail.busyIndicator.isActive = false;
            if (response.IsSuccess) {
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'DeliveryMethodDetail/', deliveryMethodDetail.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'DeliveryMethodDetail/', deliveryMethodDetail.selectedItemForDelete.Id, 'DELETE').success(function (res) {
    ...
    deliveryMethodDetail.openSetTimesModal = function (dateId) {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Delivery/DeliveryMethodDetail/setTimes.html',
            scope: $scope
        });
    ...
    deliveryMethodDetail.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Delivery/DeliveryMethodDetail/report.html',
            scope: $scope
        });
    }
