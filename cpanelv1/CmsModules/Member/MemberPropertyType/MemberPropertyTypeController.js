...
memberPropertyType.alreadyExist = function (id, array) {
   ...
   //---------------Upload Modal-------------------------------
    memberPropertyType.openUploadModal = function () {
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Service/memberPropertyType/upload_modal.html',
            size: 'lg',
            scope: $scope
        });
        ...
        if ($("#save-icon" + index).hasClass("fa-save")) {
            ...
            //--------------------------------
                ...
                ajax.call(cmsServerConfig.configApiServerPath+"FileContent/ViewModel", "", 'GET').success(function (response) {
                    ...
                    memberPropertyType.FileItem.UploadFileGUID = uploadFile.errorExceptionResult.Item.FileKey;
    ...
    memberPropertyType.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Member/MemberPropertyType/report.html',
            scope: $scope
        });
    }
