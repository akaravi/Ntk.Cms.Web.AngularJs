...
//Selector نوع پرونده
    ...
    memberPropertyTypeSite.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'memberPropertyTypeSite/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Member/memberPropertyTypeSite/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    memberPropertyTypeSite.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'memberPropertyTypeSite/', memberPropertyTypeSite.gridOptionsProperty.selectedRow.item.Id, 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Member/memberPropertyTypeSite/edit.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
        ...
        rashaErManage.showYesNo(($filter('translatentk')('warning')), ($filter('translatentk')('do_you_want_to_delete_this_attribute')), function (isConfirmed) {
            if (isConfirmed) {
                ...
                ajax.call(cmsServerConfig.configApiServerPath+'memberPropertyTypeSite/', memberPropertyTypeSite.gridOptionsProperty.selectedRow.item.Id, 'GET').success(function (response) {
                    ...
                    ajax.call(cmsServerConfig.configApiServerPath+'memberPropertyTypeSite/', memberPropertyTypeSite.selectedItemForDelete.Id, 'DELETE').success(function (res) {
...
memberPropertyTypeSite.gridOptionsSite = {
 ...
 //Show Content with Category Id
    ...
    memberPropertyTypeSite.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Member/memberPropertyTypeSite/report.html',
            scope: $scope
        });
    }
