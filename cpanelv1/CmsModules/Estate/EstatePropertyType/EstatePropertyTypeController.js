 ...
 estatePropertyType.filePickerMainImage = {
    ...
    estatePropertyType.openAddModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'estatepropertytype/ViewModel', "", 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Estate/EstatePropertyType/add.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
    ...
    estatePropertyType.openEditModal = function () {
        ...
        ajax.call(cmsServerConfig.configApiServerPath+'estatepropertytype/', estatePropertyType.gridOptions.selectedRow.item.Id, 'GET').success(function (response) {
            ...
            $modal.open({
                templateUrl: 'cpanelv1/CmsModules/Estate/EstatePropertyType/edit.html',
                scope: $scope
            });
        }).error(function (data, errCode, c, d) {
            rashaErManage.checkAction(data, errCode);
...
estatePropertyType.alreadyExist = function (id, array) {
   ...
   //---------------Upload Modal-------------------------------
    estatePropertyType.openUploadModal = function () {
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Service/estatePropertyType/upload_modal.html',
            size: 'lg',
            scope: $scope
        });
    ...
    estatePropertyType.toggleExportForm = function () {
        ...
        $modal.open({
            templateUrl: 'cpanelv1/CmsModules/Estate/EstatePropertyType/report.html',
            scope: $scope
        });
    }
